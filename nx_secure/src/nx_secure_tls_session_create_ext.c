...
ULONG metadata_size_sha256 = 0;
    ...
    /* The CertificateVerify signature working buffers are per-session, so they are carved from
       the metadata area as well. */
    max_total_metadata_size += NX_SECURE_TLS_CERTIFICATE_VERIFY_SCRATCH_SIZE;
#endif
