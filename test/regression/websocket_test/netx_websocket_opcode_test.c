...
{
0x81, 0x04, 0x01, 0x02, 0x03, 0x04, // Opcode: text
};
...
#else
void    netx_websocket_opcode_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT            code;
    ...
    else
    {
        ...
        /* The fourth response from the server shall be the opcode with close connection.  */
        status = nx_websocket_client_receive(&client_websocket, &packet_ptr1, &code, 500);
        if ((status != NX_WEBSOCKET_DISCONNECTED) || (client_pool.nx_packet_pool_invalid_releases))
            SET_ERROR_COUNTER(&error_counter, __FILE__, __LINE__);
    }
...
NX_PACKET       *packet_ptr;
    ...
    printf("NetX Test:   Websocket Opcode Test.....................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Websocket Opcode Test.....................................N/A\n");
