...
#else
void    netx_websocket_delete_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT            code;
    ...
    /* This test is significant only when is error checking is enabled */
#ifndef NX_DISABLE_ERROR_CHECKING
    status = nx_websocket_client_delete(&client_websocket);
    if (status != NX_PTR_ERROR || client_websocket.nx_websocket_client_mutex.tx_mutex_ownership_count != 0)
        SET_ERROR_COUNTER(&error_counter, __FILE__, __LINE__);
    ...
    else
    {
        ...
        /* Test the delete function which shall clean up unused resources */
        status = nx_websocket_client_delete(&client_websocket);
        if (status || client_websocket.nx_websocket_client_mutex.tx_mutex_ownership_count != 0)
            SET_ERROR_COUNTER(&error_counter, __FILE__, __LINE__);
        /* The waiting list shall be empty after calling delete */
...
NX_PACKET       *packet_ptr;
    ...
    printf("NetX Test:   Websocket Delete Test.....................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Websocket Delete Test.....................................N/A\n");
