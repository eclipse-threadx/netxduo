...
#else
void    netx_telnet_server_options_negotiate_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET *my_packet, *my_packet2, *rcv_packet;
    ...
    /* Prepare a second reply: WONT ECHO, DO SUPPRESS GO AHEAD */
    send_buff[0] = 0xFF;
    send_buff[1] = 0xFC;
    send_buff[2] = 0x01;
    send_buff[0] = 0xFF;
...
UINT        status;
    ...
    printf("NetX Test:   Telnet Server Negotiation Test............................");
    ...
    server_option_negotiation = NX_FALSE;
    ...
    do
    {
        /* Check on the result of optio negotiations while the client connection is live. */
        
        NX_TELNET_CLIENT_REQUEST *client_req_ptr = &(my_server.nx_telnet_server_client_list[0]);
            ...
            (client_req_ptr -> nx_telnet_client_agree_server_will_echo_success == NX_TRUE))
        {
            ...
            server_option_negotiation = NX_TRUE;
        }
    ...
    if (error_counter || !server_option_negotiation)
    {
...
#endif
{
    printf("NetX Test:   Telnet Server Negotiation Test............................N/A\n");
