...
static void    mqtt_disconnect_notify(struct NXD_MQTT_CLIENT_STRUCT *client_ptr);
...
#else
void       netx_mqtt_client_connect_non_block_2_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UCHAR      *byte;
    ...
    printf("NetX Test:   MQTT Connect Non Block Test 2.............................");
    ...
    nxd_mqtt_client_disconnect_notify_set(client_ptr, mqtt_disconnect_notify);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   MQTT Connect Non Block Test 2.............................N/A\n");
