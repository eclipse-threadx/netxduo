...
#if !defined(NXD_MQTT_REQUIRE_TLS) && defined(NXD_MQTT_MAXIMUM_TRANSMIT_QUEUE_DEPTH)
...
static UCHAR pool_area[PACKET_POOL_SIZE];
...
#else
void       netx_mqtt_client_transmit_queue_depth_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
    ...
    status = nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", PACKET_SIZE, pool_area, PACKET_POOL_SIZE);
...
UINT        i;
    ...
    printf("NetX Test:   MQTT Transmit Queue Depth Test............................");
    ...
    /* Send telemetry to fill the transmit queue. */
    for (i = 0 ; i < NXD_MQTT_MAXIMUM_TRANSMIT_QUEUE_DEPTH; i++)
    {
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   MQTT Transmit Queue Depth Test............................N/A\n");
