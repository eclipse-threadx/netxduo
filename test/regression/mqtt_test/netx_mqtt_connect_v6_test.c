...
#else
void       netx_mqtt_client_connect_v6_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
//NXD_ADDRESS ip1_primary_global_address;
    ...
    /* Enable IPv6 */
    nxd_ipv6_enable(&ip_1);


    /* Set IPv6 address on ip_1. */
...
UINT i;
    ...
    printf("NetX Test:   MQTT Connect V6 Test .....................................");
...
UINT       i;
    ...
    for (i = 0; i < TEST_LOOP; i++)
    {
        ...
        status = nx_tcp_server_socket_accept(&server_socket, NX_IP_PERIODIC_RATE * 2);
