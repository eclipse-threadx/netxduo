...
static UINT disconnect_notify_called = 0;
...
static VOID    disconnect_notify(NXD_MQTT_CLIENT *client_ptr);
...
#else
void       netx_mqtt_client_connect_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT i;
    ...
    printf("NetX Test:   MQTT Connect Test ........................................");
    ...
    nxd_mqtt_client_disconnect_notify_set(client_ptr, disconnect_notify);
    ...
    /* Verify disconnect callback function. */
    if (disconnect_notify_called == 0)
    {
        error_counter++;
    }
