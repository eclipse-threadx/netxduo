...
static char pkt_data[110] = {
    0x33, 0x33, 0x00, 0x00, 0x00, 0x01, 0x00, 0x0c, 
    0x29, 0x1e, 0xaa, 0x4f, 0x86, 0xdd, 0x60, 0x00, 
    0x00, 0x00, 0x00, 0x38, 0x11, 0x40, 0xfe, 0x80, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x0c, 
    0x29, 0xff, 0xfe, 0x1e, 0xaa, 0x4f, 0xff, 0x02, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x7b, 
    0x00, 0x7b, 0x00, 0x38, 0x7d, 0x9b, 0x25, 0x02, 
    0x06, 0xec, 0x00, 0x00, 0x07, 0xe9, 0x00, 0x00, 
    0x03, 0x09, 0x89, 0xbd, 0x04, 0x0a, 0xd6, 0x4f, 
    0xad, 0x4d, 0x78, 0xae, 0xb7, 0xbc, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd6, 0x4f, 
    0xad, 0x57, 0x70, 0x86, 0x42, 0x10 };


static UINT pkt_size = 110;

static ULONG expected_seconds = 0xd64fad57;
static ULONG expected_milliseconds = 0x1c2;
...
#else
void netx_sntp_client_ipv6_broadcast_basic_test_application_define(void *first_unused_memory)
#endif
{
...
NXD_ADDRESS client_ip_address;
    ...
    printf("NetX Test:   NETX SNTP Client IPv6 Broadcast Basic Test................");
    ...
    status = nxd_sntp_client_initialize_broadcast(&sntp_client,  &sntp_server_address, NX_NULL);
...
#endif
{
    printf("NetX Test:   NETX SNTP Client IPv6 Broadcast Basic Test................N/A\n");
