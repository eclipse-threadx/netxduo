...
static DHCP_RESPONSE            dhcp_response[SERVER_RESPONSE_NUM];

/* Frame (342 bytes) */
static unsigned char offer1[342] = {
...
0x44, 0x6f, 0x00, 0x00, 0x80, 0x00,             /* ........ */
0xc0, 0xa8, 0x02, 0xc5,                         /* ciaddr */
0xc0, 0xa8, 0x02, 0xc5, 0x00, 0x00,             /* ........ */
...
0x53, 0x63, 0x35, 0x01, 0x02, 0x36, 0x04, 0xa8, /* Sc5..6.. */
0x02, 0x01, 0x05, 0x33, 0x04, 0x00, 0x00, 0x1b, /* ...3.... */
0xfe, 0x01, 0x04, 0xff, 0xff, 0xff, 0x00, 0x03, /* ........ */
0x04, 0xa8, 0x02, 0x01, 0x02, 0x3a, 0x04, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x3b, 0x04, 0x00, 0x00, 0x01, /* ...*.|l. */
...
/* Frame (342 bytes) */
static unsigned char offer2[342] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
0x02, 0x01, 0x05, 0x33, 0x04, 0x00, 0x00, 0x1b, /* ...3.... */
0xfe, 0x01, 0x04, 0xff, 0xff, 0xff, 0x00, 0x03, /* ........ */
0x04, 0xa8, 0x02, 0x01, 0x02, 0x06, 0x04, 0xc0, /* ........ */
...
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ........ */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* ........ */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* ........ */
0xff, 0xff, 0x00, 0x43, 0x00, 0x44, 0x01, 0x34, /* ........ */
0xad, 0x32, 0x02, 0x01, 0x06, 0x00, 0x22, 0x33, /* ........ */
0x44, 0x6f, 0x00, 0x00, 0x80, 0x00,             /* ........ */
0xc0, 0xa8, 0x02, 0xc5,                         /* ciaddr */
0xc0, 0xa8, 0x02, 0xc5, 0x00, 0x00,             /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, /* ........ */
0x22, 0x33, 0x44, 0x57, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x63, 0x82, /* ......c. */
0x53, 0x63, 0x35, 0x01, 0x05, 0x36, 0x04, 0xff, /* Sc5..6.. */
0xff, 0xff, 0xff, 0x33, 0x04, 0x00, 0x00, 0x1b, /* ...3.... */
0xfe, 0x01, 0x04, 0xff, 0xff, 0xff, 0x00, 0x03, /* ........ */
0x04, 0xff, 0xff, 0xff, 0x00, 0x06, 0x04, 0xc0, /* ........ */
0xa8, 0x02, 0x01, 0x2a, 0x04, 0x7c, 0x6c, 0x14, /* ...*.|l. */
0x01, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00              /* ...... */
...
#else
void    netx_dhcp_send_request_internal_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        option_size;
    ...
    printf("NetX Test:   DHCP send request internal test...............................");
    ...
    dhcp_response[0].dhcp_response_pkt_data = (char*)offer1;
    dhcp_response[0].dhcp_response_pkt_size = sizeof(offer1);
    dhcp_response[1].dhcp_response_pkt_data = (char*)offer2;
    dhcp_response[1].dhcp_response_pkt_size = sizeof(offer2);
    dhcp_response[2].dhcp_response_pkt_data = ack;
    dhcp_response[2].dhcp_response_pkt_size = sizeof(ack);
    ...
    for (i = 0; i < SERVER_RESPONSE_NUM; i++)
    {
        ...
        status =  nx_udp_socket_receive(&server_socket, &my_packet, 1000);
...
UINT        ntp_server_address_size = 4;
    ...
    /* Create the DHCP instance. for the test with NULL dhcp name */
    status =  nx_dhcp_create(&dhcp_client, &client_ip, NULL);
    if (status)
    {
        error_counter++;
    }

    /* Set the ip address to NX_BOOTP_BC_ADDRESS to test the corner case */
    dhcp_client.nx_dhcp_interface_record->nx_dhcp_ip_address = NX_BOOTP_BC_ADDRESS;
    ...
    /* Create the DHCP instance. for the test with a normal short name */
    status =  nx_dhcp_create(&dhcp_client, &client_ip, "Short DHCP Name");
    if (status)
    {
        error_counter++;
    }
...
#endif
{
    ...
    printf("NetX Test:   DHCP send request internal test...............................N/A\n"); 
