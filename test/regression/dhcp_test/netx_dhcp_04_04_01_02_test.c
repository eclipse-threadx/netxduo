...
#else
void    netx_dhcp_04_04_01_02_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        addresses_added;
    ...
    printf("NetX Test:   DHCP 04_04_01_02 Test.....................................");
    ...
    /* After 5s, check the flags for error xid. */
    if((error_counter) || (dhcp_request_flag != 0) || (dhcp_offer_flag == 0))
    {
        printf("ERROR!\n");
...
NX_UDP_HEADER   *udp_header;
    ...
    /* client port 68(0x44), server port 67(0x43). packet sent from client to server*/
...
UCHAR           *pad_ptr;
    ...
    if(message_type == NX_DHCP_TYPE_DHCPOFFER)
    {
...
#ifdef __PRODUCT_NETXDUO__
        ip_header = (NX_IPV4_HEADER*)(packet_ptr -> nx_packet_prepend_ptr - 20);
#else
        ip_header = (NX_IP_HEADER *)(packet_ptr -> nx_packet_prepend_ptr - 20);
#endif
        ...
        /* Change the xid. */
        xid = (ULONG *)(packet_ptr -> nx_packet_prepend_ptr + 12);
        *xid = 0;
...
#endif
{
    ...
    printf("NetX Test:   NetX DHCP 04_04_01_02 Test................................N/A\n"); 
