/* This test reference the netx_dhcp_basic_test.c, with extra test on the corner
   of function _nx_dhcp_interface_start which checks that condition when the
   return status of tx_thread_resume is TX_SUSPEND_LIFTED */
...
#else
void    netx_dhcp_start_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        addresses_added;
    ...
    printf("NetX Test:   DHCP Start Test...........................................");
...
UINT        skip_discover_message = NX_FALSE;
    ...
    /* Force the return status of tx_thread_resume to be TX_SUSPEND_LIFTED, which
       is a corner case tested in function _nx_dhcp_interface_start */
    dhcp_client.nx_dhcp_thread.tx_thread_delayed_suspend = TX_TRUE;
    dhcp_client.nx_dhcp_thread.tx_thread_state = TX_SLEEP;
    status =  nx_dhcp_start(&dhcp_client);
    dhcp_client.nx_dhcp_thread.tx_thread_delayed_suspend = TX_FALSE;
    dhcp_client.nx_dhcp_thread.tx_thread_state = TX_READY;
...
#endif
{
    ...
    printf("NetX Test:   NetX DHCP Start Test......................................N/A\n"); 
