...
#define     CLIENT_IP_ADDRESS           IP_ADDRESS(10,0,0,10)
...
#else
void    netx_dhcp_03_02_01_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        addresses_added;
    ...
    printf("NetX Test:   DHCP 03_02_01 Test........................................");
...
ULONG           client_ip;
    ...
    if(src_dst_port == 0x00440043)
    {
        ...
        if(message_type == NX_DHCP_TYPE_DHCPREQUEST)
        {
            ...
            /* Get ciaddr value. */
            client_ip = dhcp_get_data((packet_ptr -> nx_packet_prepend_ptr + 20 + 8 + NX_BOOTP_OFFSET_CLIENT_IP), 4);

            /* Check if the 'coaddr' field is filled. */
            if(client_ip != 0)
                error_counter++;
            else
                flag = 1;
...
#endif
{
    ...
    printf("NetX Test:   NetX DHCP 03_02_01 Test...................................N/A\n"); 
