...
static NX_IP                   client_dummy1_ip;
static NX_DHCP                 dhcp_client_dummy1;
static NX_IP                   client_dummy2_ip;
static NX_DHCP                 dhcp_client_dummy2;
...
#else
void    netx_dhcp_delete_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        addresses_added;
    ...
    printf("NetX Test:   DHCP Delete Test...........................................");
...
UINT        skip_discover_message = NX_FALSE;
    ...
    /* Set the value to test the corner case when _nx_dhcp_created_ptr != dhcp_ptr and dhcp_previous -> nx_dhcp_created_next */
    dhcp_client_dummy1.nx_dhcp_created_next = NX_NULL;
...
#endif
{
    ...
    printf("NetX Test:   NetX DHCP Delete Test......................................N/A\n"); 
