...
#else
void    netx_dhcp_04_03_02_02_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        addresses_added;
    ...
    printf("NetX Test:   DHCP 04_03_02_02 Test.....................................");
    ...
    if(src_dst_port == 0x00440043)
    {
        if(dhcp_client.nx_dhcp_interface_record[0].nx_dhcp_state == NX_DHCP_STATE_INIT)
        {
            ...
            if(message_type == NX_DHCP_TYPE_DHCPDISCOVER)
            {
                ...
                NX_CHANGE_ULONG_ENDIAN(ip_dest_addr);
                NX_CHANGE_ULONG_ENDIAN(ip_src_addr);
            }

        }

        /* Make sure in renewing state. */
...
UCHAR           *pad_ptr;
    ...
    /* Check if the message is a DHCPDISCOVER. */
    if(message_type == NX_DHCP_TYPE_DHCPDISCOVER)
    {
...
#endif
{
    ...
    printf("NetX Test:   NetX DHCP 04_03_02_02 Test................................N/A\n"); 
