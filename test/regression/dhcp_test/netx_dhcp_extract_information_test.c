...
#define     DHCP_RESPONSE_TEST_CASE_NUM           11
...
static DHCP_RESPONSE            dhcp_response[DHCP_RESPONSE_TEST_CASE_NUM];

/* Frame (342 bytes) */
static unsigned char first_bad_offer[342] = {
...
0x01, 0x04, 0x00, 0x00, 0x00, 0x00,             /* Subnet Mask */
0x36, 0x04, 0x00, 0x00, 0x00, 0x00,             /* Server identifier */
0x33, 0x04, 0xff, 0xff, 0xff, 0xff,             /* IP address lease time */
0x03, 0x04, 0xc0, 0xa8, 0x02, 0x01,             /* Router */
...
/* Frame (342 bytes) */
static unsigned char second_bad_offer[342] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
/* Frame (665 bytes) */
static unsigned char first_good_offer[665] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
0x35, 0x01, 0x02,                               /* DHCP message type */
0x01, 0x04, 0xff, 0xff, 0xff, 0x00,             /* Subnet Mask */
0x36, 0x04, 0x80, 0xa8, 0x02, 0x01,             /* Server identifier */
0x33, 0x04, 0xff, 0xff, 0xff, 0xff,             /* IP address lease time */
0x03, 0x04, 0xc0, 0x01, 0x00, 0x00,             /* Router/gateway */
0x06, 0x04, 0xc0, 0xa8, 0x02, 0x01,             /* DNS server */
0x2a, 0x04, 0x7c, 0x6c, 0x14, 0x01,             /* NTP server */
0x3a, 0x04, 0xff, 0xff, 0xff, 0xff,             /* Renewal time */
0x3b, 0x04, 0x00, 0xff, 0xff, 0xff,             /* Rebind time */
0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00,                         /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
/* Frame (342 bytes) */
static unsigned char first_ack[342] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
0x63, 0x82, 0x53, 0x63,                         /* ........ */
0x35, 0x01, 0x05,                               /* ........ */
0x36, 0x04, 0xc0, 0xa8, 0x02, 0x01,             /* Server identifier */
0x33, 0x04, 0x00, 0x00, 0x1b, 0xfe,             /* IP address lease time */
0x01, 0x04, 0xff, 0xff, 0xff, 0x00,
0x03, 0x04, 0x80, 0x01, 0x00, 0x00,             /* Router/gateway */
0x06, 0x04, 0xc0, 0xa8, 0x02, 0x01,
...
/* Frame (342 bytes) */
static unsigned char second_good_offer[342] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
0x03, 0x04, 0xe0, 0x01, 0x00, 0x00,             /* Router/gateway */
0x06, 0x04, 0xc0, 0xa8, 0x02, 0x01,             /* DNS server */
0x2a, 0x04, 0x7c, 0x6c, 0x14, 0x01,             /* NTP server */
0x3a, 0x04, 0x00, 0x00, 0xff, 0xff,             /* Renewal time */
0x3b, 0x04, 0xff, 0xff, 0xff, 0xff,             /* Rebind time */
0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00
};
...
/* Frame (342 bytes) */
static unsigned char second_ack[342] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
0x33, 0x04, 0x00, 0x00, 0x1b, 0xfe,             /* IP address lease time */
0x01, 0x04, 0xff, 0xff, 0xff, 0x00,
0x03, 0x04, 0x00, 0x00, 0x00, 0x00,             /* Router/gateway */
0x06, 0x04, 0xc0, 0xa8, 0x02, 0x01,
0x2a, 0x04, 0x7c, 0x6c, 0x14, 0x01,             /* ........ */
0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
/* Frame (342 bytes) */
static unsigned char third_good_offer[342] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
0x01, 0x04, 0xff, 0xff, 0xff, 0x00,             /* Subnet Mask */
0x36, 0x04, 0xc0, 0xa8, 0x02, 0x01,             /* Server identifier */
0x33, 0x04, 0x00, 0x00, 0xff, 0xff,             /* IP address lease time */
0x03, 0x04, 0xc0, 0xa8, 0x02, 0x01,             /* Router */
0x06, 0x04, 0xc0, 0xa8, 0x02, 0x01,             /* DNS server */
0x2a, 0x04, 0x7c, 0x6c, 0x14, 0x01,             /* NTP server */
0x3b, 0x04, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00                    /* ...... */
};

/* Frame (342 bytes) */
static unsigned char third_ack[665] = {
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x15, /* ........ */
0x5d, 0x02, 0x1e, 0x0f, 0x08, 0x00, 0x45, 0x10, /* ].....E. */
0x01, 0x48, 0x00, 0x00, 0x00, 0x00, 0x80, 0x11, /* .H...... */
0x76, 0xec, 0xc0, 0xa8, 0x02, 0x01, 0xff, 0xff, /* v....... */
...
0x33, 0x04, 0x00, 0x00, 0x1b, 0xfe,             /* IP address lease time */
0x01, 0x04, 0xff, 0xff, 0xff, 0x00,
0x03, 0x04, 0xe0, 0x01, 0x02, 0x03,             /* Router/gateway */
0x06, 0x04, 0xc0, 0xa8, 0x02, 0x01,
0x2a, 0x04, 0x7c, 0x6c, 0x14, 0x01,             /* ........ */
0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
0x33, 0x04, 0x00, 0x00, 0x1b, 0xfe,             /* IP address lease time */
0x01, 0x04, 0xff, 0xff, 0xff, 0x00,
0x03, 0x04, 0xc0, 0x01, 0x02, 0x03,             /* Router/gateway */
0x06, 0x04, 0xc0, 0xa8, 0x02, 0x01,
0x2a, 0x04, 0x7c, 0x6c, 0x14, 0x01,             /* ........ */
0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
#else
void    netx_dhcp_extract_information_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        option_size;
    ...
    printf("NetX Test:   DHCP Extract Information test...............................");
    ...
    dhcp_response[0].dhcp_response_pkt_data = (char*)first_bad_offer;
    dhcp_response[0].dhcp_response_pkt_size = sizeof(first_bad_offer);
    dhcp_response[1].dhcp_response_pkt_data = (char*)second_bad_offer;
    dhcp_response[1].dhcp_response_pkt_size = sizeof(second_bad_offer);
    dhcp_response[2].dhcp_response_pkt_data = (char*)first_good_offer;
    dhcp_response[2].dhcp_response_pkt_size = sizeof(first_good_offer);
    dhcp_response[3].dhcp_response_pkt_data = first_ack;
    dhcp_response[3].dhcp_response_pkt_size = sizeof(first_ack);
    dhcp_response[4].dhcp_response_pkt_data = (char*)second_good_offer;
    dhcp_response[4].dhcp_response_pkt_size = sizeof(second_good_offer);
    dhcp_response[5].dhcp_response_pkt_data = second_ack;
    dhcp_response[5].dhcp_response_pkt_size = sizeof(second_ack);
    dhcp_response[6].dhcp_response_pkt_data = (char*)third_good_offer;
    dhcp_response[6].dhcp_response_pkt_size = sizeof(third_good_offer);
    dhcp_response[7].dhcp_response_pkt_data = (char*)third_good_offer;
    dhcp_response[7].dhcp_response_pkt_size = sizeof(third_good_offer);
    dhcp_response[8].dhcp_response_pkt_data = third_ack;
    dhcp_response[8].dhcp_response_pkt_size = sizeof(third_ack);
    dhcp_response[9].dhcp_response_pkt_data = (char*)offer;
    dhcp_response[9].dhcp_response_pkt_size = sizeof(offer);
    dhcp_response[10].dhcp_response_pkt_data = ack;
    dhcp_response[10].dhcp_response_pkt_size = sizeof(ack);

    /* Wait for Client requests (DISCOVER and REQEUST).  */
    for (i = 0; i < DHCP_RESPONSE_TEST_CASE_NUM; i++)
    {
...
UINT        ntp_server_address_size = 4;
    ...
    for (i = 0; i < DHCP_RESPONSE_TEST_CASE_NUM-4; i++)
    {
        ...
        tx_thread_sleep(8 * NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    printf("NetX Test:   DHCP extract information test...............................N/A\n");
