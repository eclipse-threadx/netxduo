...
#else
void    netx_dhcp_stop_test_application_define(void *first_unused_memory)
#endif
{
...
{
    /* change the state to cover the corner case in _nx_dhcp_interface_stop  */
    dhcp_ptr->nx_dhcp_interface_record->nx_dhcp_state = NX_DHCP_STATE_FORCERENEW;
...
UINT        addresses_added;
    ...
    printf("NetX Test:   DHCP Stop Test...........................................");
...
UINT        skip_discover_message = NX_FALSE;
    ...
    /* Set the callback to test the corner case in function _nx_dhcp_interface_stop
       when nx_dhcp_interface_state_change_callback is available */
...
#endif
{
    ...
    printf("NetX Test:   NetX DHCP Stop Test......................................N/A\n"); 
