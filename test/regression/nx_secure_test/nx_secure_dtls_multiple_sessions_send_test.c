...
void test_application_define(void *first_unused_memory)
#else
VOID    nx_secure_dtls_multiple_sessions_send_test_application_define(void *first_unused_memory)
#endif
{
UINT     status;
CHAR    *pointer;
...
NX_PACKET *packet_ptr;
    ...
    printf("NetX Secure Test:   DTLS Multiple Sessions Send Test...................");
    ...
    for (i = 0; i < NUM_SERVER_SESSIONS; i++)
    {
        ...
        status = nx_packet_allocate(&server_pool, &packet_ptr, NX_UDP_PACKET, NX_NO_WAIT);
        if (status)
        {
            ERROR_COUNTER();
        }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   DTLS Multiple Sessions Send Test...................N/A\n");
