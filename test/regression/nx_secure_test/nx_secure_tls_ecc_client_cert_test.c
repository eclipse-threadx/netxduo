...
#if !defined(NX_SECURE_TLS_CLIENT_DISABLED) && !defined(NX_SECURE_TLS_SERVER_DISABLED) && defined(NX_SECURE_ENABLE_ECC_CIPHERSUITE) && defined(NX_SECURE_ENABLE_CLIENT_CERTIFICATE_VERIFY)
...
UINT status;
    ...
    status = nx_secure_x509_certificate_initialize(&client_local_certificate,
                                                   ECTestClient1_der, ECTestClient1_der_len,
                                                   NX_NULL, 0, ECTestClient1_key_der,
                                                   ECTestClient1_key_der_len,
...
NX_PACKET *packet_ptr;
    ...
    printf("NetX Secure Test:   TLS ECC Client Cert Test...........................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   TLS ECC Client Cert Test...........................N/A\n");
