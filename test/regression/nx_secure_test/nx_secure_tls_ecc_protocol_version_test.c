...
UINT i;
    ...
    printf("NetX Secure Test:   TLS ECC Protocol Version Test......................");
    ...
    {
        if (!nx_secure_supported_versions_list[NX_SECURE_TLS].nx_secure_versions_list[i].nx_secure_tls_is_supported)
        {
...
#if 1
        /* It is optional to override protocol verion since the client will choose it. */
        nx_secure_tls_session_protocol_version_override(&tls_server_session_0,
                                                        nx_secure_supported_versions_list[NX_SECURE_TLS].nx_secure_versions_list[i].nx_secure_tls_protocol_version);
#endif
...
NXD_ADDRESS server_address;
    ...
    for (i = 0; i < nx_secure_supported_versions_list[NX_SECURE_TLS].nx_secure_versions_list_count; i++)
    {
        ...
        /* NOTE: A known bug is, client is not able to accept negotiated version. */
        nx_secure_tls_session_protocol_version_override(&tls_client_session_0,
                                                        nx_secure_supported_versions_list[NX_SECURE_TLS].nx_secure_versions_list[i].nx_secure_tls_protocol_version);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   TLS ECC Protocol Version Test......................N/A\n");
