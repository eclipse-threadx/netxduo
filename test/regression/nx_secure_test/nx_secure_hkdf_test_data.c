...
static const UCHAR HKDF_TEST_SALT_3[1] = { 0 }; /* empty; paired length forced to 0 (MSVC C1001 on zero-length array) */
static const UCHAR HKDF_TEST_INFO_3[1] = { 0 }; /* empty; paired length forced to 0 (MSVC C1001 on zero-length array) */
...
static const UCHAR HKDF_TEST_SALT_6[1] = { 0 }; /* empty; paired length forced to 0 (MSVC C1001 on zero-length array) */
static const UCHAR HKDF_TEST_INFO_6[1] = { 0 }; /* empty; paired length forced to 0 (MSVC C1001 on zero-length array) */
...
static const UCHAR HKDF_TEST_SALT_7[1] = { 0 }; /* empty; paired length forced to 0 (MSVC C1001 on zero-length array) */
static const UCHAR HKDF_TEST_INFO_7[1] = { 0 }; /* empty; paired length forced to 0 (MSVC C1001 on zero-length array) */
...
static HKDF_DATA hkdf_test_data[] =
{
    ...
    { NX_CRYPTO_HASH_SHA256, HKDF_TEST_IKM_3, sizeof(HKDF_TEST_IKM_3), HKDF_TEST_SALT_3, 0, HKDF_TEST_INFO_3, 0, HKDF_TEST_PRK_3, sizeof(HKDF_TEST_PRK_3), HKDF_TEST_LENGTH_3, HKDF_TEST_OKM_3, sizeof(HKDF_TEST_OKM_3) },
    ...
    { NX_CRYPTO_HASH_SHA1,   HKDF_TEST_IKM_6, sizeof(HKDF_TEST_IKM_6), HKDF_TEST_SALT_6, 0, HKDF_TEST_INFO_6, 0, HKDF_TEST_PRK_6, sizeof(HKDF_TEST_PRK_6), HKDF_TEST_LENGTH_6, HKDF_TEST_OKM_6, sizeof(HKDF_TEST_OKM_6) },
    { NX_CRYPTO_HASH_SHA1,   HKDF_TEST_IKM_7, sizeof(HKDF_TEST_IKM_7), HKDF_TEST_SALT_7, 0, HKDF_TEST_INFO_7, 0, HKDF_TEST_PRK_7, sizeof(HKDF_TEST_PRK_7), HKDF_TEST_LENGTH_7, HKDF_TEST_OKM_7, sizeof(HKDF_TEST_OKM_7) },
};
