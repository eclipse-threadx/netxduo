/* This test concentrates on DTLS using ciphersuite ECJPAKE. The ECJPAKE key should not be initialized multiple times.  */
...
void test_application_define(void *first_unused_memory)
#else
VOID    nx_secure_dtls_ecjpake_test_application_define(void *first_unused_memory)
#endif
{
UINT     status;
CHAR    *pointer;
...
NX_PACKET *packet_ptr;
    ...
    printf("NetX Secure Test:   DTLS ECJPAKE Test..................................");
    ...
    if (error_counter || (ecjpake_init_counter != 2))
    {
        printf("ERROR!\n");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   DTLS ECJPAKE Test..................................N/A\n");
