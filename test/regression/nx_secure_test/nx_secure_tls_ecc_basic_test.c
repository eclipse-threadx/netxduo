...
NX_PACKET *packet_ptr;
    ...
    printf("NetX Secure Test:   TLS ECC Basic Test.................................");
    ...
    if(status)
    {
        printf("TLS server renegotiation request failed with error: 0x%x\n", status);
        ERROR_COUNTER();
    }
#endif
    ...
    status = nx_secure_tls_session_receive(&tls_server_session_0, &packet_ptr, 10);
    if (!status)
    {
        nx_packet_release(packet_ptr);
    }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   TLS ECC Basic Test.................................N/A\n");
