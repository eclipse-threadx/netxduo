...
static UINT                     drop_packet_sequence[] =
{
    0,  /* ClientHello */
    2,  /* ClientHello_Verify */
    7,  /* Certificate */
};
static UINT                     packet_sequence;
static UINT                     drop_index;
...
void test_application_define(void *first_unused_memory)
#else
VOID    nx_secure_dtls_retransmit_test_application_define(void *first_unused_memory)
#endif
{
UINT     status;
CHAR    *pointer;
...
{
    if ((drop_index < sizeof(drop_packet_sequence) / sizeof(UINT)) &&
        (packet_sequence++ == drop_packet_sequence[drop_index]))
    {
        drop_index++;
...
NX_PACKET *packet_ptr;
    ...
    printf("NetX Secure Test:   DTLS Retransmit Test...............................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   DTLS Retransmit Test...............................N/A\n");
