...
void test_application_define(void *first_unused_memory)
#else
VOID    nx_secure_dtls_multiple_sessions_receive_test_application_define(void *first_unused_memory)
#endif
{
UINT     status;
CHAR    *pointer;
...
NX_PACKET *packet_ptr;
    ...
    printf("NetX Secure Test:   DTLS Multiple Sessions Receive Test................");
    ...
    for (i = 0; i < NUM_SERVER_SESSIONS; i++)
    {
        ...
        status = nx_secure_dtls_session_receive(receive_session[i], &packet_ptr, 5 * NX_IP_PERIODIC_RATE);
        if (status)
        {
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   DTLS Multiple Sessions Receive Test................N/A\n");
