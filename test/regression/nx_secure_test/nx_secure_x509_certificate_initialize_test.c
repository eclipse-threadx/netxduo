...
UINT status;
    ...
    printf("NetX Secure Test:   TLS X509 Certificate Initialize Test.......................");

    nx_system_initialize();

    /* Initialize our certificate */
    memset(&certificate, 0, sizeof(certificate));
    status = _nx_secure_x509_certificate_initialize(&certificate, test_device_cert_der, test_device_cert_der_len, NX_NULL, 0, test_device_cert_key_der, test_device_cert_key_der_len, NX_SECURE_X509_KEY_TYPE_HARDWARE);
