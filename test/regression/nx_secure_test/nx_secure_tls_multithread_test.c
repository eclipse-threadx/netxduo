...
#define NX_PACKET_POOL_BYTES  ((1536 + sizeof(NX_PACKET)) * 200)
...
#define TOTAL_STACK_SPACE (2 * (DEMO_STACK_SIZE + IP_STACK_SIZE + NX_PACKET_POOL_SIZE + ARP_AREA_SIZE) + DEMO_STACK_SIZE)
...
UINT       i;
    ...
    printf("NetX Secure Test:   TLS Multithread Test...............................");
    ...
    status = nx_tcp_socket_create(&ip_0, &server_socket, "Server Socket",
                                  NX_IP_NORMAL, NX_FRAGMENT_OKAY, NX_IP_TIME_TO_LIVE * 100, 8*1024,
                                  NX_NULL, NX_NULL);
    ...
    for (i = 0; i < (LOOP << 1); i++)
    {
        status = nx_secure_tls_session_receive(&server_tls_session,
                                               &receive_packet,
...
UINT state;
    ...
    ntest_2_entry(thread_input);
    for (;;)
    {
        tx_thread_info_get(&ntest_2, NX_NULL, &state, NX_NULL, NX_NULL, NX_NULL, NX_NULL, NX_NULL, NX_NULL);
...
NX_PACKET *send_packet;
    ...
    for (i = 0; i < LOOP; i++)
    {
        ...
        send_packet -> nx_packet_append_ptr = send_packet -> nx_packet_data_end;
        send_packet -> nx_packet_length = send_packet -> nx_packet_append_ptr - send_packet -> nx_packet_prepend_ptr;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   TLS Multithread Test...............................N/A\n");
