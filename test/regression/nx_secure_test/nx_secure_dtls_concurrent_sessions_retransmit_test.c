...
void test_application_define(void *first_unused_memory)
#else
VOID    nx_secure_dtls_concurrent_sessions_retransmit_test_application_define(void *first_unused_memory)
#endif
{
UINT     status;
CHAR    *pointer;
...
{
    {NX_SECURE_TLS_CLIENT_HELLO, NX_SECURE_TLS_CLIENT_HELLO, NX_SECURE_TLS_CLIENT_KEY_EXCHANGE,},
...
UINT status;
    ...
    printf("NetX Secure Test:   DTLS Concurrent Sessions Retransmit Test...........");
    ...
    tx_semaphore_get(&semaphore_connect, 5 * NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   DTLS Concurrent Sessions Retransmit Test...........N/A\n");
