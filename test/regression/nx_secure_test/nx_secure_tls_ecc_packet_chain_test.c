...
NX_PACKET *packet_ptr;
    ...
    printf("NetX Secure Test:   TLS ECC Packet Chain Test..........................");
    ...
    status = nx_secure_tls_session_receive(&tls_server_session_0, &packet_ptr, NX_IP_PERIODIC_RATE);
    if (status)
    {
        ERROR_COUNTER();
    }
...
#if !(NX_SECURE_TLS_TLS_1_3_ENABLED) && !defined(NX_SECURE_TLS_DISABLE_SECURE_RENEGOTIATION)
    status  = nx_secure_tls_session_renegotiate(&tls_server_session_0, NX_WAIT_FOREVER);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Secure Test:   TLS ECC Packet Chain Test..........................N/A\n");
