/* PTP two steps off test.  This test case validates two steps off procedure of PTP client synchronize. */
...
#else
void netx_ptp_client_two_steps_off_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
    ...
    printf("NetX Test:   PTP Two Steps Off Test ...................................");
...
NX_PTP_TIME ts_diff = {1, 1, 1};
    ...
    expected_time.second_high = (delay_response_ts.second_high + sync_ts.second_high) / 2;
    expected_time.second_low = (delay_response_ts.second_low + sync_ts.second_low) / 2;
    expected_time.nanosecond = (delay_response_ts.nanosecond + sync_ts.nanosecond) / 2;
