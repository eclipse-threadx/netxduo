...
#define OID_OCTETSTRING_ADDRESS       "1.3.6.1.2.1.3.1.1.2.0"


const unsigned char test_first_string[4] = {0xff, 0x00, 0xf1, 0xf2};
const unsigned char test_second_string[3] = {0x00, 0xf1, 0xf2};
...
extern char set_request_octet_string_pkt[47];
extern int  set_request_octet_string_size;
extern char get_request_octet_string_pkt[42];
extern int  get_request_octet_string_size;

extern char set_request_octet_string_leading_zero_pkt[46];
extern int  set_request_octet_string_leading_zero_size;
extern char get_request_octet_string_leading_zero_pkt[42];
extern int  get_request_octet_string_leading_zero_size;
...
#else
void    netx_snmp_setget_octet_strings_test_application_define(void *first_unused_memory)
#endif
{
...
UINT status;
    ...
    printf("NetX Test:   SNMP Set Get Octet String Test............................");
...
static void  snmp_test_initialize()
{
    ...
    snmp_query[0].snmp_query_pkt_data = &set_request_octet_string_pkt[0];
    snmp_query[0].snmp_query_pkt_size = set_request_octet_string_size;  


    snmp_query[1].snmp_query_pkt_data = &get_request_octet_string_pkt[0];
    snmp_query[1].snmp_query_pkt_size = get_request_octet_string_size; 
       
    snmp_query[2].snmp_query_pkt_data = &set_request_octet_string_leading_zero_pkt[0];
    snmp_query[2].snmp_query_pkt_size = set_request_octet_string_leading_zero_size;  

    snmp_query[3].snmp_query_pkt_data = &get_request_octet_string_leading_zero_pkt[0];
    snmp_query[3].snmp_query_pkt_size = get_request_octet_string_leading_zero_size;   
}
...
static  UINT get_query_count = 0;
    ...
    if ((object_data -> nx_snmp_object_octet_string_size == 0) || (object_data -> nx_snmp_object_octet_string_size > NX_SNMP_MAX_OCTET_STRING))
    {
       error_counter++;
    ...
    if (get_query_count == 1)                                         
    {
        ...
        {
           if (test_first_string[i] != object_data-> nx_snmp_object_octet_string[i])
           {
               error_counter++;
               break;
           }    
    ...
    else if (get_query_count == 2)                                         
    {
      
        for (i = 0; i < object_data -> nx_snmp_object_octet_string_size; i++)
        {
           if (test_second_string[i] != object_data-> nx_snmp_object_octet_string[i])
           {
               error_counter++;
               break;
           }    
...
#endif
{
    ...
    printf("NetX Test:   SNMP Set Get Octet String Test............................N/A\n");
