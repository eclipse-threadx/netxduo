...
extern unsigned char v1_double_release_packet[1421];
extern int           v1_double_release_packet_size;
...
#else
void    netx_snmp_v1_packet_double_release_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET  *packet_ptr;
    ...
    printf("NetX Test:   SNMP V1 Packet Double Release Test........................");
...
static void  snmp_test_initialize()
{
    snmp_query[0].snmp_query_pkt_data = &v1_double_release_packet[0];
    snmp_query[0].snmp_query_pkt_size = v1_double_release_packet_size;
}
...
#endif
{
    ...
    printf("NetX Test:   SNMP V1 Packet Double Release Test........................N/A\n"); 
