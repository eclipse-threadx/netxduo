...
extern char simple_get_next_query_pkt[82];
extern int  simple_get_next_query_size;
#if 1
extern char simple_get_bulk_query_pkt[76];
extern int  simple_get_bulk_query_size;
#endif 
...
#else
void    netx_snmp_basic_v2_test_application_define(void *first_unused_memory)
#endif
{
...
UINT status;
    ...
    printf("NetX Test:   SNMP Basic V2 Test........................................");
...
static void  snmp_test_initialize()
{
    ...
    snmp_query[1].snmp_query_pkt_data = &simple_get_next_query_pkt[0];
    snmp_query[1].snmp_query_pkt_size = simple_get_next_query_size;  
#if 1
...
UINT    status;
    ...
    /* Call either the get octet or get callback, depending what is registered in the table entry. */
     if (mib2_mib[i].object_get_octet_callback)
    {
...
#endif
{
    ...
    printf("NetX Test:   SNMP Basic V2 Test........................................N/A\n"); 
