...
extern unsigned char v3_object_id_buffer_overwrite_packet1[1514];
extern int           v3_object_id_buffer_overwrite_packet1_size;
...
#else
void    netx_snmp_v3_object_id_buffer_overwrite_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET  *packet_ptr;
    ...
    printf("NetX Test:   SNMP V3 Object ID Buffer OverWrite Test...................");
...
static void  snmp_test_initialize()
{
    snmp_query[0].snmp_query_pkt_data = &v3_object_id_buffer_overwrite_packet1[0];
    snmp_query[0].snmp_query_pkt_size = v3_object_id_buffer_overwrite_packet1_size;
}
...
#endif
{
    ...
    printf("NetX Test:   SNMP V3 Object ID Buffer OverWrite Test...................N/A\n"); 
