...
extern unsigned char v1_buffer_overwrite_packet1[1514];
extern int           v1_buffer_overwrite_packet1_size;
extern unsigned char v1_buffer_overwrite_packet2[54];
extern int           v1_buffer_overwrite_packet2_size;
extern unsigned char v1_buffer_overwrite_packet3[54];
extern int           v1_buffer_overwrite_packet3_size;
extern unsigned char v1_buffer_overwrite_packet4[];
extern int           v1_buffer_overwrite_packet4_size;
...
#else
void    netx_snmp_v1_buffer_overwrite_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET  *packet_ptr;
    ...
    printf("NetX Test:   SNMP V1 Buffer Overwrite Test.............................");
    ...
    /* Make sure the buffer is not overwrote.  */
    if (memcmp(mib2_mib[0].object_name, "1.3.6.1.2.1.1.1.0", sizeof("1.3.6.1.2.1.1.1.0") - 1) != 0)
    {
        error_counter++;
    }
...
static void  snmp_test_initialize()
{
    snmp_query[0].snmp_query_pkt_data = &v1_buffer_overwrite_packet1[0];
    snmp_query[0].snmp_query_pkt_size = v1_buffer_overwrite_packet1_size;

    snmp_query[1].snmp_query_pkt_data = &v1_buffer_overwrite_packet2[0];
    snmp_query[1].snmp_query_pkt_size = v1_buffer_overwrite_packet2_size;

    snmp_query[2].snmp_query_pkt_data = &v1_buffer_overwrite_packet3[0];
    snmp_query[2].snmp_query_pkt_size = v1_buffer_overwrite_packet3_size;

    snmp_query[3].snmp_query_pkt_data = &v1_buffer_overwrite_packet4[0];
    snmp_query[3].snmp_query_pkt_size = v1_buffer_overwrite_packet4_size;
}
...
#endif
{
    ...
    printf("NetX Test:   SNMP V1 Buffer Overwrite Test.............................N/A\n"); 
