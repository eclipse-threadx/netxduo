...
extern char simple_get_query_unknown_oid_pkt[82];
extern int  simple_get_query_unknown_oid_size;
...
#else
void    netx_snmp_v2_unknown_oid_test_application_define(void *first_unused_memory)
#endif
{
...
UINT status;
    ...
    printf("NetX Test:   SNMP V2 Unknown OID Test..................................");
    ...
    if (v2_my_agent.nx_snmp_agent_invalid_packets ||
        ...
        (v2_my_agent.nx_snmp_agent_request_errors != 1)  ||
...
USHORT      request_id = 1;
    ...
    for (i = 0; i < QUERY_COUNT; i++ )
    {
        ...
        /* The first request is for an unknown OID. */
        else if (i == 0) 
        {
            if ((v2_my_agent.nx_snmp_agent_no_such_name_errors != 1) &&
                (v2_my_agent.nx_snmp_agent_request_errors != 1))
            {

                /* The SNMP agent should increase it's counter of unknown OIDs. */
                error_counter++;
            }
        }
...
static void  snmp_test_initialize()
{
    ...
    snmp_query[0].snmp_query_pkt_data = &simple_get_query_unknown_oid_pkt[0];
                                         
    snmp_query[0].snmp_query_pkt_size = simple_get_query_unknown_oid_size;  


    snmp_query[1].snmp_query_pkt_data = &simple_get_query_pkt[0];
    snmp_query[1].snmp_query_pkt_size = simple_get_query_size;  

   // snmp_query[2].snmp_query_pkt_data = &simple_get_bulk_query_pkt[0];
   // snmp_query[2].snmp_query_pkt_size = simple_get_bulk_query_size;   
...
#endif
{
    ...
    printf("NetX Test:   SNMP V2 Unknown OID Test..................................N/A\n"); 
