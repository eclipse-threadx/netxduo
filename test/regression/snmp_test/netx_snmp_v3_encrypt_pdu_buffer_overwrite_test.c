...
extern unsigned char v3_encrypt_pdu_buffer_overwrite_packet1[1063];
extern int           v3_encrypt_pdu_buffer_overwrite_packet1_size;
...
#else
void    netx_snmp_v3_encrypt_pdu_buffer_overwrite_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET  *packet_ptr;
    ...
    printf("NetX Test:   SNMP V3 Encrypt PDU Buffer Overwrite Test.................");
...
static void  snmp_test_initialize()
{
    snmp_query[0].snmp_query_pkt_data = &v3_encrypt_pdu_buffer_overwrite_packet1[0];
    snmp_query[0].snmp_query_pkt_size = v3_encrypt_pdu_buffer_overwrite_packet1_size;
}
...
#endif
{
    ...
    printf("NetX Test:   SNMP V3 Encrypt PDU Buffer Overwrite Test.................N/A\n"); 
