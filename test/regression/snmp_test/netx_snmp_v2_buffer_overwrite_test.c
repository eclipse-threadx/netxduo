...
extern unsigned char v2_buffer_overwrite_packet1[1514];
extern int           v2_buffer_overwrite_packet1_size;
extern unsigned char v2_buffer_overwrite_packet2[54];
extern int           v2_buffer_overwrite_packet2_size;
...
#else
void    netx_snmp_v2_buffer_overwrite_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET  *packet_ptr;
    ...
    printf("NetX Test:   SNMP V2 Buffer Overwrite Test.............................");
...
static void  snmp_test_initialize()
{
    snmp_query[0].snmp_query_pkt_data = &v2_buffer_overwrite_packet1[0];
    snmp_query[0].snmp_query_pkt_size = v2_buffer_overwrite_packet1_size;

    snmp_query[1].snmp_query_pkt_data = &v2_buffer_overwrite_packet2[0];
    snmp_query[1].snmp_query_pkt_size = v2_buffer_overwrite_packet2_size;
}
...
#endif
{
    ...
    printf("NetX Test:   SNMP V2 Buffer Overwrite Test.............................N/A\n"); 
