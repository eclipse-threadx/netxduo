...
extern unsigned char v3_decrypt_pdu_buffer_overwrite_packet1[1514];
extern int           v3_decrypt_pdu_buffer_overwrite_packet1_size;
extern unsigned char v3_decrypt_pdu_buffer_overwrite_packet2[54];
extern int           v3_decrypt_pdu_buffer_overwrite_packet2_size;
...
#else
void    netx_snmp_v3_decrypt_pdu_buffer_overwrite_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET  *packet_ptr;
    ...
    printf("NetX Test:   SNMP V3 Decrypt PDU Buffer Overwrite Test.................");
...
static void  snmp_test_initialize()
{
    snmp_query[0].snmp_query_pkt_data = &v3_decrypt_pdu_buffer_overwrite_packet1[0];
    snmp_query[0].snmp_query_pkt_size = v3_decrypt_pdu_buffer_overwrite_packet1_size;

    snmp_query[1].snmp_query_pkt_data = &v3_decrypt_pdu_buffer_overwrite_packet2[0];
    snmp_query[1].snmp_query_pkt_size = v3_decrypt_pdu_buffer_overwrite_packet2_size;
}
...
#endif
{
    ...
    printf("NetX Test:   SNMP V3 Decrypt PDU Buffer Overwrite Test.................N/A\n"); 
