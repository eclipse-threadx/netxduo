...
#define SNMP_AGENT_ADDRESS     IP_ADDRESS(10,0,0,10)  
                         ...
                         /* counter32, counter64 msb counter 64 lsb, timertic */
//ULONG      test_data[] = {30541989, 30541989}; 
#define    COUNTER32_VAL 30541989
#define    COUNTER64_VAL 3054198999
#define    COUNTER64_VAL0 0xD2           // part of number stored in msw
#define    COUNTER64_VAL1 0x423988D7     // part of number stored in lsw
#define    TIMERTIC_VAL  30541989
#define    STRING_TEST   "my system id"
...
extern char set_request_counter32_pkt[47];
extern int  set_request_counter32_size;
extern char get_request_counter32_pkt[42];
extern int  get_request_counter32_size;

extern char set_request_counter64_pkt[48];
extern int  set_request_counter64_size;
extern char get_request_counter64_pkt[42];
extern int  get_request_counter64_size;

extern char set_request_counter64_5bytes_pkt[49];
extern int  set_request_counter64_5bytes_size;
extern char get_request_counter64_5bytes_pkt[42];
extern int  get_request_counter64_5bytes_size;

extern char set_request_timertic_pkt[47];
extern int  set_request_timertic_size;
extern char get_request_timertic_pkt[42];
extern int  get_request_timertic_size;


extern char set_request_string_pkt[53];
extern int  set_request_string_size;
extern char get_request_string_pkt[40];
extern int  get_request_string_size;
...
#else
void    netx_snmp_setget_misc_test_application_define(void *first_unused_memory)
#endif
{
...
UINT status;
    ...
    printf("NetX Test:   SNMP Set Get Miscellaneous Data Type Test.................");
    ...
    if ((v2_my_agent.nx_snmp_agent_get_requests != 5) ||
        (v2_my_agent.nx_snmp_agent_set_requests != 5) ||
        (v2_my_agent.nx_snmp_agent_total_get_variables != 5) || 
        (v2_my_agent.nx_snmp_agent_packets_received != 10) ||
        (v2_my_agent.nx_snmp_agent_packets_sent != 10) ||
        (v2_my_agent.nx_snmp_agent_getresponse_sent != 10))
...
static void  snmp_test_initialize()
{
    ...
    snmp_query[0].snmp_query_pkt_data = &set_request_counter32_pkt[0];
    snmp_query[0].snmp_query_pkt_size = set_request_counter32_size;  

    snmp_query[1].snmp_query_pkt_data = &get_request_counter32_pkt[0];
    snmp_query[1].snmp_query_pkt_size = get_request_counter32_size; 

    
    snmp_query[2].snmp_query_pkt_data = &set_request_counter64_pkt[0];
    snmp_query[2].snmp_query_pkt_size = set_request_counter64_size;  

    snmp_query[3].snmp_query_pkt_data = &get_request_counter64_pkt[0];
    snmp_query[3].snmp_query_pkt_size = get_request_counter64_size; 

    
    snmp_query[4].snmp_query_pkt_data = &set_request_counter64_5bytes_pkt[0];
    snmp_query[4].snmp_query_pkt_size = set_request_counter64_5bytes_size; 

    snmp_query[5].snmp_query_pkt_data = &get_request_counter64_5bytes_pkt[0];
    snmp_query[5].snmp_query_pkt_size = get_request_counter64_5bytes_size; 
    
    
    snmp_query[6].snmp_query_pkt_data = &set_request_timertic_pkt[0];
    snmp_query[6].snmp_query_pkt_size = set_request_timertic_size; 
    
    snmp_query[7].snmp_query_pkt_data = &get_request_timertic_pkt[0];
    snmp_query[7].snmp_query_pkt_size = get_request_timertic_size;  

    
    snmp_query[8].snmp_query_pkt_data = &set_request_string_pkt[0];
    snmp_query[8].snmp_query_pkt_size = set_request_string_size;  

    snmp_query[9].snmp_query_pkt_data = &get_request_string_pkt[0];
    snmp_query[9].snmp_query_pkt_size = get_request_string_size;  
...
UINT    status;
UINT    length = 0;
static  UINT get_request_count = 0;

     /* Increment the get request count. */
     get_request_count++;
    ...
    if (mib2_mib[i].object_get_octet_callback)
    {
            ...
            /* Yes, call the get octet function.  */
            status =  (mib2_mib[i].object_get_octet_callback)(mib2_mib[i].object_value_ptr, object_data, length);
    }
    ...
    /* Check for correct (expected) value. */
    if (get_request_count == 1) 
    {  
      if (COUNTER32_VAL != (INT)object_data -> nx_snmp_object_data_msw)
      {
           error_counter++;         
      }
    }
    else if (get_request_count == 2) 
    {  
      if (COUNTER64_VAL != (ULONG)object_data -> nx_snmp_object_data_lsw)
      {
           error_counter++;         
      }
    }
    else if (get_request_count == 3) 
    {  
      if ((COUNTER64_VAL0 != (ULONG)object_data -> nx_snmp_object_data_msw) ||
          (COUNTER64_VAL1 != (ULONG)object_data -> nx_snmp_object_data_lsw))
      {
           error_counter++;         
      }
    }

    if (get_request_count == 4) 
    {  
      if (TIMERTIC_VAL != (INT)object_data -> nx_snmp_object_data_msw)
      {
           error_counter++;         
      }
    }
    else if (get_request_count == 5)
    {
        if (memcmp(object_data -> nx_snmp_object_octet_string, STRING_TEST, strlen(STRING_TEST)))
        {
           error_counter++;
        }
    }
...
#endif
{
    ...
    printf("NetX Test:   SNMP Set Get Miscellaneous Data Type Test.................N/A\n");
