...
INT integer_data[] = {255, -255, -2345345, 1234};
...
extern char set_request_integer_255_pkt[43];
extern int  set_request_integer_255_size;
extern char get_request_integer_255_pkt[40];
extern int  get_request_integer_255_size;

extern char set_request_integer_neg255_pkt[43];
extern int  set_request_integer_neg255_size;
extern char get_request_integer_neg255_pkt[40];
extern int  get_request_integer_neg255_size;

extern char set_request_integer_neg2345345_pkt[44];
extern int  set_request_integer_neg2345345_size;
extern char get_request_integer_neg2345345_pkt[40];
extern int  get_request_integer_neg2345345_size;

extern char get_request_v1_1234_packet[];
extern int get_request_v1_1234_packet_size;
...
#else
void    netx_snmp_setget_integers_test_application_define(void *first_unused_memory)
#endif
{
...
UINT status;
    ...
    printf("NetX Test:   SNMP Set Get Integer Test.................................");
    ...
    if ((v2_my_agent.nx_snmp_agent_get_requests != 4) ||
        (v2_my_agent.nx_snmp_agent_set_requests != 3) ||
        (v2_my_agent.nx_snmp_agent_total_get_variables != 4) || 
        (v2_my_agent.nx_snmp_agent_packets_received != 7) ||
        (v2_my_agent.nx_snmp_agent_packets_sent != 7) ||
        (v2_my_agent.nx_snmp_agent_getresponse_sent != 7))
...
static void  snmp_test_initialize()
{
    ...
    snmp_query[0].snmp_query_pkt_data = &set_request_integer_255_pkt[0];
    snmp_query[0].snmp_query_pkt_size = set_request_integer_255_size;  


    snmp_query[1].snmp_query_pkt_data = &get_request_integer_255_pkt[0];
    snmp_query[1].snmp_query_pkt_size = get_request_integer_255_size; 
     
    snmp_query[2].snmp_query_pkt_data = &set_request_integer_neg255_pkt[0];
    snmp_query[2].snmp_query_pkt_size = set_request_integer_neg255_size;  

    snmp_query[3].snmp_query_pkt_data = &get_request_integer_neg255_pkt[0];
    snmp_query[3].snmp_query_pkt_size = get_request_integer_neg255_size; 
    
    snmp_query[4].snmp_query_pkt_data = &set_request_integer_neg2345345_pkt[0];
    snmp_query[4].snmp_query_pkt_size = set_request_integer_neg2345345_size;  

    snmp_query[5].snmp_query_pkt_data = &get_request_integer_neg2345345_pkt[0];
    snmp_query[5].snmp_query_pkt_size = get_request_integer_neg2345345_size;  

    snmp_query[6].snmp_query_pkt_data = &get_request_v1_1234_packet[0];
    snmp_query[6].snmp_query_pkt_size = get_request_v1_1234_packet_size;  
...
static  UINT get_request_count = 0;
    ...
    if (integer_data[get_request_count - 1] != (INT)object_data -> nx_snmp_object_data_msw)
    {
         error_counter++;
...
#endif
{
    ...
    printf("NetX Test:   SNMP Set Get Integer Test.................................N/A\n");
