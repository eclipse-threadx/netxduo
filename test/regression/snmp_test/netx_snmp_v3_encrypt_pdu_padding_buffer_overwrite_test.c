...
static UCHAR context_engine_id[] = {0x80, 0x00, 0x03, 0x10, 0x01, 0xc0, 0xa8, 0x64, 0xaf, 0x44, 0x55};
...
extern unsigned char v3_encrypt_pdu_padding_buffer_overwrite_packet1[165];
extern int           v3_encrypt_pdu_padding_buffer_overwrite_packet1_size;
...
#else
void    netx_snmp_v3_encrypt_pdu_padding_buffer_overwrite_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR    *pointer;
    ...
    /* Create a packet pool.  */
    status =  nx_packet_pool_create(&pool_1, "SNMP Packet Pool", 176, pointer, (sizeof(NX_PACKET) + 176) * 10);
    pointer = pointer + (sizeof(NX_PACKET) + 176) * 10;
...
NX_PACKET  *packet_ptr;
    ...
    printf("NetX Test:   SNMP V3 Encrypt PDU Padding Buffer Overwrite Test.........");
    ...
    status = nx_snmp_agent_create(&my_agent, "SNMP Agent", &agent_ip, snmp_stack, sizeof(snmp_stack), &pool_1, 
    ...
    my_agent.nx_snmp_agent_v3_context_engine_size = 6;
    ...
    while (pool_1.nx_packet_pool_available)
    {
        if ((nx_packet_allocate(&pool_1, &packet_ptr, 0, NX_NO_WAIT)) ||
            (packet_ptr -> nx_packet_pool_owner != &pool_1))
        {
            error_counter++;
            break;
        }
...
static void  snmp_test_initialize()
{
    snmp_query[0].snmp_query_pkt_data = &v3_encrypt_pdu_padding_buffer_overwrite_packet1[0];
    snmp_query[0].snmp_query_pkt_size = v3_encrypt_pdu_padding_buffer_overwrite_packet1_size;
}
...
#endif
{
    ...
    printf("NetX Test:   SNMP V3 Encrypt PDU Padding Buffer Overwrite Test.........N/A\n"); 
