...
#else
void    netx_web_keep_alive_abnormal_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NX_PACKET       *recv_packet;
    ...
    for (i = 0; i < loop ; i++)
    {
        ...
        for (test_count = 0; test_count < 2; test_count++)
        {
            ...
            /* Server disconnect the connection.  */
            if (test_count == 1)
            {
            ...
            /* Send GET with "connection: keep-alive", the connection should be kept alive.  */
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Keep Alive Abnormal Test..............................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Keep Alive Abnormal Test..............................N/A\n"); 
