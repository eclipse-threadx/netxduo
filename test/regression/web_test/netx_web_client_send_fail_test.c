...
#else
void    netx_web_client_send_fail_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
ULONG           temp;
    ...
    for (i = 0; i < loop ; i++)
    {
        ...
        for (j = 0; j < 2; j++)
        {
            ...
            if (j == 0)
            {
                temp = my_client.nx_web_http_client_socket.nx_tcp_socket_connect_mss;
                my_client.nx_web_http_client_socket.nx_tcp_socket_connect_mss = 1;
                ...
                my_client.nx_web_http_client_socket.nx_tcp_socket_connect_mss = temp;

                continue;
            }

            /* Send the request.  */
            status = nx_web_http_client_request_send(&my_client, NX_IP_PERIODIC_RATE);
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Client Send Fail Test.................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Client Send Fail Test.................................N/A\n"); 
