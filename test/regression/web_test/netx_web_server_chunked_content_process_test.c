/* This case tests server getting chunked content.  */
#include    "tx_api.h"
#include    "nx_api.h"
#include    "fx_api.h"
...
#define HEADER_CONTAIN_CONTENT 1

#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void    netx_web_server_chunked_content_process_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Server Chunked Content Process Test...................");
...
UINT         length;
    ...
    if(request_type == NX_WEB_HTTP_SERVER_PUT_REQUEST)
    {
        ...
        while (1)
        {
            ...
            status = nx_web_http_server_content_get_extended(server_ptr, packet_ptr, content_length, buffer, sizeof(buffer), &length);
        ...
        status = nx_web_http_server_packet_content_find(server_ptr, &packet_ptr, (ULONG *)&length);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Server Chunked Content Process Test...................N/A\n");
