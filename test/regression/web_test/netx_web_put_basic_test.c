/* This case tests basic PUT method. */
#include    "tx_api.h"
#include    "nx_api.h"
#include    "fx_api.h"
...
#else
void    netx_web_put_basic_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
    ...
    for (i = 0; i < loop ; i++)
    {
        ...
        if (i == 0)
        {
            ...
            status = nx_web_http_client_put_start(&my_client, &server_ip_address,
                                                  NX_WEB_HTTP_SERVER_PORT,"http://1.2.3.4/http_put_test.html",
        ...
        else if (i == 2)
        {
            ...
            status = nx_web_http_client_put_secure_start(&my_client, &server_ip_address,
                                                         NX_WEB_HTTPS_SERVER_PORT, "https://1.2.3.4/https_put_test.html",
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Put Basic Test........................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Put Basic Test........................................N/A\n"); 
