...
#else
void    netx_web_client_cleanup_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
    ...
    for (i = 0; i < loop; i++)
    {
        ...
        if (i == 0)
        {
            ...
            status = nx_web_http_client_put_start(&my_client, &server_ip_address,
                                                  NX_WEB_HTTP_SERVER_PORT, "http://www.abc.com/client_test.htm",
        ...
        else
        {
            ...
            status = nx_web_http_client_put_secure_start(&my_client, &server_ip_address,
                                                         NX_WEB_HTTPS_SERVER_PORT, "https://www.abc.com/client_test1.htm",
        ...
        _nx_web_http_client_error_exit(&my_client, 1 * NX_IP_PERIODIC_RATE);
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Client Cleanup Test...................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Client Cleanup Test...................................N/A\n"); 
