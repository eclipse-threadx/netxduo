...
0x00, 0x7e, 0x0b, 0xd2, 0x40, 0x00, 0x80, 0x06, /* .~..@... */
0x6c, 0x73, 0xc0, 0xa8, 0x00, 0x69, 0xc0, 0xa8, /* ls...i.. */
0x00, 0x7b, 0xca, 0x95, 0x00, 0x50, 0x66, 0x2b, /* .{...Pf+ */
0xe7, 0x60, 0xb6, 0xa2, 0xe6, 0xf3, 0x50, 0x18, /* .`....P. */
0xfa, 0xf0, 0x59, 0x33, 0x00, 0x00, 0x47, 0x45, /* ..Y3..GE */
...
#else
void    netx_web_status_400_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
CHAR            *buffer_ptr;
    ...
    for (i = 0; i < 2 ; i++)
    {
        ...
        else
        {
            ...
            /* Check the status, If success , it should be 400. */
            if((buffer_ptr[9] != '4') || (buffer_ptr[10] != '0') || (buffer_ptr[11] != '0'))
                error_counter++;
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Status 400 Test.......................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Status 400 Test.......................................N/A\n"); 
