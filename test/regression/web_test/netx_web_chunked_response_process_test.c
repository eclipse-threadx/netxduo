/* This case tests chunked response processing.  */
#include    "tx_api.h"
#include    "nx_api.h"
#include    "fx_api.h"
...
/* Packet_length: 146, header length: 71, boday length: 75 */
static UINT test_pkt_frag[][5] = 
{
    {146, 0, 0, 0, 0},   /* headerxx\r\n....\r\nxx\r\n....\r\nxx\r\n....\r\n0\r\n\r\n */
...
static UINT test_content_length = 0x14 + 0xc + 0x14;
...
0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74, /* testtest */
0x0d, 0x0a,                                     /* ..       */ /*26*/
0x30, 0x63, 0x3B, 0x45, 0x4c, 0x0d, 0x0a, 0x74, 0x65, 0x73, 0x74, /* 0c;EL..test */
0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74, /* testtest */
0x0d, 0x0a,                                     /* ..       */ /*18*/
0x31, 0x32, 0x34, 0x0d, 0x0a, 0x74, 0x65, 0x73, 0x74, /* 124..test */
0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74, /* testtest */
0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74, /* testtest */
0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74, /* testtest */
0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74, /* testtest */
...
/* Packet_length: 419, header length: 71, boday length: 348 */
static UINT test_pkt_frag[][5] = 
{
    {422, 0, 0, 0, 0},   /* headerxx\r\n....\r\nxx\r\n....\r\nxx\r\n....\r\n0\r\n\r\n */
};

static UINT test_content_length = 0x14 + 0xc + 0x124;

#endif

static UINT test_num = sizeof(test_pkt_frag)/(5 * sizeof(UINT));
static UINT test_count = 0;

#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void    netx_web_chunked_response_process_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Chunked Response Process Test.........................");
...
UCHAR       *data_ptr;
    ...
    if(request_type == NX_WEB_HTTP_SERVER_GET_REQUEST)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            status = nx_packet_data_append(response_pkt, data_ptr, test_pkt_frag[test_count][i], &server_pool, NX_WAIT_FOREVER);
            ...
            data_ptr += test_pkt_frag[test_count][i];
        }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Chunked Response Process Test.........................N/A\n");
