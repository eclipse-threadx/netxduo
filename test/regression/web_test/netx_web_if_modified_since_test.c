...
#if defined(WIN32) || defined(__linux__)
static VOID get_gmt(NX_WEB_HTTP_SERVER_DATE *now);
static UINT cache_info_get(CHAR *resource, UINT *max_age, NX_WEB_HTTP_SERVER_DATE *last_modified);
#endif /* defined(WIN32) || defined(__linux__) */

#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void    netx_web_if_modified_since_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web If Modified Since Test................................");
...
#if defined(WIN32) || defined(__linux__)
        nx_web_http_server_gmt_callback_set(&my_server, get_gmt);
        nx_web_http_server_cache_info_callback_set(&my_server, cache_info_get);
#endif /* defined(WIN32) || defined(__linux__) */
...
struct tm *timeinfo;
    ...
    now -> nx_web_http_server_day = timeinfo -> tm_mday;
    now -> nx_web_http_server_month = timeinfo -> tm_mon;
    now -> nx_web_http_server_year = timeinfo -> tm_year + 1900;
    now -> nx_web_http_server_hour = timeinfo -> tm_hour;
    now -> nx_web_http_server_minute = timeinfo -> tm_min;
    now -> nx_web_http_server_second = timeinfo -> tm_sec;
    now -> nx_web_http_server_weekday = timeinfo -> tm_wday;


}

UINT    cache_info_get(CHAR *resource, UINT *max_age, NX_WEB_HTTP_SERVER_DATE *last_modified)
{
    *max_age = 315360000;

    /* 20130101 */
    last_modified -> nx_web_http_server_day = 1;
    last_modified -> nx_web_http_server_month = 0;
    last_modified -> nx_web_http_server_year = 113 + 1900; /* 2013 */
    last_modified -> nx_web_http_server_hour = 0;
    last_modified -> nx_web_http_server_minute = 0;
    last_modified -> nx_web_http_server_second = 0;
    last_modified -> nx_web_http_server_weekday = 2;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web If Modfied Since Test.................................N/A\n"); 
