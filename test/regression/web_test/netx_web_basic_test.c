...
NX_PACKET       *recv_packet;
    ...
    for (i = 0; i < loop ; i++)
    {
        ...
        {
            /* Initialize the request.  */
            status = nx_web_http_client_request_initialize_extended(&my_client, NX_WEB_HTTP_METHOD_GET, "/test.txt", 9, "1.2.3.4", 7, 
                                                                    0, NX_FALSE, "name", 4, "password", 8, NX_WAIT_FOREVER);
        }
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Basic Test............................................");
