...
#else
void    netx_web_status_501_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
CHAR            *buffer_ptr;
    ...
    for (i = 0; i < loop ; i++)
    {
        ...
        else
        {
            ...
            /* Check the status, If success , it should be 501. */
...
UINT            server_port = NX_WEB_HTTP_SERVER_PORT;
    ...
    printf("NetX Test:   Web Status 501 Test.......................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   Web Status 501 Test.......................................N/A\n"); 
