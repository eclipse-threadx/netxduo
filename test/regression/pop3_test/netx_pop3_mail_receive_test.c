...
0x2b, 0x4f, /* ..}...+O */
0x4b, 0x20, 0x31, 0x20, 0x31, 0x38, 0x37, 0x34, /* K 1 1874 */
...
#else
void    netx_pop3_mail_receive_test_application_define(void *first_unused_memory)
#endif
{
...
UINT         i =0;
    ...
    printf("NetX Test:   POP3 Mail Receive Test...................................."); 
...
static UINT pop3_initialize_responses()
{
    ...
    pop3_response[9].pop3_response_pkt_data = &quit_ok[0];
    pop3_response[9].pop3_response_pkt_size = quit_ok_size ; 
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   POP3 Mail Receive Test....................................N/A\n"); 
