...
/* Define the TLS setup fail function for tls connection. */
UINT tls_setup_fail(NXD_MQTT_CLIENT* client_ptr, NX_SECURE_TLS_SESSION* tls_session,
...
INT         test_result = 0;
    ...
    exit_if_fail(1 == status, TLS_TEST_UNKNOWN_TYPE_ERROR);
