...
#if defined(NX_SECURE_TLS_ENABLE_TLS_1_1) && !defined(NX_SECURE_TLS_CLIENT_DISABLED)
...
CHAR* external_cmd[] = { "openssl", "s_server", "-port", DEVICE_SERVER_PORT_STRING, "-rev", "-key", "key.pem", "-cert", "cert.pem", "-naccept", "1", "-tls1_1", (CHAR*)NULL};
...
#else /* defined(NX_SECURE_TLS_ENABLE_TLS_1_1) && !defined(NX_SECURE_TLS_CLIENT_DISABLED) */

    return TLS_TEST_NOT_AVAILABLE;

#endif /* defined(NX_SECURE_TLS_ENABLE_TLS_1_1) && !defined(NX_SECURE_TLS_CLIENT_DISABLED) */
