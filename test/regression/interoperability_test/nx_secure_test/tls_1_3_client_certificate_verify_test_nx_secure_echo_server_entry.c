...
#if !defined(NX_SECURE_TLS_SERVER_DISABLED) && defined(NX_SECURE_ENABLE_ECC_CIPHERSUITE) && defined(NX_SECURE_ENABLE_CLIENT_CERTIFICATE_VERIFY)
...
NX_SECURE_X509_CERT server_trusted_ca;
NX_SECURE_X509_CERT server_remote_cert;
