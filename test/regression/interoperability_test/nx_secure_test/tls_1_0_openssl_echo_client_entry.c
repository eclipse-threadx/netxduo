...
#if defined(NX_SECURE_TLS_ENABLE_1_0) && !defined(NX_SECURE_TLS_SERVER_DISABLED)

/* Just use TLSv1.2 */
CHAR* external_cmd[] = { "openssl_echo_client.sh", TLS_TEST_IP_ADDRESS_STRING, DEVICE_SERVER_PORT_STRING, "-tls1", (CHAR*)NULL};
...
#else /* defined(NX_SECURE_TLS_ENABLE_1_0) && !defined(NX_SECURE_TLS_SERVER_DISABLED) */

    return TLS_TEST_NOT_AVAILABLE;

#endif /* defined(NX_SECURE_TLS_ENABLE_1_0) && !defined(NX_SECURE_TLS_SERVER_DISABLED) */
