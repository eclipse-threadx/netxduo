/* No.5 The control connection is used for the transfer of commands.
...
#else
void    netx_ftp_control_connection_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    if(status != NX_NOT_CONNECTED && status != NX_SUCCESS)
        error_counter++;
...
UINT    status;
    ...
    printf("NetX Test:   FTP Control Connection Test...............................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   FTP Control Connection Test...............................N/A\n"); 
