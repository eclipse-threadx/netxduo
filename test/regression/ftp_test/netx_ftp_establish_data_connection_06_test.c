...
#else
void    netx_ftp_establish_data_connection_06_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    status;
    ...
    printf("NetX Test:   FTP Server Close Data Connection 06 Test..................");
    ...
    if((error_counter !=0) && ( eof_counter == 1))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   FTP Server Close Data Connection 06 Test..................N/A\n"); 
