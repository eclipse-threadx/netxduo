...
#else
void    netx_ftp_client_pasv_file_write_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    status =  nx_ftp_client_file_open(&ftp_client, "socket_tcp_client_recv2.pl", NX_FTP_OPEN_FOR_WRITE, 100);
    if (status != NX_SUCCESS) 
    {
        error_counter++;
    }
    ...
    } while ((status == NX_SUCCESS) && (packets_sent < 2));
...
UINT         i;
    ...
    printf("NetX Test:   FTP Passive Mode Transfer File Write Test................."); 
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   FTP Passive Mode Transfer File Write Test.................N/A\n"); 
