/* Clent sends PASV and format of IP address and port in the response. */
#include    "tx_api.h"
#include    "fx_api.h" 
#include    "nx_api.h"
...
#else
void    netx_ftp_pasv_port_test_application_define(void *first_unused_memory)
#endif
{
...
UCHAR       buffer[] = "227 Entering Passive Mode (1,2,3,4,192,0).\r\n";
UINT        status;
    ...
    else
    {
        ...
        /* Check if the format of IP address and port are correct. */
        if ((recv_packet_ptr -> nx_packet_length != (sizeof(buffer) - 1)) || 
            (memcmp(recv_packet_ptr -> nx_packet_prepend_ptr, buffer, sizeof(buffer) - 1) != 0))
        {
            error_counter++;
        }
...
void    thread_server_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   FTP PASV Port Test........................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   FTP PASV Port Test........................................N/A\n"); 
