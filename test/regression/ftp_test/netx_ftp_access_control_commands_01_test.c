...
#else
void    netx_ftp_access_control_commands_01_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    status;
    ...
    printf("NetX Test:   FTP Server Access Control Commands User 01 Test...........");
    ...
    if((error_counter) && ( username_counter != 1 ))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
UCHAR            *message;
    ...
    if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT) && (flag != 1))
    {
    ...
    /* When ftp client connect the ftp server, increase the flage to make sure the "User" packet is the first packet we get. */
    if(flag)
        flag++;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   FTP Server Access Control Commands User 01 Test...........N/A\n"); 
