/* Clent sends NLST and disconnets data socket. */
#include    "tx_api.h"
#include    "fx_api.h" 
#include    "nx_api.h"
...
#else
void    netx_ftp_disconnection_event_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    /* Send NLST command. The direcotory doesn't exist, should returen error and disconnect the data socket. */
    status = nx_ftp_client_directory_listing_get(&ftp_client, "/test", &recv_packet_ptr, NX_IP_PERIODIC_RATE);
    if (status == NX_SUCCESS)
    {
        error_counter++;
    ...
    /* Let server processing disconnetion event. */
...
void    thread_server_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   FTP Disconnection Evnet Test..............................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   FTP Disconnection Event Test..............................N/A\n"); 
