...
#else
void    netx_ftp_pasv_twice_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    /* This sends PASV commands and opens data socket.  */
    ...
    /* Write QUIT into the packet payload  */
    memcpy(my_packet -> nx_packet_prepend_ptr, "QUIT\r\n", 6);
    my_packet -> nx_packet_length =  6;
    my_packet -> nx_packet_append_ptr =  my_packet -> nx_packet_prepend_ptr + 6;
    ...
    ftp_client.nx_ftp_client_state =  NX_FTP_STATE_NOT_CONNECTED;
    nx_tcp_socket_disconnect(&(ftp_client.nx_ftp_client_control_socket), NX_NO_WAIT);
    nx_tcp_client_socket_unbind(&(ftp_client.nx_ftp_client_control_socket));
...
void    thread_server_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   FTP PASV Twice Test.......................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   FTP PASV Twice Test.......................................N/A\n"); 
