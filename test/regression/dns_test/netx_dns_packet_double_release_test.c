...
#if !defined(NX_DISABLE_IPV4) && !defined (NX_DISABLE_PACKET_INFO)

#define     DEMO_STACK_SIZE         2048
#define     NX_PACKET_SIZE          1536
#define     NX_PACKET_POOL_SIZE     ((NX_PACKET_SIZE + sizeof(NX_PACKET)) * 32)
...
static ULONG                   pool_stack[NX_PACKET_POOL_SIZE / sizeof(ULONG)];
...
#else
void    netx_dns_packet_double_release_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR    *pointer;
    ...
    status =  nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", NX_PACKET_SIZE, pool_stack, NX_PACKET_POOL_SIZE);
...
UINT        record_count;
    ...
    printf("NetX Test:   DNS Packet Double Free Test...............................");
    ...
    /* Send query.  */
    status = nx_dns_ipv4_address_by_name_get(&client_dns, (UCHAR *)"google.com", &record_buffer[0], 64, &record_count, 1);

    /* Check status, ID mismatch.  */
    ...
    /* Check if there is invalid packet release.  */
...

{
    ...
    printf("NetX Test:   DNS Packet Double Free Test...............................N/A\n");
