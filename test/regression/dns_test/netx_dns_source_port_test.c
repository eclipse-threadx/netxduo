...
#else
void    netx_dns_source_port_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        record_count;
    ...
    printf("NetX Test:   DNS Source Port Test......................................");
    ...
    /* Check the port.  */
    if (dns_query_port_1 == dns_query_port_2)
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...

{
    ...
    printf("NetX Test:   DNS Source Port Test......................................N/A\n");
