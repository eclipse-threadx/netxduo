...
#else
void    netx_ppp_IPCP_nak_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   PPP IPCP NAK Test.........................................");
    ...
    status =  nx_ip_status_check(&ip_0, NX_IP_LINK_ENABLED, &ip_status, 30 * NX_IP_PERIODIC_RATE);
...
static UCHAR configure_request[] = {0x7E, 0xFF, 0x7D, 0x23, 0x80, 0x21, 0x7D, 0x21};
...
static void    ppp_1_serial_byte_output(UCHAR byte)
{
    ...
    /* Discard IPCP Configure Request before NX_PPP_IPCP_CONFIGURE_REQUEST_ACKED_STATE. */
    if (ppp_0.nx_ppp_ipcp_state > NX_PPP_IPCP_INITIAL_STATE &&
        ppp_0.nx_ppp_ipcp_state < NX_PPP_IPCP_CONFIGURE_REQUEST_ACKED_STATE)
    {
        ...
        else if (memcmp(temp_data, configure_request, 8) != 0)
        {
        ...
        else
        {
            for (;i < temp_index; i++)
            {
                nx_ppp_byte_receive(&ppp_0, temp_data[i]);
            }
        }
    }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   PPP IPCP NAK Test.........................................N/A\n"); 
