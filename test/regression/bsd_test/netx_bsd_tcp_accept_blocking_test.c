...
#else
void    netx_bsd_tcp_accept_blocking_test_application_define(void *first_unused_memory)
#endif
{
...
static void    ntest_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   Basic BSD TCP Accept Blocking Test............");
...
#endif
{
    ...
    printf("NetX Test:   Basic BSD TCP Accept Blocking Test............N/A\n"); 
