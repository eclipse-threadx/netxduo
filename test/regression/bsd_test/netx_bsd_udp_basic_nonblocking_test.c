...
#else
void    netx_bsd_udp_basic_nonblocking_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    status;
    ...
    /* Check BSD init and udp enable status.  */
    if (status)
        error_counter++;
}
...
UINT status;
    ...
    printf("NetX Test:   Basic BSD UDP Non-Blocking Test...............");
...
#endif
{
    ...
    printf("NetX Test:   Basic BSD UDP Non-Blocking Test...............N/A\n"); 
