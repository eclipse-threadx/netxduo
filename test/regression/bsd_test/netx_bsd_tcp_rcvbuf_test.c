...
#include   "tx_api.h"
#include   "nx_api.h"
#if defined(NX_BSD_ENABLE) && !defined(NX_DISABLE_IPV4) && defined(NX_ENABLE_TCP_WINDOW_SCALING) && defined(__PRODUCT_NETXDUO__)
#include   "nx_icmpv6.h"
#include   "nxd_bsd.h"
...
#else
void    netx_bsd_tcp_rcvbuf_test_application_define(void *first_unused_memory)
#endif
{
...
struct sock_winsize option;
    ...
    option.winsize = 0x10000;
    if(setsockopt(sockfd, SOL_SOCKET, SO_RCVBUF, &option, sizeof(option)) < 0)
        error_counter++;
...
struct sock_winsize option;
    ...
    for(i = 0; i < NUM_CLIENTS; i++)
    {
        ...
        option.winsize = 0x10000;
        if(setsockopt(newsock, SOL_SOCKET, SO_RCVBUF, &option, sizeof(option)) < 0)
            error_counter++;
...
int                ret;
    ...
    printf("NetX Test:   Basic BSD TCP RCVBUF Test....................."); 
...
#endif
{
    ...
    printf("NetX Test:   Basic BSD TCP RCVBUF Test.....................N/A\n"); 
