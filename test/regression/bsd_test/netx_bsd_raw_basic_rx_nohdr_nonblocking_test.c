...
#else
void    netx_bsd_raw_basic_rx_nohdr_nonblocking_test_application_define(void *first_unused_memory)
#endif
{
...
UINT status;
    ...
    printf("NetX Test:   Basic BSD RAW RX NoHdr Non-Blocking Test......");
...
#endif
{
    printf("NetX Test:   Basic BSD RAW RX NoHdr Non-Blocking Test......N/A\n");
    test_control_return(3);
}
