...
#else
void    netx_tftp_error_destination_port_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    printf("NetX Test:   TFTP Error Destination Port Test..........................");
...
/* 1. Host A sends a "WRQ" to host B with source = A's TID, destination = 69/
   2. Host B sends a "ACK" (with block number = 0) to host A with source = B's TID, destination = A's TID.  RFC1350, Section4, Page5.  */
...
UINT                    src_port,dest_port; 
    ...
    udp_header_ptr -> nx_udp_header_word_0 = udp_header_ptr -> nx_udp_header_word_0 & 0xFFFF0000;
    udp_header_ptr -> nx_udp_header_word_0 = udp_header_ptr -> nx_udp_header_word_0| (NX_TFTP_SERVER_PORT + 1);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TFTP Error Destination Port Test..........................N/A\n"); 
