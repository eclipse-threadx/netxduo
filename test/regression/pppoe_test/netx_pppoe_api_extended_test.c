...
#else
void    netx_pppoe_api_extended_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG   network_mask;
    ...
    /* Set host unique.  */
    status = nx_pppoe_client_host_uniq_set_extended(&pppoe_client, "220000000000000041000000", sizeof("220000000000000041000000") - 1);
    if (status)
    {
        error_counter++;
    }
    ...
    /* Set service name.  */
    status = nx_pppoe_client_service_name_set_extended(&pppoe_client, "BRAS", sizeof("BRAS") - 1);
    if (status)
    {
        error_counter++;
    }
...
ULONG   network_mask;
    ...
    printf("NetX Test:   PPPoE API Extended Test...................................");
    ...
    status = nx_pppoe_server_ac_name_set(&pppoe_server, (UCHAR *)"PPPoE Server AC", sizeof("PPPoE Server AC") - 1);
    if (status)
    {
        error_counter++;
    }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   PPPoE API Extended Test...................................N/A\n"); 
