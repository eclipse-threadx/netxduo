...
extern TAHI_TEST_SEQ tahi_02_134[];

extern int tahi_02_134_size;
...
static void build_test_suite(void)
{
    ...
    test_suite[0].test_case = &tahi_02_134[0]; test_suite[0].test_case_size = tahi_02_134_size;
...
#else
void           netx_tahi_test_2_9_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
