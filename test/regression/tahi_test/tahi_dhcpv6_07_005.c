...
/* Frame (104 bytes) */
static char pkt9[104] = {
    0x00, 0x11, 0x22, 0x33, 0x44, 0x56, 0x00, 0x00, /* .."3DV.. */
    0x00, 0x00, 0xa1, 0xa1, 0x86, 0xdd, 0x60, 0x00, /* ......`. */
    0x00, 0x00, 0x00, 0x32, 0x11, 0x01, 0xfe, 0x80, /* ...2.... */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0xa1, 0xa1, 0xfe, 0x80, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
    0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0x02, 0x27, /* "..3DV.' */
    0x83, 0x00, 0x00, 0x32, 0x39, 0x36, 0x07, 0x3e, /* ...296.> */
    0xf0, 0x12, 0x00, 0x02, 0x00, 0x0e, 0x00, 0x01, /* ........ */
    0x00, 0x01, 0x00, 0x06, 0x1a, 0x80, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0xa1, 0xa1, 0x00, 0x17, 0x00, 0x10, /* ........ */
...
static char pkt12[152] = {
    0x00, 0x00, 0x00, 0x00, 0xa1, 0xa1, 0x00, 0x11, /* ........ */
    0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
    0x00, 0x00, 0x00, 0x62, 0x3a, 0xff, 0xfe, 0x80, /* ...b:... */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
    0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0xfe, 0x80, /* "..3DV.. */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0xa1, 0xa1, 0x01, 0x04, /* ........ */
    0x86, 0x31, 0x00, 0x00, 0x00, 0x00, 0x60, 0x00, /* .1....`. */
    0x00, 0x00, 0x00, 0x32, 0x11, 0x01, 0xfe, 0x80, /* ...2.... */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0xa1, 0xa1, 0xfe, 0x80, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
TAHI_TEST_SEQ tahi_dhcpv6_07_005[] = {
    {TITLE, "dhcpv6 07-005", 13, 0},
    ...
    {CHECK,  &pkt12[0], sizeof(pkt12), 5},    /* Dest unreachable */

    {INJECT, &pkt13[0], sizeof(pkt13), 0},    /* NA */
    {INJECT, &pkt14[0], sizeof(pkt14), 0},    /* Echo Request */
    
    {WAIT, NX_NULL, 0, 10}, 

    {INJECT, &pkt21[0], sizeof(pkt21), 0},    /* RA */
    {INJECT, &pkt22[0], sizeof(pkt22), 0},    /* NA */

    {INJECT, &pkt23[0], sizeof(pkt23), 0},    /* Echo Request */
    {CHECK,  &pkt24[0], sizeof(pkt24), 5},    /* Echo Reply */
...
int  tahi_dhcpv6_07_005_size = sizeof(tahi_dhcpv6_07_005) / sizeof(TAHI_TEST_SEQ);
#endif
