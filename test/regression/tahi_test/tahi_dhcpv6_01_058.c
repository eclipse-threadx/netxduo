...
TAHI_TEST_SEQ tahi_dhcpv6_01_058[] = {
    {TITLE, "dhcpv6 01-058", 13, 0},
    ...
    {N_CHECK, (CHAR *)RELEASE, 0 ,     15},

    {CLEANUP, NX_NULL, 0, 0},
    {DUMP, NX_NULL, 0, 0}
};

int  tahi_dhcpv6_01_058_size = sizeof(tahi_dhcpv6_01_058) / sizeof(TAHI_TEST_SEQ);
#endif
