...
static char pkt17[162] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
    0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0x02, 0x23, /* "..3DV.# */
    0x02, 0x22, 0x00, 0x6c, 0x73, 0xbc, 0x07, 0x52, /* .".ls..R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x02, 0x00, 0x0e, /* "3DV.... */
    0x00, 0x01, 0x00, 0x01, 0x00, 0x06, 0x1a, 0x80, /* ........ */
...
TAHI_TEST_SEQ tahi_dhcpv6_01_005[] = {
    {TITLE, "dhcpv6 01-005", 13, 0},
    ...
    {WAIT,   NX_NULL,  0, 15}, /* Wait for the second RENEW. */
    {CHECK,  &pkt15[0], sizeof(pkt15), 5},
    {WAIT,   NX_NULL,  0, 25}, /* Wait for the REBIND. */
...
int  tahi_dhcpv6_01_005_size = sizeof(tahi_dhcpv6_01_005) / sizeof(TAHI_TEST_SEQ);
#endif
