...
TAHI_TEST_SEQ tahi_dhcpv6_01_079[] = {
    {TITLE, "dhcpv6 01-079", 13, 0},
...
int  tahi_dhcpv6_01_079_size = sizeof(tahi_dhcpv6_01_079) / sizeof(TAHI_TEST_SEQ);
#endif
