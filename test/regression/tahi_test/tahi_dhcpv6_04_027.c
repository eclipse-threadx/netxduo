...
TAHI_TEST_SEQ tahi_dhcpv6_04_027[] = {
    {TITLE, "dhcpv6 04-027", 13, 0},

    {CHECK,  &pkt4[0], sizeof(pkt4), 30},
    {DHCPV6_REBOOT, NX_NULL, 0, 0},

    {CHECK,  &pkt10[0], sizeof(pkt10), 5}, /* RS */
    {INJECT, &pkt13[0], sizeof(pkt13), 0}, /* RA */

    {CHECK,  &pkt15[0], sizeof(pkt15), 30},
   
    {CLEANUP, NX_NULL, 0, 0},
    {DUMP, NX_NULL, 0, 0}
};

int  tahi_dhcpv6_04_027_size = sizeof(tahi_dhcpv6_04_027) / sizeof(TAHI_TEST_SEQ);
