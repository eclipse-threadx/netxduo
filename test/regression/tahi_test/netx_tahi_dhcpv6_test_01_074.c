...
extern TAHI_TEST_SEQ tahi_dhcpv6_01_074[];
extern int  tahi_dhcpv6_01_074_size;

static ULONG                    original_xid;
static UCHAR                    original_cid[18];
static UINT                     confirm_count;

#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void netx_tahi_dhcpv6_test_01_074_define(void * first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT        status;
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_074[0], tahi_dhcpv6_01_074_size);
...
UCHAR           cid[18] = {0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, 0x00, 0x01,
    ...
    if(src_dst_port == 0x02220223)
    {
        ...
        if((message_type == NX_DHCPV6_MESSAGE_TYPE_SOLICIT))
        {
            ...
            {
                *(ULONG *)(packet_ptr -> nx_packet_prepend_ptr + 8) = 0xa4e49601;
            }
        }
