...
extern TAHI_TEST_SEQ tahi_ipsec_006[];
extern TAHI_TEST_SEQ tahi_ipsec_007[];
extern TAHI_TEST_SEQ tahi_ipsec_008[];
/*
extern TAHI_TEST_SEQ tahi_ipsec_008_02[];
*/
extern TAHI_TEST_SEQ tahi_ipsec_009[];
extern TAHI_TEST_SEQ tahi_ipsec_009_02[];
extern TAHI_TEST_SEQ tahi_ipsec_010[];
extern TAHI_TEST_SEQ tahi_ipsec_011[];
extern TAHI_TEST_SEQ tahi_ipsec_012[];
extern TAHI_TEST_SEQ tahi_ipsec_013[];
extern TAHI_TEST_SEQ tahi_ipsec_014[];
extern TAHI_TEST_SEQ tahi_ipsec_015[];
extern TAHI_TEST_SEQ tahi_ipsec_016[];
extern TAHI_TEST_SEQ tahi_ipsec_017[];
extern TAHI_TEST_SEQ tahi_ipsec_018[];
extern TAHI_TEST_SEQ tahi_ipsec_019[];
extern TAHI_TEST_SEQ tahi_ipsec_020[];
extern TAHI_TEST_SEQ tahi_ipsec_021[];
extern TAHI_TEST_SEQ tahi_ipsec_022[];
extern TAHI_TEST_SEQ tahi_ipsec_023[];
extern TAHI_TEST_SEQ tahi_ipsec_024[];
extern TAHI_TEST_SEQ tahi_ipsec_025[];
extern TAHI_TEST_SEQ tahi_ipsec_026[];

extern int tahi_ipsec_006_size;
extern int tahi_ipsec_007_size;
extern int tahi_ipsec_008_size;
//extern int tahi_ipsec_008_02_size;
extern int tahi_ipsec_009_size;
extern int tahi_ipsec_009_02_size;
extern int tahi_ipsec_010_size;
extern int tahi_ipsec_011_size;
extern int tahi_ipsec_012_size;
extern int tahi_ipsec_013_size;
extern int tahi_ipsec_014_size;
extern int tahi_ipsec_015_size;
extern int tahi_ipsec_016_size;
extern int tahi_ipsec_017_size;
extern int tahi_ipsec_018_size;
extern int tahi_ipsec_019_size;
extern int tahi_ipsec_020_size;
extern int tahi_ipsec_021_size;
extern int tahi_ipsec_022_size;
extern int tahi_ipsec_023_size;
extern int tahi_ipsec_024_size;
extern int tahi_ipsec_025_size;
...
static void build_test_suite(void)
{
    ...
    test_suite[0].test_case = &tahi_ipsec_006[0];       test_suite[0].test_case_size = tahi_ipsec_006_size;
    test_suite[1].test_case = &tahi_ipsec_007[0];       test_suite[1].test_case_size = tahi_ipsec_007_size;
    test_suite[2].test_case = &tahi_ipsec_008[0];       test_suite[2].test_case_size = tahi_ipsec_008_size;
//    test_suite[3].test_case = &tahi_ipsec_008_02[0];    test_suite[3].test_case_size = tahi_ipsec_008_02_size;
    test_suite[4].test_case = &tahi_ipsec_009[0];       test_suite[4].test_case_size = tahi_ipsec_009_size;
    test_suite[5].test_case = &tahi_ipsec_009_02[0];    test_suite[5].test_case_size = tahi_ipsec_009_02_size;
    test_suite[6].test_case = &tahi_ipsec_010[0];       test_suite[6].test_case_size = tahi_ipsec_010_size;
 //   test_suite[7].test_case = &tahi_ipsec_011[0];       test_suite[7].test_case_size = tahi_ipsec_011_size;
    test_suite[8].test_case = &tahi_ipsec_012[0];       test_suite[8].test_case_size = tahi_ipsec_012_size;
    test_suite[9].test_case = &tahi_ipsec_013[0];       test_suite[9].test_case_size = tahi_ipsec_013_size;
    test_suite[10].test_case = &tahi_ipsec_014[0];      test_suite[10].test_case_size = tahi_ipsec_014_size;
    test_suite[11].test_case = &tahi_ipsec_015[0];      test_suite[11].test_case_size = tahi_ipsec_015_size;
    test_suite[12].test_case = &tahi_ipsec_016[0];      test_suite[12].test_case_size = tahi_ipsec_016_size;
    test_suite[13].test_case = &tahi_ipsec_017[0];      test_suite[13].test_case_size = tahi_ipsec_017_size;
    test_suite[14].test_case = &tahi_ipsec_018[0];      test_suite[14].test_case_size = tahi_ipsec_018_size;
    test_suite[15].test_case = &tahi_ipsec_019[0];      test_suite[15].test_case_size = tahi_ipsec_019_size;
//    test_suite[16].test_case = &tahi_ipsec_020[0];      test_suite[16].test_case_size = tahi_ipsec_020_size;
//    test_suite[17].test_case = &tahi_ipsec_021[0];      test_suite[17].test_case_size = tahi_ipsec_021_size;
    test_suite[18].test_case = &tahi_ipsec_022[0];      test_suite[18].test_case_size = tahi_ipsec_022_size;
    test_suite[19].test_case = &tahi_ipsec_023[0];      test_suite[19].test_case_size = tahi_ipsec_023_size;
    test_suite[20].test_case = &tahi_ipsec_024[0];      test_suite[20].test_case_size = tahi_ipsec_024_size;
    test_suite[21].test_case = &tahi_ipsec_025[0];      test_suite[21].test_case_size = tahi_ipsec_025_size;
    test_suite[22].test_case = &tahi_ipsec_026[0];      test_suite[22].test_case_size = tahi_ipsec_026_size;
...
#else
void           netx_tahi_test_ipsec_2_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
