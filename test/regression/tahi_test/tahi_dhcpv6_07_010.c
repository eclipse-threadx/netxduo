...
TAHI_TEST_SEQ tahi_dhcpv6_07_010[] = {
    {TITLE, "dhcpv6 07-010", 13, 0},
...
int  tahi_dhcpv6_07_010_size = sizeof(tahi_dhcpv6_07_010) / sizeof(TAHI_TEST_SEQ);
#endif
