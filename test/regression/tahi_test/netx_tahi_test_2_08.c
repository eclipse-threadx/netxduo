...
extern TAHI_TEST_SEQ tahi_02_133[];

extern int tahi_02_133_size;
...
static void build_test_suite(void)
{
    ...
    test_suite[0].test_case = &tahi_02_133[0]; test_suite[0].test_case_size = tahi_02_133_size;
...
#else
void           netx_tahi_test_2_8_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
