...
extern TAHI_TEST_SEQ tahi_dhcpv6_01_076[];
extern int  tahi_dhcpv6_01_076_size;
...
#else
void netx_tahi_dhcpv6_test_01_076_define(void * first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT        status;
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_076[0], tahi_dhcpv6_01_076_size);
    ...
    if(src_dst_port == 0x02220223)
    {
        ...
        else if(message_type == NX_DHCPV6_MESSAGE_TYPE_REQUEST)
        {
            ...
            if(renew_count == 0)
                ...
                *(ULONG *)(packet_ptr -> nx_packet_prepend_ptr + 8) = 0xa4e49603;
        }
