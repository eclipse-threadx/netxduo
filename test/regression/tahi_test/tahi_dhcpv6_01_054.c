...
TAHI_TEST_SEQ tahi_dhcpv6_01_054[] = {
    {TITLE, "dhcpv6 01-054", 13, 0},
...
int  tahi_dhcpv6_01_054_size = sizeof(tahi_dhcpv6_01_054) / sizeof(TAHI_TEST_SEQ);
#endif
