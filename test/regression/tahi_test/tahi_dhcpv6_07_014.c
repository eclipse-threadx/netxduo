...
#if 0
/* Frame (78 bytes) */
static const unsigned char pkt1[78] = {
...
/* Frame (102 bytes) */
static const unsigned char pkt12[102] = {
...
/* Frame (104 bytes) */
static const unsigned char pkt13[104] = {
0x00, 0x11, 0x22, 0x33, 0x44, 0x56, 0x00, 0x00, /* .."3DV.. */
0x00, 0x00, 0xa1, 0xa1, 0x86, 0xdd, 0x60, 0x00, /* ......`. */
0x00, 0x00, 0x00, 0x32, 0x11, 0x40, 0xfe, 0x80, /* ...2.@.. */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, /* ........ */
0x00, 0xff, 0xfe, 0x00, 0xa1, 0xa1, 0xfe, 0x80, /* ........ */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0x02, 0x23, /* "..3DV.# */
0x02, 0x22, 0x00, 0x32, 0xdb, 0xee, 0x07, 0x3e, /* .".2...> */
0xf0, 0x12, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* ........ */
0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
0x22, 0x33, 0x44, 0x56, 0x00, 0x17, 0x00, 0x10, /* "3DV.... */
0x3f, 0xfe, 0x05, 0x01, 0xff, 0xff, 0x01, 0x00, /* ?....... */
0x02, 0x00, 0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e  /* ......?> */
};

/* Frame (102 bytes) */
static const unsigned char pkt14[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (86 bytes) */
static const unsigned char pkt15[86] = {
...
#if 0
/* Frame (86 bytes) */
static const unsigned char pkt17[86] = {
...
/* Frame (86 bytes) */
static const unsigned char pkt18[86] = {
0x33, 0x33, 0xff, 0xec, 0x37, 0x7e, 0x00, 0x11, /* 33..7~.. */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x20, 0x3a, 0xff, 0x3f, 0xfe, /* ... :.?. */
0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (102 bytes) */
static const unsigned char pkt19[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (86 bytes) */
static const unsigned char pkt20[86] = {
0x33, 0x33, 0xff, 0xec, 0x37, 0x7e, 0x00, 0x11, /* 33..7~.. */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x20, 0x3a, 0xff, 0x3f, 0xfe, /* ... :.?. */
0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (102 bytes) */
static const unsigned char pkt21[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (70 bytes) */
static const unsigned char pkt24[70] = {
0x00, 0x11, 0x22, 0x33, 0x44, 0x56, 0xd4, 0xbe, /* .."3DV.. */
0xd9, 0xec, 0x37, 0x7e, 0x86, 0xdd, 0x60, 0x00, /* ..7~..`. */
0x00, 0x00, 0x00, 0x10, 0x3a, 0xff, 0xfe, 0x80, /* ....:... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd6, 0xbe, /* ........ */
...
#if 0
/* Frame (102 bytes) */
static const unsigned char pkt26[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (102 bytes) */
static const unsigned char pkt27[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
0x02, 0x23, 0x00, 0x30, 0xf3, 0xc8, 0x0b, 0x3e, /* .#.0...> */
0xf0, 0x12, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* ........ */
0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
/* Frame (78 bytes) */
static const unsigned char pkt28[78] = {
0x33, 0x33, 0xff, 0x33, 0x44, 0x56, 0x00, 0x11, /* 33.3DV.. */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x18, 0x3a, 0xff, 0x00, 0x00, /* ....:... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
/* Frame (78 bytes) */
static const unsigned char pkt29[78] = {
0x33, 0x33, 0xff, 0x33, 0x44, 0x56, 0x00, 0x11, /* 33.3DV.. */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x18, 0x3a, 0xff, 0x00, 0x00, /* ....:... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
/* Frame (78 bytes) */
static const unsigned char pkt30[78] = {
0x33, 0x33, 0xff, 0x33, 0x44, 0x56, 0x00, 0x11, /* 33.3DV.. */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x18, 0x3a, 0xff, 0x00, 0x00, /* ....:... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
TAHI_TEST_SEQ tahi_dhcpv6_07_014[] = {
    {TITLE, "dhcpv6 07-014", 13, 0},
    ...
    {CHECK,  &pkt12[0],  sizeof(pkt12),  5},    /* DHCP Information-Request  */
    {INJECT, &pkt13[0],  sizeof(pkt13),  0},    /* DHCP Reply  */
    {CHECK,  &pkt14[0], sizeof(pkt14), 5},     /* DHCP Information-Request  */
    ...
    {INJECT, &pkt22[0], sizeof(pkt22), 0},    /* RA */
    {INJECT, &pkt23[0], sizeof(pkt23), 0},    /* NA */

    {INJECT, &pkt24[0], sizeof(pkt24), 0},    /* Echo Request */
    {CHECK,  &pkt25[0], sizeof(pkt25), 5},    /* Echo Reply */
...
int  tahi_dhcpv6_07_014_size = sizeof(tahi_dhcpv6_07_014) / sizeof(TAHI_TEST_SEQ);
#endif
