...
TAHI_TEST_SEQ tahi_dhcpv6_01_064[] = {
    {TITLE, "dhcpv6 01-064", 13, 0},
...
int  tahi_dhcpv6_01_064_size = sizeof(tahi_dhcpv6_01_064) / sizeof(TAHI_TEST_SEQ);
#endif
