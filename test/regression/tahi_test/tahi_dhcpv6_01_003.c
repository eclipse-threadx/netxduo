...
TAHI_TEST_SEQ tahi_dhcpv6_01_003[] = {
    {TITLE, "dhcpv6 01-003", 13, 0},
...
int  tahi_dhcpv6_01_003_size = sizeof(tahi_dhcpv6_01_003) / sizeof(TAHI_TEST_SEQ);
#endif
