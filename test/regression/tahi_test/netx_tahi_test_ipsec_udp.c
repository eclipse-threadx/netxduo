...
extern TAHI_TEST_SEQ tahi_ipsec_udp_001[];
extern TAHI_TEST_SEQ tahi_ipsec_udp_002[];
extern TAHI_TEST_SEQ tahi_ipsec_udp_004[];
extern TAHI_TEST_SEQ tahi_ipsec_udp_005[];

extern int tahi_ipsec_udp_001_size;
extern int tahi_ipsec_udp_002_size;
extern int tahi_ipsec_udp_004_size;
extern int tahi_ipsec_udp_005_size;
...
static void build_test_suite(void)
{
    ...
    test_suite[0].test_case = &tahi_ipsec_udp_001[0]; test_suite[0].test_case_size = tahi_ipsec_udp_001_size;
    test_suite[1].test_case = &tahi_ipsec_udp_002[0]; test_suite[1].test_case_size = tahi_ipsec_udp_002_size;
    /*
    test_suite[2].test_case = &tahi_ipsec_udp_003[0]; test_suite[2].test_case_size = tahi_ipsec_udp_003_size;
    */
    test_suite[3].test_case = &tahi_ipsec_udp_004[0]; test_suite[3].test_case_size = tahi_ipsec_udp_004_size;
    test_suite[4].test_case = &tahi_ipsec_udp_005[0]; test_suite[4].test_case_size = tahi_ipsec_udp_005_size;
}
...
#else
void           netx_tahi_test_ipsec_udp_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
    ...
    status = nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", 1640, pointer, 1640*16);
    pointer = pointer + 1640*16;
