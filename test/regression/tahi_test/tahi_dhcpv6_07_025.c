...
/* Frame (148 bytes) */
static char pkt10[148] = {
    0x00, 0x11, 0x22, 0x33, 0x44, 0x56, 0x00, 0x00, /* .."3DV.. */
    0x00, 0x00, 0xa1, 0xa1, 0x86, 0xdd, 0x60, 0x00, /* ......`. */
    0x00, 0x00, 0x00, 0x5e, 0x11, 0x40, 0xfe, 0x80, /* ...^.@.. */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0xa1, 0xa1, 0x3f, 0xfe, /* ......?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x11, /* ........ */
    0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0x02, 0x23, /* "..3DV.# */
    0x02, 0x23, 0x00, 0x5e, 0xc3, 0x33, 0x0d, 0x00, /* .#.^.3.. */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x02, 0x00, 0x00, 0xff, 0xfe, 0x00, 0xa2, 0xa2, /* ........ */
    0x00, 0x12, 0x00, 0x04, 0x01, 0x01, 0x01, 0x01, /* ........ */
    0x00, 0x09, 0x00, 0x28, 0x07, 0x00, 0x00, 0x68, /* ...(...h */
...
TAHI_TEST_SEQ tahi_dhcpv6_07_025[] = {
    {TITLE, "dhcpv6 07-025", 13, 0},
    ...
    {INJECT, &pkt19[0], sizeof(pkt19), 0},    /* RA */
    {INJECT, &pkt20[0], sizeof(pkt20), 0},    /* NA */

    {INJECT, &pkt21[0], sizeof(pkt21), 0},    /* Echo Request */
    {CHECK,  &pkt22[0], sizeof(pkt22), 5},    /* Echo Reply */

    {CLEANUP, NX_NULL, 0, 0},
    {DUMP, NX_NULL, 0, 0}
};

int  tahi_dhcpv6_07_025_size = sizeof(tahi_dhcpv6_07_025) / sizeof(TAHI_TEST_SEQ);
#endif
