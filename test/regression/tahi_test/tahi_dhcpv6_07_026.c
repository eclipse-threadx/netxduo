...
TAHI_TEST_SEQ tahi_dhcpv6_07_026[] = {
    {TITLE, "dhcpv6 07-026", 13, 0},
    ...
    {INJECT, &pkt9[0],  sizeof(pkt9),  0},    /* NA */
...
int  tahi_dhcpv6_07_026_size = sizeof(tahi_dhcpv6_07_026) / sizeof(TAHI_TEST_SEQ);
#endif
