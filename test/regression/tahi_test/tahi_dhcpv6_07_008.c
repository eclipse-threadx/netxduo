...
TAHI_TEST_SEQ tahi_dhcpv6_07_008[] = {
    {TITLE, "dhcpv6 07-008", 13, 0},

    {CHECK,  &pkt4[0], sizeof(pkt4), 20},
    {INJECT, &pkt6[0], sizeof(pkt6), 0},      /* RA */
    ...
    {CHECK,  &pkt12[0], sizeof(pkt12), 5},    /* Echo Reply */

    {DHCPV6_INFO_REQUEST, NX_NULL, 0, 0},
    {CHECK,  &pkt13[0], sizeof(pkt13), 5},

    {INJECT, &pkt14[0], sizeof(pkt14), 0},    /* NA */
...
int  tahi_dhcpv6_07_008_size = sizeof(tahi_dhcpv6_07_008) / sizeof(TAHI_TEST_SEQ);
#endif
