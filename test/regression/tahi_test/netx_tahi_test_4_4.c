...
extern TAHI_TEST_SEQ tahi_04_004[];

extern int tahi_04_004_size;

static TAHI_TEST_SUITE test_suite[15];
static void build_test_suite(void)
{
    test_suite[2].test_case = &tahi_04_004[0];test_suite[2].test_case_size = tahi_04_004_size;
}
...
#else
void           netx_tahi_test_4_4_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
