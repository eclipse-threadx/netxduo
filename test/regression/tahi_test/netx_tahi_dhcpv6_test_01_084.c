...
extern TAHI_TEST_SEQ tahi_dhcpv6_01_084[];
extern int  tahi_dhcpv6_01_084_size;
...
#else
void netx_tahi_dhcpv6_test_01_084_define(void * first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT        status;
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_084[0], tahi_dhcpv6_01_084_size);
