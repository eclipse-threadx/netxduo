...
extern TAHI_TEST_SEQ tahi_dhcpv6_01_082[];
extern int  tahi_dhcpv6_01_082_size;
...
#else
void netx_tahi_dhcpv6_test_01_082_define(void * first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT        status;
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_082[0], tahi_dhcpv6_01_082_size);
...
ULONG                   message_type;
    ...
    if((dst_port & 0x0000FFFF) == 0x00000222)
    {
        ...
        /* Modify the xid. */
        _nx_dhcpv6_utility_get_data(packet_ptr -> nx_packet_prepend_ptr + 8, 1, &message_type);
        if(message_type != NX_DHCPV6_MESSAGE_TYPE_DECLINE)
        {
