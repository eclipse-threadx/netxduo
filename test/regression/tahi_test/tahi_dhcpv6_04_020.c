...
static char pkt12[103] = {
    ...
    0x00, 0x35, 0x00, 0x31, 0xff, 0xc1, 0x2a, 0xd1, /* .5.1..*. */
...
TAHI_TEST_SEQ tahi_dhcpv6_04_020[] = {
    {TITLE, "dhcpv6 04-020", 13, 0},
...
int  tahi_dhcpv6_04_020_size = sizeof(tahi_dhcpv6_04_020) / sizeof(TAHI_TEST_SEQ);
#endif
