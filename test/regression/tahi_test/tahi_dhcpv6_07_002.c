...
static char pkt19[103] = {
    ...
    0x00, 0x35, 0x00, 0x31, 0x59, 0x71, 0x15, 0x55, /* .5.1Yq.U */
...
static char pkt25[103] = {
    ...
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e, 0x75, 0x30, /* ....?>u0 */
    0x00, 0x35, 0x00, 0x31, 0x57, 0xa1, 0x17, 0x25, /* .5.1W..% */
    0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x06, 0x64, 0x68, 0x63, 0x70, 0x76, /* ...dhcpv */
    0x36, 0x04, 0x74, 0x65, 0x73, 0x74, 0x07, 0x65, /* 6.test.e */
    0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, /* xample.c */
...
TAHI_TEST_SEQ tahi_dhcpv6_07_002[] = {
    {TITLE, "dhcpv6 07-002", 13, 0},

    {CHECK,  &pkt4[0],  sizeof(pkt4),  20},     /* RS */
    {INJECT, &pkt8[0],  sizeof(pkt8),  0},      /* RA */

    {WAIT, NX_NULL, 0 ,5},                      /* Wait for the DAD. */

    {INJECT, &pkt11[0], sizeof(pkt11), 0},    /* Echo Request */
    {CHECK,  &pkt12[0], sizeof(pkt12), 5},    /* NS */
    {INJECT, &pkt13[0], sizeof(pkt13), 0},    /* NA */
    {CHECK,  &pkt14[0], sizeof(pkt14), 5},    /* Echo Reply */

    {DHCPV6_INFO_REQUEST, NX_NULL, 0, 0},     /* Start DHCPv6 Information   */
    {CHECK,  &pkt15[0], sizeof(pkt15), 5},    /* DHCPv6 Information   */
    {INJECT, &pkt16[0], sizeof(pkt16), 0},    /* DHCPv6 Reply    */

    {DHCPV6_DNS, NX_NULL, 0, 0},              /* Start DNS Query */
    {CHECK,  &pkt17[0], sizeof(pkt17), 5},    /* NS */
    {INJECT, &pkt18[0], sizeof(pkt18), 0},    /* NA */
    {CHECK,  &pkt19[0], sizeof(pkt19), 5},    /* Check DNS Query */

    {CLEANUP, NX_NULL, 0, 0},
    {DUMP, NX_NULL, 0, 0}
};

int  tahi_dhcpv6_07_002_size = sizeof(tahi_dhcpv6_07_002) / sizeof(TAHI_TEST_SEQ);
#endif
