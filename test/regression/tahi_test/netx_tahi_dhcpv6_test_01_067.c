...
#if (NX_DHCPV6_MAX_IA_ADDRESS >= 2)  /* This test case works OK when NX_DHCPV6_MAX_IA_ADDRESS is 2, default is 1. */
...
extern TAHI_TEST_SEQ tahi_dhcpv6_01_067[];
extern int  tahi_dhcpv6_01_067_size;

#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void netx_tahi_dhcpv6_test_01_067_define(void * first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT        status;
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_067[0], tahi_dhcpv6_01_067_size);
...
#endif
{
    printf("NetX Test:   TAHI dhcpv6 01-067 TEST.......................N/A!\n");
