...
extern TAHI_TEST_SEQ tahi_04_002[];

extern int tahi_04_002_size;

static TAHI_TEST_SUITE test_suite[1];
static void build_test_suite(void)
{
    test_suite[0].test_case = &tahi_04_002[0];test_suite[0].test_case_size = tahi_04_002_size;
}
...
#else
void           netx_tahi_test_4_2_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
