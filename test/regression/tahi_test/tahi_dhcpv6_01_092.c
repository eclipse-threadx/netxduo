...
TAHI_TEST_SEQ tahi_dhcpv6_01_092[] = {
    {TITLE, "dhcpv6 01-092", 13, 0},

    {CHECK,  &pkt10[0], sizeof(pkt10), 30},
...
int  tahi_dhcpv6_01_092_size = sizeof(tahi_dhcpv6_01_092) / sizeof(TAHI_TEST_SEQ);
#endif
