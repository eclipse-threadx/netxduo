...
extern TAHI_TEST_SEQ tahi_04_003[];

extern int tahi_04_003_size;

static TAHI_TEST_SUITE test_suite[1];
static void build_test_suite(void)
{
    test_suite[0].test_case = &tahi_04_003[0];test_suite[0].test_case_size = tahi_04_003_size;
}
...
#else
void           netx_tahi_test_4_3_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
