...
TAHI_TEST_SEQ tahi_dhcpv6_01_076[] = {
    {TITLE, "dhcpv6 01-076", 13, 0},
...
int  tahi_dhcpv6_01_076_size = sizeof(tahi_dhcpv6_01_076) / sizeof(TAHI_TEST_SEQ);
#endif
