...
TAHI_TEST_SEQ tahi_ipsec_udp_009_02[] = {
    {TITLE, "IPSEC-UDP-009-02", 16, 0, 0, 0, 0, 0},
...
int tahi_ipsec_udp_009_02_size = sizeof(tahi_ipsec_udp_009_02) / sizeof(TAHI_TEST_SEQ);
