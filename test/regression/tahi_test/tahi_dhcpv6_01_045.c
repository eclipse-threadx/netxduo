...
TAHI_TEST_SEQ tahi_dhcpv6_01_045[] = {
    {TITLE, "dhcpv6 01-045", 13, 0},

    {WAIT,   NX_NULL,  0,            15},
    {CHECK,  &pkt6[0], sizeof(pkt6), 10},
...
int  tahi_dhcpv6_01_045_size = sizeof(tahi_dhcpv6_01_045) / sizeof(TAHI_TEST_SEQ);
#endif
