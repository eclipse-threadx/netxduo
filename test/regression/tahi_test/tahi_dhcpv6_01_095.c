...
TAHI_TEST_SEQ tahi_dhcpv6_01_095[] = {
    {TITLE, "dhcpv6 01-095", 13, 0},
...
int  tahi_dhcpv6_01_095_size = sizeof(tahi_dhcpv6_01_095) / sizeof(TAHI_TEST_SEQ);
#endif
