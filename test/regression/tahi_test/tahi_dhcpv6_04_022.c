...
static char pkt10[86] = {
    ...
    0x5b, 0xbc, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xfe, /* [.....?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
...
static char pkt11[86] = {
    ...
    0x58, 0x1d, 0xe0, 0x00, 0x00, 0x00, 0x3f, 0xfe, /* X.....?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
...
static char pkt12[103] = {
    ...
    0x00, 0x35, 0x00, 0x31, 0x11, 0x46, 0x19, 0x4d, /* .5.1.F.M */
...
static char pkt13[103] = {
    ...
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e, 0x75, 0x30, /* ....?>u0 */
    0x00, 0x35, 0x00, 0x31, 0x0f, 0xb6, 0x1a, 0xdd, /* .5.1.... */
    0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x06, 0x64, 0x68, 0x63, 0x70, 0x76, /* ...dhcpv */
    0x36, 0x04, 0x74, 0x65, 0x73, 0x74, 0x07, 0x65, /* 6.test.e */
    0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, /* xample.c */
...
static char pkt14[103] = {
    ...
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e, 0x75, 0x30, /* ....?>u0 */
    0x00, 0x35, 0x00, 0x31, 0x0c, 0x56, 0x1e, 0x3d, /* .5.1.V.= */
    0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x06, 0x64, 0x68, 0x63, 0x70, 0x76, /* ...dhcpv */
    0x36, 0x04, 0x74, 0x65, 0x73, 0x74, 0x07, 0x65, /* 6.test.e */
    0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, /* xample.c */
...
static char pkt16[174] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
    0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0x02, 0x23, /* "..3DV.# */
    0x02, 0x22, 0x00, 0x78, 0xee, 0x5f, 0x07, 0x52, /* .".x._.R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x02, 0x00, 0x0e, /* "3DV.... */
    0x00, 0x01, 0x00, 0x01, 0x00, 0x06, 0x1a, 0x80, /* ........ */
    ...
    0x00, 0x00, 0x00, 0x17, 0x00, 0x10, 0x3f, 0xfe, /* ......?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3e, 0x3f              /* ....>? */
    };

#if 0
/* Frame (103 bytes) */
static char pkt17[103] = {
    0x00, 0x00, 0x00, 0x00, 0x3f, 0x3e, 0x00, 0x11, /* ....?>.. */
    0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
    0x00, 0x00, 0x00, 0x31, 0x11, 0xff, 0x3f, 0xfe, /* ...1..?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, /* ........ */
    ...
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e, 0x75, 0x30, /* ....?>u0 */
    0x00, 0x35, 0x00, 0x31, 0xfc, 0x61, 0x2e, 0x31, /* .5.1.a.1 */
    0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x06, 0x64, 0x68, 0x63, 0x70, 0x76, /* ...dhcpv */
    0x36, 0x04, 0x74, 0x65, 0x73, 0x74, 0x07, 0x65, /* 6.test.e */
    0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, /* xample.c */
...
static char pkt18[103] = {
    ...
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e, 0x75, 0x30, /* ....?>u0 */
    0x00, 0x35, 0x00, 0x31, 0xfb, 0x11, 0x2f, 0x81, /* .5.1../. */
    0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x06, 0x64, 0x68, 0x63, 0x70, 0x76, /* ...dhcpv */
    0x36, 0x04, 0x74, 0x65, 0x73, 0x74, 0x07, 0x65, /* 6.test.e */
    0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, /* xample.c */
...
static char pkt19[86] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, 0x3f, 0xfe, /* ......?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e, 0x87, 0x00, /* ....?>.. */
    0x12, 0xc2, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xfe, /* ......?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3f, 0x3e, 0x01, 0x01, /* ....?>.. */
    0x00, 0x11, 0x22, 0x33, 0x44, 0x56              /* .."3DV */
};
...
static char pkt25[86] = {
    0x33, 0x33, 0xff, 0x00, 0x3e, 0x3f, 0x00, 0x11, /* 33..>?.. */
    0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
    0x00, 0x00, 0x00, 0x20, 0x3a, 0xff, 0x3f, 0xfe, /* ... :.?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, 0xff, 0x02, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x01, 0xff, 0x00, 0x3e, 0x3f, 0x87, 0x00, /* ....>?.. */
    0x5d, 0xba, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xfe, /* ].....?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3e, 0x3f, 0x01, 0x01, /* ....>?.. */
    0x00, 0x11, 0x22, 0x33, 0x44, 0x56              /* .."3DV */
};
...
static char pkt26[86] = {
    ...
    0x00, 0x00, 0x00, 0x20, 0x3a, 0xff, 0x3f, 0xfe, /* ... :.?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3e, 0x3f, 0x3f, 0xfe, /* ....>??. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, 0x88, 0x00, /* ........ */
    0x5a, 0x1b, 0xe0, 0x00, 0x00, 0x00, 0x3f, 0xfe, /* Z.....?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3e, 0x3f, 0x02, 0x01, /* ....>?.. */
    0x00, 0x00, 0x00, 0x00, 0x3f, 0x3e              /* ....?> */
};

/* Frame (103 bytes) */
static char pkt27[103] = {
    0x00, 0x00, 0x00, 0x00, 0x3f, 0x3e, 0x00, 0x11, /* ....?>.. */
    0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
    0x00, 0x00, 0x00, 0x31, 0x11, 0xff, 0x3f, 0xfe, /* ...1..?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, 0x3f, 0xfe, /* ......?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3e, 0x3f, 0x75, 0x30, /* ....>?u0 */
    0x00, 0x35, 0x00, 0x31, 0xf2, 0x70, 0x39, 0x21, /* .5.1.p9! */
    0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x06, 0x64, 0x68, 0x63, 0x70, 0x76, /* ...dhcpv */
    0x36, 0x04, 0x74, 0x65, 0x73, 0x74, 0x07, 0x65, /* 6.test.e */
    0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, /* xample.c */
...
static char pkt28[103] = {
    ...
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
    0x00, 0xff, 0xfe, 0x00, 0x3e, 0x3f, 0x75, 0x30, /* ....>?u0 */
    0x00, 0x35, 0x00, 0x31, 0xf0, 0xe0, 0x3a, 0xb1, /* .5.1..:. */
    0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x06, 0x64, 0x68, 0x63, 0x70, 0x76, /* ...dhcpv */
    0x36, 0x04, 0x74, 0x65, 0x73, 0x74, 0x07, 0x65, /* 6.test.e */
    0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, /* xample.c */
...
TAHI_TEST_SEQ tahi_dhcpv6_04_022[] = {
    {TITLE, "dhcpv6 04-022", 13, 0},

    {CHECK,  &pkt3[0],  sizeof(pkt3), 30},      /* DHCPv6 Solicit   */
    {INJECT, &pkt4[0],  sizeof(pkt4), 0},       /* DHCPv6 Reply     */
    {CHECK,  &pkt5[0],  sizeof(pkt5), 5},       /* DHCPv6 Request   */
    {INJECT, &pkt6[0],  sizeof(pkt6), 0},       /* DHCPv6 Reply     */

    {CHECK,  &pkt7[0], sizeof(pkt7), 5},        /* D */
    {CHECK,  &pkt8[0], sizeof(pkt8), 5},        /* A */
    {CHECK,  &pkt9[0], sizeof(pkt9), 5},        /* D */
    {WAIT, NX_NULL, 0 ,5},                      /* Wait for the DAD. */

    {DHCPV6_DNS, NX_NULL, 0, 0},                /* Start DNS Query  */
    {CHECK,  &pkt10[0], sizeof(pkt10), 20},     /* NS */
    {INJECT, &pkt11[0], sizeof(pkt11), 0},      /* NA */
    {CHECK,  &pkt12[0], sizeof(pkt12), 15},     /* Check DNS Query  */

    {WAIT, NX_NULL, 0 , 40},                    /* Wait RENEW.      */
    {CHECK,  &pkt15[0], sizeof(pkt15), 15},     /* DHCPv6 Renew     */
    {INJECT, &pkt16[0], sizeof(pkt16), 0},      /* DHCPv6 Replay    */

    {DHCPV6_DNS, NX_NULL, 0, 0},                /* Start DNS Query  */
    {CHECK,  &pkt25[0], sizeof(pkt25), 20},     /* NS */
    {INJECT, &pkt26[0], sizeof(pkt26), 0},      /* NA */
    {CHECK,  &pkt27[0], sizeof(pkt27), 20},     /* Check DNS Query  */

    {CLEANUP, NX_NULL, 0, 0},
    {DUMP, NX_NULL, 0, 0}
};

int  tahi_dhcpv6_04_022_size = sizeof(tahi_dhcpv6_04_022) / sizeof(TAHI_TEST_SEQ);
#endif
