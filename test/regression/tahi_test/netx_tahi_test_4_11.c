...
extern TAHI_TEST_SEQ tahi_04_011[];

extern int tahi_04_011_size;

static TAHI_TEST_SUITE test_suite[1];
static void build_test_suite(void)
{
    test_suite[0].test_case = &tahi_04_011[0];test_suite[0].test_case_size = tahi_04_011_size;
}
...
#else
void           netx_tahi_test_4_11_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
