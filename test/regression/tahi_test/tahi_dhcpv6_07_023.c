...
TAHI_TEST_SEQ tahi_dhcpv6_07_023[] = {
    {TITLE, "dhcpv6 07-023", 13, 0},
...
int  tahi_dhcpv6_07_023_size = sizeof(tahi_dhcpv6_07_023) / sizeof(TAHI_TEST_SEQ);
#endif
