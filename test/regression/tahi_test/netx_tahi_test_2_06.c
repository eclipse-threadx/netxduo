...
extern TAHI_TEST_SEQ tahi_02_131[];

extern int tahi_02_131_size;
...
static void build_test_suite(void)
{
    ...
    test_suite[0].test_case = &tahi_02_131[0]; test_suite[0].test_case_size = tahi_02_131_size;
...
#else
void           netx_tahi_test_2_6_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
