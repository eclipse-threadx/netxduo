...
TAHI_TEST_SEQ tahi_dhcpv6_01_098[] = {
    {TITLE, "dhcpv6 01-098", 13, 0},
...
int  tahi_dhcpv6_01_098_size = sizeof(tahi_dhcpv6_01_098) / sizeof(TAHI_TEST_SEQ);
#endif
