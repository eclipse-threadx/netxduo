...
static char pkt6[162] = {
    ...
    0x02, 0x22, 0x00, 0x6c, 0xe4, 0x80, 0x07, 0x08, /* .".l.... */
    0x0e, 0x90, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* ........ */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x02, 0x00, 0x0e, /* "3DV.... */
    0x00, 0x01, 0x00, 0x01, 0x00, 0x06, 0x1a, 0x80, /* ........ */
    ...
    0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0xab, 0xcd, 0x00, 0x00, 0x07, 0xd0, 0x00, 0x00, /* ........ */
    0x0b, 0xb8, 0x00, 0x0d, 0x00, 0x04, 0x00, 0x00, /* ........ */
...
static char pkt14[164] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x6e, 0x05, 0x1c, 0x05, 0x52, /* .#.n...R */
    ...
    0x3f, 0xfe, 0x05, 0x01, 0xff, 0xff, 0x01, 0x00, /* ?....... */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, /* ........ */
    0x00, 0x00, 0x07, 0xd0, 0x00, 0x00, 0x0b, 0xb8, /* ........ */
    0x00, 0x06, 0x00, 0x08, 0x00, 0x17, 0x00, 0x1f, /* ........ */
    0x00, 0x29, 0x00, 0x18                          /* .).. */
    };
...
static char pkt15[164] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x6e, 0x01, 0x34, 0x05, 0x52, /* .#.n.4.R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
static char pkt16[146] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x5c, 0xc0, 0x79, 0x06, 0x52, /* .#.\.y.R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
    ...
    0x07, 0xd0, 0x00, 0x00, 0x0b, 0xb8, 0x00, 0x06, /* ........ */
    0x00, 0x08, 0x00, 0x17, 0x00, 0x1f, 0x00, 0x29, /* .......) */
    0x00, 0x18                                      /* .. */
    };

/* Frame (146 bytes) */
static char pkt17[146] = {
    0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
    0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
    0x00, 0x00, 0x00, 0x5c, 0x11, 0xff, 0xfe, 0x80, /* ...\.... */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x5c, 0xbc, 0x91, 0x06, 0x52, /* .#.\...R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
static char pkt18[146] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x5c, 0xb4, 0xc1, 0x06, 0x52, /* .#.\...R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
static char pkt19[146] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x5c, 0xa5, 0x21, 0x06, 0x52, /* .#.\.!.R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
static char pkt20[146] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x5c, 0x85, 0xe1, 0x06, 0x52, /* .#.\...R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
static char pkt21[146] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x5c, 0x47, 0x61, 0x06, 0x52, /* .#.\Ga.R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
static char pkt22[146] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
    0x02, 0x23, 0x00, 0x5c, 0xca, 0x60, 0x06, 0x52, /* .#.\.`.R */
    0x91, 0x66, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* .f...... */
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
    0xf6, 0x18, 0x00, 0x03, 0x00, 0x28, 0xc0, 0xde, /* .....(.. */
    0xdb, 0xad, 0x00, 0x00, 0x00, 0x32, 0x00, 0x00, /* .....2.. */
    0x00, 0x50, 0x00, 0x05, 0x00, 0x18, 0x3f, 0xfe, /* .P....?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, 0x00, 0x00, /* ........ */
...
static char pkt23[146] = {
    ...
    0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
    0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
    0xff, 0xff, 0x00, 0x03, 0x00, 0x28, 0xc0, 0xde, /* .....(.. */
    0xdb, 0xad, 0x00, 0x00, 0x00, 0x32, 0x00, 0x00, /* .....2.. */
    0x00, 0x50, 0x00, 0x05, 0x00, 0x18, 0x3f, 0xfe, /* .P....?. */
    0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, /* ........ */
    0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, 0x00, 0x00, /* ........ */
...
TAHI_TEST_SEQ tahi_dhcpv6_01_052[] = {
    {TITLE, "dhcpv6 01-052", 13, 0},
    ...
    {WAIT,   NX_NULL,  0, 10}, /* Wait for the REBIND. */
    {CHECK,  &pkt17[0], sizeof(pkt17), 5},
    {WAIT,   NX_NULL,  0, 20}, /* Wait for the REBIND. */
    {CHECK,  &pkt18[0], sizeof(pkt18), 5},
    {WAIT,   NX_NULL,  0, 40}, /* Wait for the REBIND. */
    {CHECK,  &pkt19[0], sizeof(pkt19), 5},
    {WAIT,   NX_NULL,  0, 80}, /* Wait for the REBIND. */
    {CHECK,  &pkt20[0], sizeof(pkt20), 5},
    {WAIT,   NX_NULL,  0, 160}, /* Wait for the REBIND. */
    {CHECK,  &pkt21[0], sizeof(pkt21), 5},
    {WAIT,   NX_NULL,  0, 320}, /* Wait for the REBIND. */
    {CHECK,  &pkt22[0], sizeof(pkt22), 5},
    {WAIT,   NX_NULL,  0, 640}, /* Wait for the REBIND. */
...
int  tahi_dhcpv6_01_052_size = sizeof(tahi_dhcpv6_01_052) / sizeof(TAHI_TEST_SEQ);
#endif
