...
/* Frame (86 bytes) */
static const unsigned char pkt6[86] = {
0x00, 0x11, 0x22, 0x33, 0x44, 0x56, 0x00, 0x00, /* .."3DV.. */
0x00, 0x00, 0xa1, 0xa1, 0x86, 0xdd, 0x60, 0x00, /* ......`. */
0x00, 0x00, 0x00, 0x20, 0x3a, 0xff, 0x3f, 0xfe, /* ... :.?. */
0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x00, /* ........ */
...
/* Frame (70 bytes) */
static const unsigned char pkt7[70] = {
...
/* Frame (102 bytes) */
static const unsigned char pkt8[102] = {
...
0x02, 0x22, 0x00, 0x44, 0x0f, 0xe2, 0x07, 0x00, /* .".D.... */
...
/* Frame (102 bytes) */
static const unsigned char pkt10[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (86 bytes) */
static const unsigned char pkt11[86] = {
...
/* Frame (102 bytes) */
static const unsigned char pkt15[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (86 bytes) */
static const unsigned char pkt16[86] = {
0x33, 0x33, 0xff, 0xec, 0x37, 0x7e, 0x00, 0x11, /* 33..7~.. */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x20, 0x3a, 0xff, 0x3f, 0xfe, /* ... :.?. */
0x05, 0x01, 0xff, 0xff, 0x01, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (102 bytes) */
static const unsigned char pkt17[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (110 bytes) */
static const unsigned char pkt18[110] = {
0x33, 0x33, 0x00, 0x00, 0x00, 0x01, 0xd4, 0xbe, /* 33...... */
0xd9, 0xec, 0x37, 0x7e, 0x86, 0xdd, 0x60, 0x00, /* ..7~..`. */
0x00, 0x00, 0x00, 0x38, 0x3a, 0xff, 0xfe, 0x80, /* ...8:... */
...
/* Frame (86 bytes) */
static const unsigned char pkt19[86] = {
0x33, 0x33, 0x00, 0x00, 0x00, 0x01, 0xd4, 0xbe, /* 33...... */
0xd9, 0xec, 0x37, 0x7e, 0x86, 0xdd, 0x60, 0x00, /* ..7~..`. */
...
#if 0
/* Frame (102 bytes) */
static const unsigned char pkt22[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (102 bytes) */
static const unsigned char pkt23[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
/* Frame (102 bytes) */
static const unsigned char pkt24[102] = {
0x33, 0x33, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, /* 33...... */
0x22, 0x33, 0x44, 0x56, 0x86, 0xdd, 0x60, 0x00, /* "3DV..`. */
0x00, 0x00, 0x00, 0x30, 0x11, 0xff, 0xfe, 0x80, /* ...0.... */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x11, /* ........ */
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x02, 0x22, /* ......." */
0x02, 0x23, 0x00, 0x30, 0xe7, 0x48, 0x0b, 0x3e, /* .#.0.H.> */
0xf0, 0x12, 0x00, 0x01, 0x00, 0x0e, 0x00, 0x01, /* ........ */
0x00, 0x01, 0xac, 0x7d, 0x87, 0x3a, 0x00, 0x11, /* ...}.:.. */
0x22, 0x33, 0x44, 0x56, 0x00, 0x08, 0x00, 0x02, /* "3DV.... */
...
TAHI_TEST_SEQ tahi_dhcpv6_07_015[] = {
    {TITLE, "dhcpv6 07-015", 13, 0},
    ...
    {INJECT, &pkt19[0], sizeof(pkt19), 0},    /* NA */

    {INJECT, &pkt20[0], sizeof(pkt20), 0},    /* Echo Request */
    {CHECK,  &pkt21[0], sizeof(pkt21), 5},    /* Echo Reply */
...
int  tahi_dhcpv6_07_015_size = sizeof(tahi_dhcpv6_07_015) / sizeof(TAHI_TEST_SEQ);
#endif
