...
static void my_dhcpv6_reboot();

extern TAHI_TEST_SEQ tahi_dhcpv6_01_014[];
extern int  tahi_dhcpv6_01_014_size;

static CHAR    *pointer;
#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void netx_tahi_dhcpv6_test_01_014_define(void * first_unused_memory)
#endif
{
UINT    status;
...
UINT        status;
    ...
    netx_tahi_set_dhcpv6_reboot(my_dhcpv6_reboot);
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_014[0], tahi_dhcpv6_01_014_size);
