...
TAHI_TEST_SEQ tahi_dhcpv6_01_081[] = {
    {TITLE, "dhcpv6 01-081", 13, 0},
...
int  tahi_dhcpv6_01_081_size = sizeof(tahi_dhcpv6_01_081) / sizeof(TAHI_TEST_SEQ);
#endif
