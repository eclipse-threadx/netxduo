...
TAHI_TEST_SEQ tahi_dhcpv6_07_027[] = {
    {TITLE, "dhcpv6 07-027", 13, 0},
    ...
    {CHECK,  &pkt14[0], sizeof(pkt14), 25},    /* RS */
    {INJECT, &pkt15[0], sizeof(pkt15), 0},     /* RA */

    {WAIT, NX_NULL, 0, 5},

    {INJECT, &pkt18[0], sizeof(pkt18), 0},    /* Echo Request */
    {CHECK,  &pkt19[0], sizeof(pkt19), 5},    /* NS */
    {INJECT, &pkt20[0], sizeof(pkt20), 0},    /* NA */
    ...
    {INJECT, &pkt31[0], sizeof(pkt31), 0},    /* RA */
    {INJECT, &pkt32[0], sizeof(pkt32), 0},    /* NA */

    {INJECT, &pkt33[0], sizeof(pkt33), 0},    /* Echo Request */
    {CHECK,  &pkt34[0], sizeof(pkt34), 5},    /* Echo Reply */

    {CLEANUP, NX_NULL, 0, 0},
    {DUMP, NX_NULL, 0, 0}
};

int  tahi_dhcpv6_07_027_size = sizeof(tahi_dhcpv6_07_027) / sizeof(TAHI_TEST_SEQ);
#endif
