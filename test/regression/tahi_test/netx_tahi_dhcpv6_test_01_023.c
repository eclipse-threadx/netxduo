...
extern TAHI_TEST_SEQ tahi_dhcpv6_01_023[];
extern int  tahi_dhcpv6_01_023_size;

#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void netx_tahi_dhcpv6_test_01_023_define(void * first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
UINT        status;
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_023[0], tahi_dhcpv6_01_023_size);
