...
TAHI_TEST_SEQ tahi_dhcpv6_01_080[] = {
    {TITLE, "dhcpv6 01-080", 13, 0},
...
int  tahi_dhcpv6_01_080_size = sizeof(tahi_dhcpv6_01_080) / sizeof(TAHI_TEST_SEQ);
#endif
