...
extern TAHI_TEST_SEQ tahi_dhcpv6_01_045[];
extern int  tahi_dhcpv6_01_045_size;

static void my_icmpv6_ra_flag_callback(NX_IP *ip_ptr, UINT ra_flag);

#ifdef CTEST
VOID test_application_define(void *first_unused_memory)
#else
void netx_tahi_dhcpv6_test_01_045_define(void * first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
    ...
    /* Set icmpv6 ra flag. */
    status = nxd_icmpv6_ra_flag_callback_set(&ip_0, my_icmpv6_ra_flag_callback);
    if(status)
        error_counter++;
...
UINT        status;
    ...
    netx_tahi_run_test_case(&ip_0, &tahi_dhcpv6_01_045[0], tahi_dhcpv6_01_045_size);
