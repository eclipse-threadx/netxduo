...
extern TAHI_TEST_SEQ tahi_03_022[];

extern int tahi_03_022_size;

static TAHI_TEST_SUITE test_suite[1];
static void build_test_suite(void)
{
    test_suite[0].test_case = &tahi_03_022[0];test_suite[0].test_case_size = tahi_03_022_size;    
}
...
#else
void           netx_tahi_test_3_22_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
