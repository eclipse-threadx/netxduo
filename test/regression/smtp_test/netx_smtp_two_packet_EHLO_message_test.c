...
extern char response_250_ehlo_last_pkt[10];
extern int response_250_ehlo_last_size;
...
#else
void    netx_smtp_two_packet_ehlo_message_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        wait_timeout = 300;
    ...
    printf("NetX Test:   SMTP Two Packet EHLO Message Test.........................");
...
static void     smtp_test_initialize()
{
    ...
    smtp_test[2].smtp_test_pkt_data = &response_250_ehlo_last_pkt[0];
    smtp_test[2].smtp_test_pkt_size = response_250_ehlo_last_size;  
...
#endif
{
    ...
    printf("NetX Test:   SMTP Two Packet EHLO Message Test.........................N/A\n"); 
