...
extern char response_250_ehlo_auth_no_type_pkt[145];
extern int response_250_ehlo_auth_no_type_size;
...
#else
void    netx_smtp_auth_no_type_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        wait_timeout = 300;
    ...
    printf("NetX Test:   SMTP Auth No Type Test....................................");
...
static void     smtp_test_initialize()
{
    ...
    smtp_test[1].smtp_test_pkt_data = &response_250_ehlo_auth_no_type_pkt[0];
    smtp_test[1].smtp_test_pkt_size = response_250_ehlo_auth_no_type_size;  
    smtp_test[2].smtp_test_pkt_data = &response_334_pkt[0];
    smtp_test[2].smtp_test_pkt_size = response_334_size;   
    smtp_test[3].smtp_test_pkt_data = &response_235_auth_passed_pkt[0];
    smtp_test[3].smtp_test_pkt_size = response_235_auth_passed_size; 

    smtp_test[4].smtp_test_pkt_data = &response_250_sender_ok_pkt[0];
    smtp_test[4].smtp_test_pkt_size = response_250_sender_ok_size; 
    smtp_test[5].smtp_test_pkt_data = &response_250_recipient_ok_pkt[0];
    smtp_test[5].smtp_test_pkt_size = response_250_recipient_ok_size; 
    smtp_test[6].smtp_test_pkt_data = &response_354_enter_mail_pkt[0];
    smtp_test[6].smtp_test_pkt_size = response_354_enter_mail_size; 

    smtp_test[7].smtp_test_pkt_data = &response_250_message_saved_pkt[0];
    smtp_test[7].smtp_test_pkt_size = response_250_message_saved_size;  

    smtp_test[8].smtp_test_pkt_data = &response_221_bye_pkt[0];
    smtp_test[8].smtp_test_pkt_size = response_221_bye_size;  
}
#else
...
#endif
{
    ...
    printf("NetX Test:   SMTP Auth No Type Test....................................N/A\n"); 
