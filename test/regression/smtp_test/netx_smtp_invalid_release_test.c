...
#else
void    netx_smtp_invalid_release_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        wait_timeout = 300;
    ...
    printf("NetX Test:   SMTP Invalid Release Test.................................");
    ...
    nx_smtp_mail_send(&smtp_client, RECIPIENT_ADDRESS, NX_SMTP_MAIL_PRIORITY_NORMAL, 
    ...
    if (client_packet_pool.nx_packet_pool_invalid_releases != 0)
    {
        error_counter++;
    }
...
static void     smtp_test_initialize()
{
    ...
    smtp_test[0].smtp_test_pkt_data = "2200"; /* Invalid value */
    smtp_test[0].smtp_test_pkt_size = 4; 
}
#else
...
#endif
{
    ...
    printf("NetX Test:   SMTP Invalid Release Test.................................N/A\n");
