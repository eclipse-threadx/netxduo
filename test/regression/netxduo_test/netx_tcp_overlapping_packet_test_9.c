...
#else
void           netx_tcp_overlapping_packet_test_9_application_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
...
static void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 9.............................");
    ...
    /* Create 4 packets, packet 1-3 contains 3 segments of the outgoing message. Packet 4 contains a retran overlapping 2. */
    ...
    memcpy(my_packet4 -> nx_packet_prepend_ptr, &msg[25], 6);
    my_packet4 -> nx_packet_length = 6;
    my_packet4 -> nx_packet_append_ptr = my_packet4 -> nx_packet_prepend_ptr + 6;
    ...
    client_socket.nx_tcp_socket_tx_sequence -= 35;
...
#endif
{
    printf("NetX Test:   TCP Overlapping Packet Test 9.............................N/A\n");
