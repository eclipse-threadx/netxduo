/* 11.27 TCP, FINWAIT-1 state MUST inform the application in case of aborting from remote site.  */

/* Procedure
   1. Client connects to server.
   2. Server calls disconnect function.
   3. Drop the FIN packet.
   4. Send a RST packet to server.
   5. Check if server is notified.  */
...
static void    my_tcp_packet_receive_11_27(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_11_27_application_define(void *first_unused_memory)
#endif
{
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 11.27 Test.......................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_11_27;
    advanced_packet_process_callback = my_packet_process_11_27;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 11.27 Test.......................................N/A\n"); 
