/* 9.22 TCP, in SYN-RCVD state through passive open, MUST return to LISTEN state on RST.  */


/* Procedure
1. Client connect to the Server.
2. Drop the ack packet sent from the Client to the Server, then the server state is SYN_RCVD
3. Client sends a RST to Server.
...
static void    my_tcp_packet_receive_9_22(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_9_22_application_define(void *first_unused_memory)
#endif
{
...
ULONG   actual_status;
    ...
    printf("NetX Test:   TCP Spec 9.22 Test........................................");
    ...
    /* Deal the the SYN+ACK packet with my routine.  */
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_9_22;
    advanced_packet_process_callback = my_packet_process_9_22;
...
NX_TCP_HEADER   header_ptr;
    ...
    header_ptr.nx_tcp_sequence_number       = server_socket.nx_tcp_socket_tx_sequence + 1;
...
NX_TCP_HEADER   *tcp_header_ptr;
    ...
    if ((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT) && (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_SYN_BIT))
    {      
        /*Drop the packet*/
...
void    my_tcp_packet_receive_9_22(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 9.22 Test........................................N/A\n"); 
