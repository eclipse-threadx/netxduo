...
/* Test sequence:
 * 1. ip_0 allocate 1000 bytes.     
 * 2. ip_0 discard the packets excpet the header packet, packet length also is 1000.
 * 3. ip_0 call nxd_ip_raw_packet_send to send packet.  
...
#else
void  netx_ipv6_fragmentation_error_test1_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   IPv6 Fragmentation Error Test1............................");
    ...
    /* Send the raw packet.  */
    status = nxd_ip_raw_packet_send(&ip_0, my_packet, &ipv6_address_1, 23, 255, NX_IP_NORMAL);
...
#endif
{
    ...
    printf("NetX Test:   IPv6 Fragmentation Error Test1............................N/A\n");
