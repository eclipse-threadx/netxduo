/* This NetX test concentrates on the TCP Socket Receive Cleanup operation.  */
...
#else
void    netx_tcp_receive_cleanup_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *packet_ptr;
    ...
    printf("NetX Test:   TCP Recieve Cleanup Test..................................");
    ...
    if (client_socket.nx_tcp_socket_receive_suspended_count != 0)       
        error_counter++;
                                 
    /* Check the TCP socket bind suspended count.  */
    if (server_socket.nx_tcp_socket_receive_suspended_count != 1)       
        error_counter++;
    ...
    /* Check the TCP socket bind suspended count.  */
    if (server_socket.nx_tcp_socket_receive_suspended_count != 0)       
        error_counter++;
...
#endif
{
    ...
    printf("NetX Test:   TCP Recieve Cleanup Test..................................N/A\n"); 
