/* This case tests HTTP Proxy error response. */
#include    "tx_api.h"
#include    "nx_api.h"
...
#else
void    netx_http_proxy_error_response_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NXD_ADDRESS     server_ip_address;
    ...
    for ( i = 0; i < TEST_LOOP; i++)
    {
        ...
        if (i % 2 == 0)
        {
            ...
            status = nxd_tcp_client_socket_connect(&test_client, &server_ip_address, TEST_SERVER_PORT, NX_NO_WAIT);
            if(status != NX_IN_PROGRESS)
                error_counter++;
    
            status = nx_tcp_socket_state_wait(&test_client, NX_TCP_ESTABLISHED, NX_IP_PERIODIC_RATE);
        }
        else
        {
...
NXD_ADDRESS server_ip_address;
    ...
    for (i = 0; i < TEST_LOOP; i++)
    {
        ...
        /* Send error response to test client.  */
...
NX_PACKET       *packet_ptr;
    ...
    printf("NetX Test:   HTTP Proxy Error Response Test............................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   HTTP Proxy Error Response Test............................N/A\n"); 
