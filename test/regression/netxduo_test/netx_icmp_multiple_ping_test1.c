...
/*
  ...
  thread 1 send ICMP Echo Request to the nonexistent IP address IP_ADDRESS(1, 2, 3, 7),
  Delay the ICMP Echo Reply in driver, let thread 0 receive the ICMP Echo Reply after thread 1 send ICMP Echo Request.
*/
...
#else
void    netx_icmp_multiple_ping_test1_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   ICMP Multiple Ping Test1..................................");
    ...
    if ((error_counter) || (icmp_request_counter != 1) || (icmp_reply_counter != 1))
    {
...
NX_PACKET   *my_packet;
    ...
    status = nx_icmp_ping(&ip_0, IP_ADDRESS(1, 2, 3, 7), "PjCZEZGZIZKZMZOZQZSZUZWZYZ", 28, &my_packet, 2 * NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   ICMP Multiple Ping Test1..................................N/A\n"); 
