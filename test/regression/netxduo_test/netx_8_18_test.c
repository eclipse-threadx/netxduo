/* 8.18 TCP, in SYN-SENT state MUST ignore a RST control message.  */

/* Procedure
1. Client connects.
2. Drop the SYN+ACK packet in the driver.
3. Server sends a segment that is carrying an RST and ACK flag.
4. Modify the packet with RST flag.
5. Client ignores the packet.
...
static void    my_tcp_packet_receive_8_18(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_8_18_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    advanced_packet_process_callback = my_packet_process_8_18;
    ...
    /* Deal the packet with my routing.  */
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_8_18;
...
NX_TCP_HEADER    tcp_header_ptr;
    ...
    printf("NetX Test:   TCP Spec 8.18 Test........................................");
    ...
    /* Set the RST.  */
    tcp_header_ptr.nx_tcp_header_word_3 |= NX_TCP_RST_BIT | NX_TCP_ACK_BIT;
...
NX_IP_HEADER       *ip_header_ptr;
    ...
    if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_SYN_BIT) && (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT))
    {
        ...
        client_socket.nx_tcp_socket_rx_sequence = tcp_header_ptr -> nx_tcp_sequence_number + 1;
        NX_CHANGE_ULONG_ENDIAN(tcp_header_ptr -> nx_tcp_sequence_number);
    ...
    /* Remove the ACK bit in THE rst packet. */
    else if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_RST_BIT) && (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT))
    {
#if defined(__PRODUCT_NETXDUO__)
        ...
        tcp_header_ptr -> nx_tcp_header_word_3 &= 0xffc0ffff;
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 8.18 Test........................................N/A\n"); 
