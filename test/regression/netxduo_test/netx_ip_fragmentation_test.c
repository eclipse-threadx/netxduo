...
#else
void    netx_ip_fragmentation_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG       packets_sent, bytes_sent, packets_received, bytes_received, packets_queued, receive_packets_dropped, checksum_errors;
    ...
    printf("NetX Test:   IP Fragmentation Processing Test..........................");
    ...
    while ((thread_0_counter < 1000) && (error_counter == 0))
    {
        ...
        my_packet -> nx_packet_length =  300;
        my_packet -> nx_packet_append_ptr =  my_packet -> nx_packet_prepend_ptr + 300;
    ...
    if((packets_sent != 2000) || (bytes_sent != 2000*300))
        error_counter++;
#endif
    ...
    if((udp_packets_sent != 2000) || (udp_bytes_sent != 2000*300))
        error_counter++;
#endif
    ...
    if ((error_counter) || (status) || (thread_0_counter != 2000) || (thread_1_counter != 2000) || 
        ...
        (udp_invalid_packets) || (udp_receive_packets_dropped) || (udp_checksum_errors) || (notify_calls != 2000))
    {
...
#endif
{
    ...
    printf("NetX Test:   IP Fragmentation Processing Test..........................N/A\n");
