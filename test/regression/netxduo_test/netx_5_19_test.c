/* 5.19 If SEND call arrives on state FINWAIT-1, TCP MUST return error: connection closing. */
...
static UINT    my_packet_process_5_19(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
...
#else
void           netx_5_19_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
NX_PACKET                   *my_packet;
    ...
    printf("NetX Test:   TCP Spec 5.19 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_5_19;

    /* Disconnect the client socket.  */
    status = nx_tcp_socket_disconnect(&client_socket, NX_NO_WAIT);

    /* A SEND Call arrives when client socket is in NX_TCP_WAIT_1 state.*/
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 5.19 Test........................................N/A\n");
