/* 10.23.02 TCP, in CLOSED, Send RST for FIN +ACK, in SYN-SENT state, ignore the FIN+ACK..  */

/*  Procedure
    1.When the Client has been on the CLOSED , Server sends a FIN + ACK to Client
    2.When the Client has been on the SYN_SENT, Server sends a FIN + ACK to Client.
    3.Check if the state has been changed.  */
...
static void    my_tcp_packet_receive_10_23_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_10_23_02_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_10_23_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT        status;
    ...
    advanced_packet_process_callback = my_packet_process_10_23_02;
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_10_23_02;
    ...
    /* Let the client socket disconnect.  */
    ...
    if((error_counter) || (rst_counter != 1) || (syn_counter != 1) || (fin_counter != 2))
    {
        printf("ERROR!\n");
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 10.23.02 Test....................................");
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_10_23_02_2;

    /* Send FIN packet.  */
    _nx_tcp_packet_send_fin(&server_socket, server_socket.nx_tcp_socket_tx_sequence);
    ...
    /* Let the server socket disconnect.  */
...
ULONG           source_ip, dest_ip;
    ...
    else if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_FIN_BIT) && (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT) && (fin_counter == 1))
    {
        /* Modify the acknowledgement number.  */
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 10.23.02 Test....................................N/A\n");
