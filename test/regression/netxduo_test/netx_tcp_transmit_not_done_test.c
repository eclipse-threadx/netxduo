/* This NetX test concentrates on the TCP transmitting packet is not done by driver before
 * the socket is going to close.  */
...
#else
void    netx_tcp_transmit_not_done_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   TCP Transmit Not Done Test................................");
    ...
    /* Let driver delay the packet for 1 second. */
    ...
    /* Verify the packet is queued in the TX queue. */
    if (client_socket.nx_tcp_socket_transmit_sent_count != 1)
    {
        error_counter++;
    }
    ...
    /* Disconnect this socket without waiting.  */
    ...
    /* Wait 2 seconds and driver will release the transmitting packet. */
    tx_thread_sleep(2 * NX_IP_PERIODIC_RATE);

    /* Verify all packets are released. */
...
ULONG           actual_status;
    ...
    /* Let client thread run first. */
    tx_thread_suspend(&thread_1);

    /* Disconnect the server socket without waiting.  */
...
#endif
{
    ...
    printf("NetX Test:   TCP Transmit Not Done Test................................N/A\n"); 
