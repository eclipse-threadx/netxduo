/* 16.02 Even if the receive window is closed indefinitely, the sending TCP MUST allow the connection to stay open as long as probes are acknowledged.  */

/* Update
   1. nx_tcp_fast_periodic_processing.c between line 199 and line 271.
   2. nx_tcp_socket_state_ack_check.c between line 436 and 441, line 536.  */
...
static void    my_tcp_packet_receive_16_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_16_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
NX_PACKET    *my_packet;
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_16_02;
    ...
    if((ack_counter != 1) || (client_socket.nx_tcp_socket_state != NX_TCP_ESTABLISHED))
        error_counter++;
...
NX_PACKET  *rcv_packet_ptr;
    ...
    printf("NetX Test:   TCP Spec 16.02 Test.......................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 16.02 Test.......................................N/A\n"); 
