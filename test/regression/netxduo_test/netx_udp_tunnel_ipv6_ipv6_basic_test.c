...
#else
void    netx_udp_tunnel_ipv6_ipv6_basic_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        free_port;
    ...
    printf("NetX Test:   TUNNEL UDP IPV6_6 Basic Processing Test.......");
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("NetX Test:   TUNNEL UDP IPV6_6 Basic Processing Test...................N/A\n");
