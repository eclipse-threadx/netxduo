/* This NetX test concentrates on the TCP Socket connect reset operation under interface deatch(tested receive suspension list).  */
...
#else
void    netx_tcp_receive_under_interface_detach_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    printf("NetX Test:   TCP Receive Under Interface Detach Test...................");
...
NX_PACKET   *my_packet;
    ...
    status =  nx_tcp_socket_receive(&server_socket, &my_packet, 5 * NX_IP_PERIODIC_RATE);
...
UINT        status;
    ...
    /* Check the TCP socket receive suspended count.  */  
    if (server_socket.nx_tcp_socket_receive_suspension_list == NX_NULL)       
        error_counter++;
...
#endif
{
    printf("NetX Test:   TCP Receive Under Interface Detach Test...................N/A\n");
