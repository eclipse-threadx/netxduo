...
static UCHAR   send_buff[1500];
static UCHAR   recv_buff[1500];
...
#else
void    netx_tcp_odd_window_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   TCP Odd Window Test.......................................");
    ...
    status = nx_packet_data_append(my_packet, send_buff, 1, &pool_0, 2 * NX_IP_PERIODIC_RATE);
    if(status)
        error_counter++;
    ...
    status = nx_packet_data_append(my_packet, send_buff + 1, sizeof(send_buff) - 1, 
...
#endif
{
    ...
    printf("NetX Test:   TCP Odd Window Test.......................................N/A\n");
