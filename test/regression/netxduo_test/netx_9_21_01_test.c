...
/* Procedure
   ...
   2. Server disconnect.
   3. Client disconnect,then Client's state move to LAST-ACK state.
   4. Server sends RST to Client.
   5. Judge the Client state.  */
...
static UINT    my_packet_process_9_21_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
static void    my_tcp_packet_receive_9_21_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_9_21_01_application_define(void *first_unused_memory)
#endif
{
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 9.21.01 Test.....................................");
    ...
    /* Deal the FIN packet with my routing  */
    advanced_packet_process_callback = my_packet_process_9_21_01;
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_9_21_01;
...
NX_TCP_HEADER   *tcp_header_ptr;
    ...
    /* drop the fin packet send from client to server */
...
void    my_tcp_packet_receive_9_21_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 9.21.01 Test.....................................N/A\n");
