...
#else
void    netx_tcp_overlapping_packet_test_16_application_define(void *first_unused_memory)
#endif
{
...
ULONG          seq1, seq2;
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 16............................");
    ...
    /* The full message to send is: 0x0100000002000000......00010000 
                    ...
                    Packet 2 sends: 0x0100000002000000......C0000000
                    Packet 3 sends: 0x4100000042000000......00010000 */
    
    status = nx_packet_data_append(my_packet1, (VOID *)(&long_msg[0]), 0x100, &pool_0, TX_WAIT_FOREVER);
    status += nx_packet_data_append(my_packet2, (VOID *)(&long_msg[0]), 0x300, &pool_0, TX_WAIT_FOREVER);
    status += nx_packet_data_append(my_packet3, (VOID *)(&long_msg[64]), 0x300, &pool_0, TX_WAIT_FOREVER);
    ...
    /* Set the tx_seq to seq1 to send packet2 that is duplicated.  */
...
#endif
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 16............................N/A\n");
