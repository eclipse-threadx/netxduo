...
#else
void    netx_tcp_tunnel_ipv4_ipv6_address_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    status; 
    ...
    ipv6_address_5.nxd_ip_address.v6[0] = 0x40010000;
    ipv6_address_5.nxd_ip_address.v6[1] = 0x00000000;
    ipv6_address_5.nxd_ip_address.v6[2] = 0x00000000;
    ipv6_address_5.nxd_ip_address.v6[3] = 0x20000005;
...
UINT        status;
    ...
    printf("NetX Test:   TUNNEL TCP IPV4_6 ADDRESS Processing Test.....");
    ...
    address_selector_0.nx_selector_dst_tunnel_address = ipv6_address_5;
...
ULONG           actual_status;
    ...
    /* add tunnel address.  */
    address_selector_1.nx_selector_src_tunnel_address = ipv6_address_5;
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("NetX Test:   TUNNEL TCP IPV4_6 ADDRESS Processing Test.................N/A\n");
