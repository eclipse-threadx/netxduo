/* 4.21 If an OPEN call arrives on state SYN-SENT, TCP MUST return error: connection already exists.  */
...
#else
void           netx_4_21_application_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 4.21 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_4_21;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 4.21 Test........................................N/A\n"); 
