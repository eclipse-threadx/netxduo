...
#else
void           netx_tcp_overlapping_packet_test_13_application_define(void *first_unused_memory)
#endif
{
    CHAR           *pointer;
    UINT           status;
...
static void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 13............................");
    ...
    memcpy(my_packet4 -> nx_packet_prepend_ptr, &msg[45], 35);
    my_packet4 -> nx_packet_length = 35;
    my_packet4 -> nx_packet_append_ptr = my_packet4 -> nx_packet_prepend_ptr + 35;

    memcpy(my_packet5 -> nx_packet_prepend_ptr, &msg[20], 25); 
    my_packet5 -> nx_packet_length = 25;
    my_packet5 -> nx_packet_append_ptr = my_packet5 -> nx_packet_prepend_ptr + 25;
    ...
    /* Send the 4th one   */
    client_socket.nx_tcp_socket_tx_sequence = seq1;
    client_socket.nx_tcp_socket_tx_sequence += 25;
    ...
    client_socket.nx_tcp_socket_tx_sequence += 55;
...
#endif
{
    printf("NetX Test:   TCP Overlapping Packet Test 13............................N/A\n");
