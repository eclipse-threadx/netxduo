/* 12.03 TCP MUST ignore without error any TCP option it does not implement.   */

/* Procedure
1. Client send SYN to server.
2. When server receives SYN packet, modify the TCP option to error in 'my_tcp_packet_process_12_03'.
3. Pass the SYN packet to the default function .
4. Check if client connect to server successfully.  */
...
static void    my_tcp_packet_receive_12_03(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_12_03_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 12.03 Test.......................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_03;
...
UINT       status;
    ...
    advanced_packet_process_callback = my_packet_process_12_03;
...
#error "NetX Product undefined."
    ...
    if(packet_ptr -> nx_packet_length >= 40)
    {
        ...
        {   
            ...
            /* Modify the TCP option to unkown option with crrect option length. */
            *option_word_1 = 0x05040002;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 12.03 Test.......................................N/A\n"); 
