/* This case tests HTTP Proxy non-blocking connection. */
#include    "tx_api.h"
#include    "nx_api.h"
...
#else
void    netx_http_proxy_non_block_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NX_PACKET       *packet_ptr;
    ...
    printf("NetX Test:   HTTP Proxy Non Block Test.................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   HTTP Proxy Non Block Test.................................N/A\n"); 
