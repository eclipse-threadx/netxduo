/* 2.20 When congestion occurs, one-half of the current window size is saved in ssthresh.  */
...
static void    my_tcp_packet_receive_2_20(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_2_20_application_define(void *first_unused_memory)
#endif
{
CHAR           *pointer;
UINT           status;
...
NX_PACKET    *my_packet4;
    ...
    printf("NetX Test:   TCP Spec 2.20 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_2_20;
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_2_20;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 2.20 Test........................................N/A\n"); 
