...
#else
void          netx_tcp_overlapping_packet_test_5_application_define(void *first_unused_memory)
#endif
{
    CHAR      *pointer;
    UINT      status;
...
static void   thread_0_entry(ULONG thread_input)
{
    ...
    NX_PACKET      *my_packet123;
    NX_PACKET      *my_packet23;
    char           *msg = MSG;
    ULONG          seq1;

    /* Print out test information banner.  */
    printf("NetX Test:   TCP Overlapping Packet Test 5.............................");
    ...
    status += nx_packet_allocate(&pool_0, &my_packet123, NX_TCP_PACKET, NX_WAIT_FOREVER);
    ...
    /* Packet 1   contains bytes  0 - 19 
       ...
       packet 123 contains bytes 20 - 59
       packet 23  contains bytes 60 - 89 */
    ...
    memcpy(my_packet3 -> nx_packet_prepend_ptr, &msg[80], 20);
    my_packet3 -> nx_packet_length = 20;
    my_packet3 -> nx_packet_append_ptr = my_packet3 -> nx_packet_prepend_ptr + 20;

    memcpy(my_packet123 -> nx_packet_prepend_ptr, &msg[20], 40);
    my_packet123 -> nx_packet_length = 40;
    my_packet123 -> nx_packet_append_ptr = my_packet123 -> nx_packet_prepend_ptr + 40;

    memcpy(my_packet23 -> nx_packet_prepend_ptr, &msg[60], 30); 
    my_packet23 -> nx_packet_length = 30;
    my_packet23 -> nx_packet_append_ptr = my_packet23 -> nx_packet_prepend_ptr + 30;
    ...
    /* Restore the seq number for packet 123 */
    client_socket.nx_tcp_socket_tx_sequence = seq1;

    /* Also reduce the outstanding byte count. */
    client_socket.nx_tcp_socket_tx_outstanding_bytes -= 20;
    status += nx_tcp_socket_send(&client_socket, my_packet123, NX_IP_PERIODIC_RATE);
    ...
    /* Also reduce the outstanding byte count. */
    client_socket.nx_tcp_socket_tx_outstanding_bytes -= 10;
#endif 
    status += nx_tcp_socket_send(&client_socket, my_packet23, NX_IP_PERIODIC_RATE);
    client_socket.nx_tcp_socket_tx_sequence += 10;
...
#endif
{
    printf("NetX Test:   TCP Overlapping Packet Test 5.............................N/A\n");
