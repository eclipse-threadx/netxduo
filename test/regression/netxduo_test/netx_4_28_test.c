/* 4.28 If an OPEN call arrives on state CLOSING, TCP MUST return error: connection already exists.  */
...
static void    my_tcp_packet_receive_4_28(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_4_28_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 4.28 Test........................................");
    ...
    /* Let driver drop the FIN packet. */
    advanced_packet_process_callback = my_packet_process_4_28;

     /*Let the client socket to check the FIN segment*/
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_4_28;
    ...
    /* Let the server thread finish first. */
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 4.28 Test........................................N/A\n");
