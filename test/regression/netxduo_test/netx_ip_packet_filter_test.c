...
#if defined(NX_ENABLE_IP_PACKET_FILTER) && !defined(NX_DISABLE_ICMP_INFO)
...
static UINT    drop_incoming_packet(VOID *ip_header_ptr, UINT direction);
static UINT    drop_outgoing_packet(VOID *ip_header_ptr, UINT direction);
...
#else
void    netx_ip_packet_filter_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        test_responded_to = 0;
    ...
    printf("NetX Test:   IP Packet Filter Test.....................................");
    ...
    ip_0.nx_ip_packet_filter = NX_NULL;
    ...
    ip_0.nx_ip_packet_filter = drop_outgoing_packet;
    ...
    ip_0.nx_ip_packet_filter = drop_incoming_packet;
...
{                                                                        
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   IP Packet Filter Test.....................................N/A\n");
