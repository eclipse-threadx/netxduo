/* 10.23.01 TCP, in LISTEN state, Send RST message when recieved a FIN + ACK.  */

/*  Procedure
    1.When the Server has been on the LISTEN state, Client sends a FIN to Server
    2.Check if the state has been changed.  */
...
static void    my_tcp_packet_receive_10_23_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_10_23_01_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_10_23_01_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    advanced_packet_process_callback = my_packet_process_10_23_01;
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_10_23_01;

    tx_thread_suspend(&ntest_0);

    if((fin_counter != 1) || (server_socket.nx_tcp_socket_state != NX_TCP_LISTEN_STATE))
        error_counter++;
...
UINT        status;
    ...
    printf("NetX Test:   TCP Spec 10.23.01 Test....................................");
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_10_23_01_2;

    /* Send FIN packet.  */
    _nx_tcp_packet_send_fin(&client_socket, client_socket.nx_tcp_socket_tx_sequence);
    ...
    if((error_counter) || (rst_counter != 1) || (fin_counter != 1) || (rst_for_fin_ack != 1))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 10.23.01 Test....................................N/A\n");
