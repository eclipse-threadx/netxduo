/*  1.03 TCP MUST send an ACK in response to a FIN received in ESTABLISHED state.  */

/* Procedure
   1. Check the state of client is ESTABLISHED.
   2. Server sends a FIN packet.
   3. Check the packet is a FIN one.
   4. Client replies a packet.
   5. Check the packet is an ACK one.  */
...
static void    my_tcp_packet_receive_1_03(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_1_03_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_03_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_03;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 1.03 Test........................................");
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_03_2;
...
void           my_tcp_packet_receive_1_03(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER               *tcp_header_ptr;

    /* Check the state of client is ESTABLISHED.  */
...
void           my_tcp_packet_receive_1_03_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER               *tcp_header_ptr;
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.03 Test........................................N/A\n"); 
