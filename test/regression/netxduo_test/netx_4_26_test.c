/* 4.26 If an OPEN call arrives on state FINWAIT-2, TCP MUST return error: connection already exists.  */
...
#else
void           netx_4_26_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    /* An OPEN call arrives when the client socket is in FIN_WAIT_2 state. */
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 4.26 Test........................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 4.26 Test........................................N/A\n");
