/* This NetX test to test the ICMPv6 Echo Reply process.  */
...
0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0x81, 0x00, /* "..3DV.. */
...
#else
void           netx_icmpv6_echo_reply_test_application_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
...
NX_IPV6_HEADER   *ip_header_ptr;
    ...
    printf("NetX Test:   ICMPv6 Echo Reply Test....................................");
    ...
    /* Call the _nx_ip_packet_receive function directly receive the ICMPv6 Echo Reply.  */
    _nx_ip_packet_receive(&ip_0, my_packet);
  
    /* Check the value.  */    
    if ((ip_0.nx_ip_ping_responses_received != 1) || (ip_0.nx_ip_icmp_invalid_packets != 1))  
    {
        printf("ERROR!\n");
        test_control_return(1);
    }                   
    ...
    /* Call the _nx_ip_packet_receive function directly receive the ICMPv6 Echo Reply with error source address.  */
    _nx_ip_packet_receive(&ip_0, my_packet);
 
    /* Check the value.  */                                                         
    if ((ip_0.nx_ip_ping_responses_received != 2) || (ip_0.nx_ip_icmp_invalid_packets != 2))  
    {
        printf("ERROR!\n");
        test_control_return(1);
    }                                                    
    ...
    /* Call the _nx_ip_packet_receive function directly receive the valid ICMPv6 Echo Reply.  */
    _nx_ip_packet_receive(&ip_0, my_packet);
  
    /* Check the value.  */                                                             
    if ((ip_0.nx_ip_ping_responses_received != 3) || (ip_0.nx_ip_icmp_invalid_packets != 3))  
    {
        printf("ERROR!\n");
        test_control_return(1);
    }  
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   ICMPv6 Echo Reply Test....................................N/A\n");
