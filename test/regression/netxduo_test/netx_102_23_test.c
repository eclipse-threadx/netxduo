/* 102.23 Slow start continues until TCP is halfway to where it was when congestion occurred.   */
...
static void    my_tcp_packet_receive_102_23(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_102_23_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG        cwnd;
    ...
    printf("NetX Test:   TCP Spec 102.23 Test......................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_102_23;
    ...
    /* Check whether the cwnd = cwnd + MSS.  */
    if((ack_counter != 1) || (server_socket.nx_tcp_socket_tx_window_congestion != 20 + cwnd))
        error_counter++;
...
#endif
{
    printf("NetX Test:   TCP Spec 102.23 Test......................................N/A\n");
