...
#else
void    netx_tcp_overlapping_packet_test_2_application_define(void *first_unused_memory)
#endif
{
...
static void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 2.............................");
    ...
    /* Packet 1 contains bytes   0 - 37 
       ...
       packet 23 contains bytes 37 - 112 */
    ...
    memcpy(my_packet23 -> nx_packet_prepend_ptr, &msg[37], 76);
...
#endif
{
    printf("NetX Test:   TCP Overlapping Packet Test 2.............................N/A\n");
