/* 6.29 TCP, in FINWAIT-1 state, MUST return error: connection closing for CLOSE call.  */

/* Procedure
   1. Client connect with Server.
   2. Server disconnect, then server state is FINWAIT1.
   3. Client call disconnect.
   4. Check the status.  */
...
static UINT    my_packet_process_6_29(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
...
#else
void           netx_6_29_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 6.29 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_6_29;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 6.29 Test........................................N/A\n");
