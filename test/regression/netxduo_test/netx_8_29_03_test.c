/* 8.29.03 TCP, in CLOSING state,MUST ignore a RST segment with OTW SEQ number.  */
...
static void    my_tcp_packet_receive_8_29_03(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_8_29_03_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    advanced_packet_process_callback = my_packet_process_8_29_03;
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_8_29_03;

    status = nx_tcp_socket_disconnect(&server_socket, NX_NO_WAIT);

    tx_thread_suspend(&ntest_0);

    if((rst_counter != 1) || (server_socket.nx_tcp_socket_state != NX_TCP_CLOSING))
        error_counter++;
...
NX_TCP_HEADER    header_ptr;
    ...
    printf("NetX Test:   TCP Spec 8.29.03 Test.....................................");
    ...
    if((error_counter) || (fin_counter != 2) || (rst_counter != 1))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
NX_TCP_HEADER   *tcp_header_ptr;
    ...
    if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_FIN_BIT) && (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT) && !(tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_RST_BIT) && (fin_counter == 0))
    {
        fin_counter++;
...
NX_TCP_HEADER        *tcp_header_ptr;
    ...
    else if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_FIN_BIT) && (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT))
        fin_counter++;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 8.29.03 Test.....................................N/A\n");
