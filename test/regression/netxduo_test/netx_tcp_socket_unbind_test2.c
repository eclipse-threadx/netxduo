...
#else
void netx_tcp_socket_unbind_test2_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    printf("NetX Test:   TCP Socket Unbind Cleanup Test 2..........................");
    ...
    /* Let socket 1 bind to CLIENT_PORT_1. */
...
UINT status;
    ...
    /* Bind the socket 1 to the port socket 0 has bound to */
    status = nx_tcp_client_socket_bind(&client_socket_1, CLIENT_PORT_2, NX_IP_PERIODIC_RATE);
