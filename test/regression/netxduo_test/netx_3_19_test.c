...
static void    my_tcp_packet_receive_3_19(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_3_19_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_3_19_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 3.19 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_3_19;

    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_3_19;
...
NX_PACKET  *my_packet2;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_3_19_2;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 3.19 Test........................................N/A\n");
