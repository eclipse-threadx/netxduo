...
#else
void    netx_forward_udp_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG       packets_sent, bytes_sent, packets_received, bytes_received, packets_queued, receive_packets_dropped, checksum_errors;
    ...
    printf("NetX Test:   Forward UDP Processing Test...............................");
    ...
    /***********************************************************************/
    /*         Socket0 sends udp packet to unknow address                  */    
    /***********************************************************************/
    ...
    /* Send the UDP packet.  */
    status =  nx_udp_socket_source_send(&socket_0, my_packet, IP_ADDRESS(3, 2, 3, 5), 0x89, 0);
    ...
    /***********************************************************************/
    /*         Socket0 sends udp packet to Socket1                         */    
    /***********************************************************************/
    ...
    /***********************************************************************/
    /*         Socket0 sends udp packet to Socket2                         */    
    /***********************************************************************/
    ...
    /* Send the UDP packet.  */
    status =  nx_udp_socket_send(&socket_0, my_packet, IP_ADDRESS(2, 2, 3, 5), 0x8a);
    ...
    /***********************************************************************/
    /*         Socket1 sends udp packet to Socket0 by interface0           */    
    /***********************************************************************/
    ...
    /***********************************************************************/
    /*         Socket1 sends udp packet to Socket0 by interface1           */    
    /***********************************************************************/
    ...
    /* Send the UDP packet.  */
    status =  nx_udp_socket_send(&socket_1, my_packet, IP_ADDRESS(2, 2, 3, 4), 0x88);
    ...
    /***********************************************************************/
    /*         Socket2 sends udp packet to Socket0 by interface0           */    
    /***********************************************************************/
    ...
    /* Send the UDP packet.  */
    status =  nx_udp_socket_send(&socket_2, my_packet, IP_ADDRESS(1, 2, 3, 4), 0x88);
    ...
    /***********************************************************************/
    /*         Socket2 sends udp packet to Socket0 by interface1           */    
    /***********************************************************************/
    ...
    /* Send the UDP packet.  */
    status =  nx_udp_socket_send(&socket_2, my_packet, IP_ADDRESS(2, 2, 3, 4), 0x88);
    ...
    /***********************************************************************/
    /*         Socket2 sends udp packet to Socket1                         */    
    /***********************************************************************/
    ...
    /* Send the UDP packet.  */
    status =  nx_udp_socket_send(&socket_2, my_packet, IP_ADDRESS(1, 2, 3, 5), 0x89);
    ...
    if ((packets_sent != 3) || (bytes_sent != 3 * 28) || (packets_received != 4) || (bytes_received != 4 * 28))
    {
        error_counter++;
    }
#endif
    ...
    /* Get UDP socket1 information.  */
    status =  nx_udp_socket_info_get(&socket_1, &packets_sent, &bytes_sent, &packets_received, &bytes_received, 
                                                &packets_queued, &receive_packets_dropped, &checksum_errors);
    
#ifndef NX_DISABLE_UDP_INFO

    if ((packets_sent != 3) || (bytes_sent != 3 * 28) || (packets_received != 2) || (bytes_received != 2 * 28))
    {
        error_counter++;
    }
#endif
...
NX_PACKET   *my_packet;
    ...
    /***********************************************************************/
    /*         Socket1 receives the udp packet from Socket0                */    
    /***********************************************************************/
    ...
    /***********************************************************************/
    /*         Socket2 receives the udp packet from Socket0                */    
    /***********************************************************************/
    ...
    /***********************************************************************/
    /*         Socket0 receives the udp packet from Socket1                */    
    /***********************************************************************/

    /* Receive a UDP packet.  */
    status =  nx_udp_socket_receive(&socket_0, &my_packet, 10 * NX_IP_PERIODIC_RATE);
    ...
    /***********************************************************************/
    /*         Socket0 receives the udp packet from Socket2                */    
    /***********************************************************************/
    ...
    /***********************************************************************/
    /*         Socket1 receives the udp packet from Socket2                */    
    /***********************************************************************/
...
#endif
{
    printf("NetX Test:   Forward UDP Processing Test...............................N/A\n");
