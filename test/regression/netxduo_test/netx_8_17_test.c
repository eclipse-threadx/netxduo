/* 8.17 TCP in SYN-SENT state MUST ignore a segment carrying an unacceptable ACK and RST.  */

/* Procedure
1. Client connects.
2. Drop the SYN+ACK packet in the driver.
3. Server sends a segment that is carrying an ACK and RST flag with unacceptable ACK number.
4. Clean up.Print the resuit. */
...
static void    my_tcp_packet_receive_8_17(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_8_17_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    advanced_packet_process_callback = my_packet_process_8_17;
    ...
    /* Deal the packet with my routing.  */
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_8_17;
...
NX_TCP_HEADER   tcp_header_ptr;
    ...
    printf("NetX Test:   TCP Spec 8.17 Test........................................");
    ...
    /* If ACK bit not set, _nx_tcp_packet_send_rst will send one RST and ACK packet.  */
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 8.17 Test........................................N/A\n"); 
