/* 11.28 TCP, FINWAIT-2 state MUST inform the application in case of aborting from remote site.  */

/* Procedure
   1. Client connects to server.
   2. Server calls disconnect function.
   2. When server receives ACK packet, client sends a RST packet to server.
...
static void    my_tcp_packet_receive_11_28(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_11_28_application_define(void *first_unused_memory)
#endif
{
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 11.28 Test.......................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_11_28;

    /* Disconnect the server socket.  */
    status = nx_tcp_socket_disconnect(&server_socket, 2 * NX_IP_PERIODIC_RATE);

    if((rst_counter != 1) || (status!= NX_DISCONNECT_FAILED))
        error_counter++;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 11.28 Test.......................................N/A\n"); 
