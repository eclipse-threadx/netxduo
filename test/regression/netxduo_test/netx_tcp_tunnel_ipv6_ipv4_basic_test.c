...
#else
void    netx_tcp_tunnel_ipv6_ipv4_basic_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR        *msg = MSG;
    ...
    printf("NetX Test:   TUNNEL TCP IPV6_4 Basic Processing Test.......");
    ...
    /* Send the packet out!  */
    status =  nx_tcp_socket_send(&client_socket, my_packet, 4 * NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("NetX Test:   TUNNEL TCP IPV6_4 Basic Processing Test...................N/A\n");
