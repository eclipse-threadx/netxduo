...
2. Server sends a RST to Client.
3. Check the Client state. */
...
static void    my_tcp_packet_receive_9_18(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_9_18_application_define(void *first_unused_memory)
#endif
{
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 9.18 Test........................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_9_18;
...
void    my_tcp_packet_receive_9_18(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 9.18 Test........................................N/A\n");
