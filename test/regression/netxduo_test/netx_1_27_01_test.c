/* 1.27.01 TCP must ignore a data segment in SYN_SENT state.  */

/* Procedure
1. Establish a connection by the "three-way handshake" procedure.
2. Set client socket to CLOSED state.
3. Let client socket connect to the server socket.
4. Let the driver drop the SYN packet.
5. Let the server socket send out a data segment.
6. Check if the client socket is in SYN_SENT state.
...
static UINT    my_packet_process_1_27_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
static void    my_tcp_packet_receive_1_27_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_27_01_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NX_PACKET    *packet_ptr;
    ...
    printf("NetX Test:   TCP Spec 1.27.01 Test.....................................");
    ...
    /* Let driver drop the SYN packet.  */
    advanced_packet_process_callback = my_packet_process_1_27_01;

    /* Attempt to connect the socket.  */
    status = nx_tcp_client_socket_connect(&client_socket, IP_ADDRESS(1, 2, 3, 5), 12, NX_NO_WAIT);

    /* Setup function pointer.  */
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_27_01;
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.27.01 Test.....................................N/A\n"); 
