...
#else
void    netx_forward_icmp_small_header_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR        data[256];
    ...
    printf("NetX Test:   Forward ICMP Small Header Processing Test2................");
    ...
    /* Check the status .  */
    if ((status != NX_SUCCESS) || (my_packet -> nx_packet_length != size))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }                                                                   
    ...
    /* Check the counter.  */
    if ((callback_0_counter != 1) || (callback_1_counter != 1))
    {
...
#endif
{
    printf("NetX Test:   Forward ICMP Small Header Processing Test2................N/A\n");
