...
/*9.21.2 test the TCP in CLOSING state*/
/* Procedure
   1. Client connect with Server.
   2. Server disconnect, delay the FIN  packet
   3. Client disconnect, then Server state is CLOSING
   4. Client sends RST to Server.
   5. Check the Server state.  */
...
static void    my_tcp_packet_receive_9_21_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_9_21_02_application_define(void *first_unused_memory)
#endif
{
...
ULONG           actual_status;
    ...
    printf("NetX Test:   TCP Spec 9.21.02 Test.....................................");
    ...
    advanced_packet_process_callback = my_packet_process_9_21_02;
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_9_21_02;
...
void    my_tcp_packet_receive_9_21_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 9.21.02 Test.....................................N/A\n");
