/* 9.19.01 TCP, in FINWAIT-1 state, MUST return to CLOSED state on RST.  */
...
2. Client disconnect, then Client state is FINWAIT1.
...
static void    my_tcp_packet_receive_9_19_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_9_19_01_application_define(void *first_unused_memory)
#endif
{
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 9.19.01 Test.....................................");
    ...
    advanced_packet_process_callback = my_packet_process_9_19_01;
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_9_19_01;
...
NX_TCP_HEADER   header_ptr;
    ...
    /* Let the ACK number is big enough excluding the OTW situation.  */
...
void    my_tcp_packet_receive_9_19_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 9.19.01 Test.....................................N/A\n");
