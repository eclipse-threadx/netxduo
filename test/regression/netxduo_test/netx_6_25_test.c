/* 6.25 If RECEIVE call arrives on state LAST-ACK, TCP MUST return "error: connection closing".  */
...
static UINT    my_packet_process_6_25(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
...
#else
void           netx_6_25_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
NX_PACKET  *my_packet;
    ...
    printf("NetX Test:   TCP Spec 6.25 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_6_25;
    ...
    if(client_socket.nx_tcp_socket_state == NX_TCP_LAST_ACK)
    {
        ...
        status = nx_tcp_socket_receive(&client_socket, &my_packet, 50);
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 6.25 Test........................................N/A\n");
