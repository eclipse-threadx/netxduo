/* 1.21 TCP MUST send an ACK after receiving a FIN in FIN_WAIT_2 state.  */

/* Procedure
1. Establish a connection by the "three-way handshake" procedure.
2. Server sends a FIN packet.
3. Server receives an ACK packet which responsing the FIN one and becomes FIN_WAIT_2 state.
...
static void    my_tcp_packet_receive_1_21_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_1_21_02_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_21_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 1.21.02 Test.....................................");
    ...
    /* Let server check the packet.  */
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_21_02;
...
UINT       status;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_21_02_2;
...
void           my_tcp_packet_receive_1_21_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER               *tcp_header_ptr;

    /* Check the state of server is FIN_WAIT_2.  */
...
void           my_tcp_packet_receive_1_21_02_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER               *tcp_header_ptr;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 1.21.02 Test.....................................N/A\n"); 
