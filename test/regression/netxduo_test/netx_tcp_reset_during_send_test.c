...
/* This NetX test concentrates on sending TCP packets while socket is reset by peer.  */

#include   "nx_api.h"

extern void    test_control_return(UINT status);
#if defined(__PRODUCT_NETXDUO__) && !defined(NX_DISABLE_RESET_DISCONNECT) &&!defined(NX_DISABLE_PACKET_CHAIN) && !defined(NX_DISABLE_IPV4)
...
#else
void    netx_tcp_reset_during_send_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   TCP Reset During Send Test................................");
    ...
    else if (my_packet -> nx_packet_length == sizeof(send_buff))
    {

        /* Partial data should be sent but not. */
        error_counter++;
    }
