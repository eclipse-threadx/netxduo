...
/* Test tcp function between IP_2 and Interface0 of IP_0.  */
...
#else
void    netx_forward_tcp_test_3_application_define(void *first_unused_memory)
#endif
{
...
ULONG       packets_sent, bytes_sent, packets_received, bytes_received, retransmit_packets, packets_queued, checksum_errors, socket_state, transmit_queue_depth, transmit_window, receive_window;
    ...
    printf("NetX Test:   Forward TCP Processing Test3..............................");
    ...
    status =  nx_tcp_client_socket_connect(&socket_2, IP_ADDRESS(1, 2, 3, 4), 0x89, 5 * NX_IP_PERIODIC_RATE);
...
#endif
{
    printf("NetX Test:   Forward TCP Processing Test3..............................N/A\n");
