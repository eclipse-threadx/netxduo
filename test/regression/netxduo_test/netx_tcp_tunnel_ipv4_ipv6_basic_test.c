...
#else
void    netx_tcp_tunnel_ipv4_ipv6_basic_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR        *msg = MSG;
    ...
    printf("NetX Test:   TUNNEL TCP IPV4_6 Basic Processing Test.......");
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("NetX Test:   TUNNEL TCP IPV4_6 Basic Processing Test...................N/A\n");
