/* 13.02 TCP SHOULD implement a delayed ACK, but the delay MUST be less than 0.5 sec.  */
...
static void    my_tcp_packet_receive_13_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_13_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
    ...
    status = tx_timer_create(&my_timer, "my timer", 
...
NX_PACKET       *rcv_packet_ptr;
    ...
    printf("NetX Test:   TCP Spec 13.02 Test.......................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_13_02;

    advanced_packet_process_callback = my_packet_process_13_02;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 13.02 Test.......................................N/A\n"); 
