/* 5.22 f SEND call arrives on state CLOSING, TCP MUST return "error: connection closing".  */
...
static void    my_tcp_packet_receive_5_22(NX_IP *ip_ptr, NX_PACKET *packet_ptr);

extern UINT    (*advanced_packet_process_callback)(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
static UINT    my_packet_process_5_22(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
...
#else
void           netx_5_22_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
NX_PACKET  *my_packet;
    ...
    printf("NetX Test:   TCP Spec 5.22 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_5_22;

    /*Let the client socket to check the FIN segment*/
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_5_22;
    ...
    if (client_socket.nx_tcp_socket_state == NX_TCP_CLOSING)
    {
        ...
        status = nx_packet_data_append(my_packet, "01012345678920123456", 20, &pool_0, NX_NO_WAIT);
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 5.22 Test........................................N/A\n");
