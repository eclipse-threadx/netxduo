...
#else
void           netx_nd_cache_under_interface_detach_test_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT                interface_index;
    ...
    printf("NetX Test:   ND Cache Under Interface Detach Test......................"); 
    ...
    /* Match the mac address and interface index.  */
    if ((interface_index != 1) ||
        (ipv6_address.nxd_ip_address.v6[0] != dest_address[3].nxd_ip_address.v6[0]) ||
        (ipv6_address.nxd_ip_address.v6[1] != dest_address[3].nxd_ip_address.v6[1]) ||
        (ipv6_address.nxd_ip_address.v6[2] != dest_address[3].nxd_ip_address.v6[2]) ||
        (ipv6_address.nxd_ip_address.v6[3] != dest_address[3].nxd_ip_address.v6[3]))
        error_counter ++;                                          
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   ND Cache Under Interface Detach Test......................N/A\n");   
