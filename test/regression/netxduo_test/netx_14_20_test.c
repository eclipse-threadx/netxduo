...
#else
void           netx_14_20_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG        rcv_length;
    ...
    printf("NetX Test:   TCP Spec 14.20 Test.......................................");
    ...
    else
    {
        ...
        if((rcv_packet_ptr -> nx_packet_length == mss_option) && (!memcmp(rcv_packet_ptr -> nx_packet_prepend_ptr, MSG, mss_option)))
           data_packet_counter++;
...
char         *msg = MSG;
    ...
    status = nx_packet_data_append(my_packet, msg, mss_option, &pool_0, NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 14.20 Test.......................................N/A\n"); 
