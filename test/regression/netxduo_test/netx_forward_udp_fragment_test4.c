/* This NetX test concentrates on the forward fragment operation.
   (fragment failure: source_packet -> nx_packet_next is null and the remaining_bytes is non zero in nx_ip_fragment_forward_packet).  */
...
#else
void    netx_forward_udp_fragment_test4_application_define(void *first_unused_memory)
#endif
{
...
UINT        free_port;
    ...
    printf("NetX Test:   Forward UDP Fragment Test4................................");
...
ULONG           val;
    ...
    /* Clear the checksum.  */
    ip_header_ptr -> nx_ip_header_word_2 &= 0x0000FFFF;
