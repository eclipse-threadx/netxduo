/* 1.18 TCP MUST be capable of progressing to ESTABLISHED state after receiving SYN,ACK in SYN-SENT state.   */
...
static void    my_tcp_packet_receive_1_18(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_18_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_18;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 1.18 Test........................................");
...
void    my_tcp_packet_receive_1_18(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER    *tcp_header_ptr;

    /* Check the state of client is SYN_SENT.  */
    if(client_socket.nx_tcp_socket_state == NX_TCP_SYN_SENT)
    {
        tcp_header_ptr = (NX_TCP_HEADER *)packet_ptr -> nx_packet_prepend_ptr;
        NX_CHANGE_ULONG_ENDIAN(tcp_header_ptr -> nx_tcp_header_word_3);

        /* Check the packet is a SYN + ACK one.  */
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.18 Test........................................N/A\n"); 
