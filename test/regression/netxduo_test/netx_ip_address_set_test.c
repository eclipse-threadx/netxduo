...
#else
void netx_ip_address_set_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG       my_packet_length;

    
    /* Print out test information banner.  */
    printf("NetX Test:   IP Address Set Test.......................................");
    ...
    status += nx_packet_length_get(my_packet, &my_packet_length);
    if((status != NX_SUCCESS) || (my_packet == NX_NULL) || (my_packet_length != 28))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
    ...
    if ((pings_sent != 3) || (ping_timeouts != 1) || (ping_responses_received != 2) || (icmp_checksum_errors) || 
    ...
    status = nx_ip_address_set(&ip_1, IP_ADDRESS(1, 2, 3, 5), 0xFFFFFF00);
...
#endif
{
    printf("NetX Test:   IP Address Set Test.......................................N/A\n");
