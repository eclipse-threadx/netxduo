/* 4.25 If an OPEN call arrives on state FINWAIT-1, TCP MUST return error: connection already exists.  */
...
#else
void           netx_4_25_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 4.25 Test........................................");
    ...
    /* Let the driver drop the FIN packet.  */
    advanced_packet_process_callback = my_packet_process_4_25;
    ...
    /* An OPEN call arrives at the state NX_TCP_FIN_WAIT_1. */
    if (client_socket.nx_tcp_socket_state == NX_TCP_FIN_WAIT_1)
    {
        status = nx_tcp_client_socket_connect(&server_socket, IP_ADDRESS(1, 2, 3, 5), 12, 0);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 4.25 Test........................................N/A\n");
