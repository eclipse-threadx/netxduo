/* 1.26 TCP MAY send an ACK after receiving a data segment in FINWAIT_1 state.  */
...
static void    my_tcp_packet_receive_1_26_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_26_01_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NX_PACKET       *packet_ptr;
    ...
    printf("NetX Test:   TCP Spec 1.26.01 Test.....................................");
    ...
    advanced_packet_process_callback = my_packet_process_1_26_01;
...
NX_PACKET   *my_packet;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_26_01;
...
void    my_tcp_packet_receive_1_26_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER    *tcp_header_ptr;
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.26.01 Test.....................................N/A\n");
