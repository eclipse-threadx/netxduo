...
#else
void    netx_tcp_large_mtu_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG   tcp_transmit_window;
    ...
    printf("NetX Test:   TCP Large MTU Test........................................");
    ...
    /* Verify the cwnd is 2MSS. */
    if ((tcp_transmit_window != client_socket.nx_tcp_socket_connect_mss * 2) ||
...
UINT    status;
    ...
    /* Verify the cwnd is 2MSS. */
    if (server_socket.nx_tcp_socket_tx_window_congestion != server_socket.nx_tcp_socket_connect_mss * 2)
    {
        error_counter++;
    }
...
#endif
{
    ...
    printf("NetX Test:   TCP Large MTU Test........................................N/A\n");
