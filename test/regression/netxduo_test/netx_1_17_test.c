/* 1.17 TCP, in CLOSED state, MUST send a SYN on an active OPEN call.   */
...
static void    my_tcp_packet_receive_1_17(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_17_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    /* Check the state of client is CLOSED.  */
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 1.17 Test........................................");
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_17;
...
void           my_tcp_packet_receive_1_17(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER               *tcp_header_ptr;
    ...
    if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_SYN_BIT) && !(tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT) && !(tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_RST_BIT))
    {
        ...
        /* Deal the packet with default routing.  */
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.17 Test........................................N/A\n"); 
