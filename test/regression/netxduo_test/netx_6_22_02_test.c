...
/* Procedure
  ...
  2. Client call disconnect without waiting, then Client state is FIN-WAIT-2..
  3. Client call receive function,then judge the status.  */
...
#else
void           netx_6_22_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
NX_PACKET  *rcv_packet_ptr;
    ...
    printf("NetX Test:   TCP Spec 6.22.02 Test.....................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 6.22.02 Test.....................................N/A\n");
