/* 5.24 If a SEND call arrives on SYN-SENT state, TCP MAY queue the request and send it after entering ESTABLISHED state.  */

/* Procedure
   1. Client sends a SYN packet and becomes SYN_SENT state.
   2. Client calls the send command.
   3. Check the status, test error.
   4. After entering ESTABLISHED state, check if client sends the packet.*/
...
#else
void           netx_5_24_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET  *my_packet;
    ...
    printf("NetX Test:   TCP Spec 5.24 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_5_24;
    ...
    if (client_socket.nx_tcp_socket_state == NX_TCP_SYN_SENT)
    {
        ...
        /* Send the packet out!  */
        nx_tcp_socket_send(&client_socket, my_packet, NX_IP_PERIODIC_RATE);
    }
    else
        error_counter++;
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 5.24 Test........................................N/A\n"); 
