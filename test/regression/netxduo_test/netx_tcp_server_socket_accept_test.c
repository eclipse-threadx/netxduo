/* This NetX test concentrates on the TCP Server Socket accept operation.  */
...
#else
void    netx_tcp_server_socket_accept_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        client_port;
    ...
    printf("NetX Test:   TCP Server Socket Accept Test.............................");
    ...
    status =  nx_tcp_socket_disconnect(&client_socket_0, NX_IP_PERIODIC_RATE);
...
ULONG           actual_status;
    ...
    /* Accept the server socket before listen.  */
    ...
    /* Accept the server socket again.  */
    status =  nx_tcp_server_socket_accept(&server_socket_0, NX_NO_WAIT);
    ...
    /* Disconnect the server socket.  */
    status =  nx_tcp_socket_disconnect(&server_socket_0, NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    printf("NetX Test:   TCP Server Socket Accept Test.............................N/A\n"); 
