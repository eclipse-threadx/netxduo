/* 23.02.2 TCP in LISTEN state, MUST reject an incoming SYN with 
multicast addresses  as source IP address.  */

/* Update
   1. nx_tcp_packet_process.c between line 340 and line 355.  */
...
#else
void           netx_23_02_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 23.02.02 Test....................................");
...
UINT       status;
    ...
    advanced_packet_process_callback = my_packet_process_23_02_02;
...
ULONG            checksum;
    ...
    if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_SYN_BIT) && (!(tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT)))
    {
        ...
        ip_header_ptr -> nx_ip_header_source_ip =  0x010000E0;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 23.02.02 Test....................................N/A\n");
