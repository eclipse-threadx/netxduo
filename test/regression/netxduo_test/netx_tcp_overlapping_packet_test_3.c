...
#else
void    netx_tcp_overlapping_packet_test_3_application_define(void *first_unused_memory)
#endif
{
...
static void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 3.............................");
    ...
    memcpy(my_packet23 -> nx_packet_prepend_ptr, &msg[37], 77);
...
#endif
{
    printf("NetX Test:   TCP Overlapping Packet Test 3.............................N/A\n");
