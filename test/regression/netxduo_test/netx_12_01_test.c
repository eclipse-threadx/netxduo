...
/* Procedure
   ...
   2. When server receives SYN packet, modify the length of MSS in 'my_tcp_packet_process_12_01'.
   3. Pass the SYN packet to the default function .
   4. Check whether client received the RST packet.  */
...
static void    my_tcp_packet_receive_12_01_1(NX_IP *ip_ptr, NX_PACKET *packet_ptr);    
static void    my_tcp_packet_receive_12_01_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_12_01_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 12.01 Test.......................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_01_1;
...
UINT       status;
    ...
    advanced_packet_process_callback = my_packet_process_12_01; 

    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_01_2;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 12.01 Test.......................................N/A\n"); 
