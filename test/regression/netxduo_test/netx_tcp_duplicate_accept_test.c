...
static UINT                    syn_ack_received;
static UINT                    sequence[10];
static UINT                    ack_number[10];
...
#else
void    netx_tcp_duplicate_accept_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    status;
    ...
    status =  nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", 1536, pointer, 10240);
...
ULONG       actual_status;
    ...
    printf("NetX Test:   TCP Duplicate Accept Test.................................");
    ...
    /* Filter the TCP packet received by client. */
...
UINT            i;
    ...
    /* Accept a client socket connection again.  */
    status =  nx_tcp_server_socket_accept(&server_socket, NX_NO_WAIT);
    if (status != NX_IN_PROGRESS)
        error_counter++;
...
NX_TCP_HEADER  *tcp_header_ptr;   
       ...
       (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT))
    {
        ...
        sequence[syn_ack_received] = tcp_header_ptr -> nx_tcp_sequence_number;
        ack_number[syn_ack_received] = tcp_header_ptr -> nx_tcp_acknowledgment_number;
        syn_ack_received++;
    }
...
#endif
{
    ...
    printf("NetX Test:   TCP Duplicate Accept Test.................................N/A\n");
