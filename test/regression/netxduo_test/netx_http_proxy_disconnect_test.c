/* This case tests TCP disconnect before HTTP Proxy connected. */
#include    "tx_api.h"
#include    "nx_api.h"
...
#else
void    netx_http_proxy_disconnect_test_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NX_PACKET       *packet_ptr;
    ...
    printf("NetX Test:   HTTP Proxy Disconnect Test................................");
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   HTTP Proxy Disconnect Test................................N/A\n"); 
