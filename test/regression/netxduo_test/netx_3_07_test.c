/* 3.7 TCP, in ESTABLISHED state, MUST send an ACK indicating the correct SEQ number it expects, after receiving a SYN with a SEQ number that is OTW.  */
...
static void    my_tcp_packet_receive_3_07(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_3_07_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_3_07_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG             actual_status;
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_3_07;
...
UINT              status;
    ...
    printf("NetX Test:   TCP Spec 3.07 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_3_07;

    status = nx_tcp_socket_disconnect(&client_socket, NX_NO_WAIT);

    /* Let client checks the packet.  */
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_3_07_2;
    ...
    if((error_counter) || (rst_counter != 1) || (syn_counter != 1) || (ack_counter != 1))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
ULONG           source_ip, dest_ip;
    ...
    {
        /* Modify the sequence number of the packet to be OTW and recalculate the checksum. */
        NX_CHANGE_ULONG_ENDIAN(tcp_header_ptr ->nx_tcp_sequence_number);
        tcp_header_ptr ->nx_tcp_sequence_number += server_socket.nx_tcp_socket_rx_window_current;
        NX_CHANGE_ULONG_ENDIAN(tcp_header_ptr ->nx_tcp_sequence_number);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 3.07 Test........................................N/A\n");
