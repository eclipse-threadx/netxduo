...
3.Client sends an unacceptable RST packet to server.
4.Server will remain the same state.
5.Check the status.  */
...
static void    my_tcp_packet_receive_3_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_3_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 3.02 Test........................................");
    ...
    advanced_packet_process_callback = my_packet_process_3_02;

    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_3_02;

    tx_thread_suspend(&ntest_0);

    /* The server socket should remain the SYN_RVED state.  */
    if((server_socket.nx_tcp_socket_state != NX_TCP_SYN_RECEIVED) || (rst_counter != 1))
        error_counter++;
...
NX_TCP_HEADER   header_ptr;
    ...
    if(error_counter || (rst_counter != 1) || (syn_ack_counter != 1))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
NX_TCP_HEADER   *tcp_header_ptr;
    ...
    /* Check if it is a AYN+ACK packet.  */
    if ((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_SYN_BIT) && (tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT) && !(tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_RST_BIT))
    {
        ...
        *delay_ptr = NX_IP_PERIODIC_RATE;
        ...
        /* AYN+ACK packet has been processed. */ 
...
NX_TCP_HEADER   *header_ptr;
    ...
    /* The server socket should be in SYN_RVED state.  */
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 3.02 Test........................................N/A\n"); 
