...
#define MSG "1---------abcdefgh203---------ABCDEFGH405---------klmnopqr607---------KLMNOPQR809---------"
...
#else
void           netx_tcp_overlapping_packet_test_8_application_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
...
static void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 8.............................");
    ...
    /* Create 4 packets, packet 1-3 contains 3 segments of the outgoing message. Packet 4 contains a retran overlapping 1-3.   */
    ...
    memcpy(my_packet4 -> nx_packet_prepend_ptr, &msg[0], 60);
    my_packet4 -> nx_packet_length = 60;
    my_packet4 -> nx_packet_append_ptr = my_packet4 -> nx_packet_prepend_ptr + 60;
    ...
    /* Update the seq number and send the my_packet1.   */
...
#endif
{
    printf("NetX Test:   TCP Overlapping Packet Test 8.............................N/A\n");
