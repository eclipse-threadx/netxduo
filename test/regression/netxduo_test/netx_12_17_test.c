...
static void    my_tcp_packet_receive_12_17_1(NX_IP *ip_ptr, NX_PACKET *packet_ptr);   
static void    my_tcp_packet_receive_12_17_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
static UINT    my_packet_process_12_17(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
...
#else
void           netx_12_17_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 12.17 Test.......................................");  
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_17_1;

    /*To handle the syn,ack packet.*/
    advanced_packet_process_callback = my_packet_process_12_17;
...
ULONG      actual_status;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_17_2;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 12.17 Test.......................................N/A\n"); 
