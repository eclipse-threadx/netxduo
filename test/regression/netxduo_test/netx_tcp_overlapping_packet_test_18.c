...
#define MSG "11122222333333344444444"
...
#else
void    netx_tcp_overlapping_packet_test_18_application_define(void *first_unused_memory)
#endif
{
...
ULONG          seq1, seq2;
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 18............................");
    ...
    status += nx_packet_data_append(my_packet2, &msg[0], 15, &pool_0, TX_WAIT_FOREVER);
    status += nx_packet_data_append(my_packet3, &msg[3], 20, &pool_0, TX_WAIT_FOREVER);
    ...
    /* Store tx_seq after sending packet1.  */
    seq2 = client_socket.nx_tcp_socket_tx_sequence;

    /* Set the tx_seq to seq1 to send packet2 with duplicate data.  */
    client_socket.nx_tcp_socket_tx_sequence = seq1;
    status += nx_tcp_socket_send(&client_socket, my_packet2, NX_IP_PERIODIC_RATE);

    /* Set the tx_seq to seq2 to send packet3.  */
    client_socket.nx_tcp_socket_tx_sequence = seq2;
...
ULONG          total_length = 0;
    ...
    status =  nx_ip_status_check(&ip_1, NX_IP_INITIALIZE_DONE, (ULONG *)&actual_status, NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 18............................N/A\n");
