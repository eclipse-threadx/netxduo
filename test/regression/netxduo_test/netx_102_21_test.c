...
static UINT    my_packet_process_102_21(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr);
static void    my_tcp_packet_receive_102_21(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_102_21_application_define(void *first_unused_memory)
#endif
{
CHAR           *pointer;
UINT           status;
...
NX_PACKET    *my_packet4;
    ...
    printf("NetX Test:   TCP Spec 102.21 Test......................................");
    ...
    advanced_packet_process_callback = my_packet_process_102_21;
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_102_21;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 102.21 Test......................................N/A\n"); 
