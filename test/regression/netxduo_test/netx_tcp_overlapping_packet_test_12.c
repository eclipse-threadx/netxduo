...
#else
void           netx_tcp_overlapping_packet_test_12_application_define(void *first_unused_memory)
#endif
{
    CHAR           *pointer;
    UINT           status;
...
static void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TCP Overlapping Packet Test 12............................");
    ...
    memcpy(my_packet4 -> nx_packet_prepend_ptr, &msg[30], 20);
...
#endif
{
    printf("NetX Test:   TCP Overlapping Packet Test 12............................N/A\n");
