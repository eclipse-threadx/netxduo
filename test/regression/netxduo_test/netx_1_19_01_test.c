/* 1.19.01:TCP MUST send a FIN on a CLOSE call in ESTAB-LISHED state.  */

/*  Procedure
    1.Let the client connect server socket.
    2.Check the state of server socket is Established.
    3.Server send a FIN on a CLOSE call.
    4.Check the FIN packet.  */
...
static void    my_tcp_packet_receive_1_19_01(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_19_01_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 1.19.01 Test.....................................");
    ...
    /* Disconnect the server socket to send a CLOSE call.  */
    if(flag_1_19_01 == 0)
        flag_1_19_01 = 1;
...
UINT       status;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_19_01;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 1.19.01 Test.....................................N/A\n"); 
