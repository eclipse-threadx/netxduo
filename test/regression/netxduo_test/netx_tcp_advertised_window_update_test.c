/* This NetX test updating advertise window.  */
...
#else
void    netx_tcp_advertised_window_update_test_application_define(void *first_unused_memory)
#endif
{
...
char        *msg = MSG;
    ...
    printf("NetX Test:   TCP Advertised Window Update Test.........................");
    ...
    client_socket.nx_tcp_socket_tx_sequence_recover = 0x00221121;
    server_socket.nx_tcp_socket_rx_sequence = 0x00221122;
    server_socket.nx_tcp_socket_rx_sequence_acked = 0x00221122;

    /* Send the 1st one */
    status = nx_tcp_socket_send(&client_socket, my_packet1, NX_IP_PERIODIC_RATE);

    /* Set the callback function.  */
    updated_window = 0x200;
    client_socket.nx_tcp_socket_rx_window_current = updated_window;
...
static void    thread_1_entry(ULONG thread_input)
{
    ...
    if(server_socket.nx_tcp_socket_tx_window_advertised != updated_window)
        error_counter++;
...
#endif
{
    printf("NetX Test:   TCP Advertised Window Update Test.........................N/A\n");
