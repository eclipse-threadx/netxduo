...
#else
void    netx_udp_tunnel_ipv4_ipv4_basic_test_application_define(void *first_unused_memory)
#endif
{
...
static void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TUNNEL UDP IPV4_4 Basic Processing Test.......");
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("NetX Test:   TUNNEL UDP IPV4_4 Basic Processing Test...................N/A\n");
