...
/*  Procedure
    ...
    5.Drop the ACK packet sent form the Sever to the Client.
    6.The Client will retransmit the FIN packet. */
...
static void    my_tcp_packet_receive_10_24_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void    netx_10_24_02_application_define(void *first_unused_memory)
#endif
{
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 10.24.02 Test....................................");
    ...
    status = nx_tcp_server_socket_listen(&ip_0, 12, &server_socket, 5, ntest_1_connect_received);
    ...
    advanced_packet_process_callback = my_packet_process_10_24_02;
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_10_24_02;
    ...
    /* Check the server socket state and fin_counter.  */
    if((server_socket.nx_tcp_socket_state != NX_TCP_CLOSING) || (fin_counter != 3))
        error_counter++;
...
NX_TCP_HEADER   *tcp_header_ptr;
    ...
    /* Drop the ACK packet in order to let the client socket retransmit a FIN packet. */
    else if((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT) && (ip_ptr == &ip_0))
    {
        *operation_ptr = NX_RAMDRIVER_OP_DROP;        
    }
...
void    my_tcp_packet_receive_10_24_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
...
NX_TCP_HEADER   *tcp_header_ptr;
    ...
    if ((tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_FIN_BIT) && (fin_counter == 1))
    {
        fin_counter++;
    }
    /* Check wether receive a FIN in CLOSE_WAIT state */
    else if (server_socket.nx_tcp_socket_state == NX_TCP_CLOSING && fin_counter == 2)
    {
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 10.24.02 Test....................................N/A\n");
