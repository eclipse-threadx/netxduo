...
/* Test tcp function between IP_2 and Interface1 of IP_0.  */
...
#else
void    netx_forward_tcp_test_4_application_define(void *first_unused_memory)
#endif
{
...
ULONG       packets_sent, bytes_sent, packets_received, bytes_received, retransmit_packets, packets_queued, checksum_errors, socket_state, transmit_queue_depth, transmit_window, receive_window;
    ...
    printf("NetX Test:   Forward TCP Processing Test4..............................");
    ...
    /* Create a socket.  */
    status =  nx_tcp_socket_create(&ip_2, &socket_2, "Socket 0", 
    ...
    status =  nx_tcp_free_port_find(&ip_2, 0x88, &free_port);
    ...
    /* Bind the socket.  */
    status =  nx_tcp_client_socket_bind(&socket_2, 0x88, NX_WAIT_FOREVER);
    ...
    status =  nx_tcp_client_socket_port_get(&socket_2, &free_port);
    ...
    status =  nx_tcp_client_socket_connect(&socket_2, IP_ADDRESS(2, 2, 3, 4), 0x89, 5 * NX_IP_PERIODIC_RATE);
    ...
    status =  nx_tcp_socket_state_wait(&socket_2, NX_TCP_ESTABLISHED, 5 * NX_IP_PERIODIC_RATE);
    ...
    /* Send the packet out!  */
    status =  nx_tcp_socket_send(&socket_2, my_packet, 5 * NX_IP_PERIODIC_RATE);
    ...
    status =  nx_tcp_socket_disconnect(&socket_2, 5 * NX_IP_PERIODIC_RATE);
    ...
    /* Unbind the socket.  */
    status =  nx_tcp_client_socket_unbind(&socket_2);
    ...
    status =  nx_tcp_socket_info_get(&socket_2, &packets_sent, &bytes_sent, 
    ...
    /* Delete the socket.  */
    status =  nx_tcp_socket_delete(&socket_2);
...
#endif
{
    printf("NetX Test:   Forward TCP Processing Test4..............................N/A\n");
