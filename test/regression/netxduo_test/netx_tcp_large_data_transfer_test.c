/* This NetX test concentrates on the large data of TCP transmission.  */
/* Payload size of pool is 1536. Host A sends 8k bytes. */
...
static UCHAR   send_buff[8192];
static UCHAR   recv_buff[8192];
...
#else
void    netx_tcp_large_data_transfer_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    i;
    ...
    status =  nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", 1516, pointer, 30000);
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   TCP Large Data Transfer Test..............................");
...
#endif
{
    ...
    printf("NetX Test:   TCP Large Data Transfer Test..............................N/A\n");
