...
/* Update
   1. nx_tcp_packet_process.c between line 348 and line 349.  */
...
#else
void           netx_23_02_04_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
    ...
    status = nx_ip_create(&ip_0, "NetX IP Instance 0", IP_ADDRESS(128, 1, 2, 2), 0xFFFFFF00UL, &pool_0, _nx_ram_network_driver,
                          pointer, 2048, 1);
    pointer = pointer + 2048;

    /* Create another IP instance.  */
    status += nx_ip_create(&ip_1, "NetX IP Instance 1", IP_ADDRESS(128, 1, 2, 0), 0xFFFFFF00UL, &pool_0, _nx_ram_network_driver,
                           pointer, 2048, 1);
    pointer = pointer + 2048;
    if(status)
        error_counter++;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 23.02.04 Test....................................");
...
UINT       status;
    ...
    status = nx_tcp_client_socket_connect(&client_socket, IP_ADDRESS(128, 1, 2, 2), 12, 50);
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 23.02.04 Test....................................N/A\n");
