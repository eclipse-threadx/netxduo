/* 1.27.03 TCP must ignore a data segment in CLOSING state.  */

/* Procedure
1. Establish a connection by the "three-way handshake" procedure.
2. Let the server socket disconnect to the client socket.
3. Let the driver delay the FIN packet.
4. Let the client socket disconnect to the server socket.
5. Let the client socket send out a data segment.
6. Check if the server socket is in CLOSING state.
7. Let the server socket receive the data segment
8. Check the status.  */
...
static void    my_tcp_packet_receive_1_27_03(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_27_03_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NX_PACKET    *packet_ptr;
    ...
    printf("NetX Test:   TCP Spec 1.27.03 Test.....................................");
    ...
    advanced_packet_process_callback = my_packet_process_1_27_03;

    /* Disconnect.  */
    status = nx_tcp_socket_disconnect(&server_socket, NX_NO_WAIT);

    /* Setup function pointer.  */
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_27_03;
...
NX_PACKET    *my_packet;
    ...
    /* Send the packet out.  */
    status = nx_tcp_socket_send(&client_socket, my_packet, 50);
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.27.03 Test.....................................N/A\n");
