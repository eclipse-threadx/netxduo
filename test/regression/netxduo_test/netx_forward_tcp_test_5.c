...
/* Test tcp function between IP_1 and IP_2.  */
...
#else
void    netx_forward_tcp_test_5_application_define(void *first_unused_memory)
#endif
{
...
ULONG       packets_sent, bytes_sent, packets_received, bytes_received, retransmit_packets, packets_queued, checksum_errors, socket_state, transmit_queue_depth, transmit_window, receive_window;
    ...
    printf("NetX Test:   Forward TCP Processing Test5..............................");
    ...
    status =  nx_tcp_client_socket_connect(&socket_1, IP_ADDRESS(2, 2, 3, 5), 0x89, 5 * NX_IP_PERIODIC_RATE);
...
ULONG           actual_status;
    ...
    status =  nx_ip_status_check(&ip_2, NX_IP_INITIALIZE_DONE, &actual_status, NX_IP_PERIODIC_RATE);
    ...
    /* Create a socket.  */
    status =  nx_tcp_socket_create(&ip_2, &socket_2, "Server Socket", 
    ...
    status =  nx_tcp_server_socket_listen(&ip_2, 0x89, &socket_2, 5, NX_NULL);
    ...
    status =  nx_tcp_server_socket_accept(&socket_2, 5 * NX_IP_PERIODIC_RATE);
    ...
    status =  nx_tcp_socket_receive(&socket_2, &packet_ptr, 5 * NX_IP_PERIODIC_RATE);
    ...
    status =  nx_tcp_server_socket_unaccept(&socket_2);
    ...
    status =  nx_tcp_server_socket_unlisten(&ip_2, 0x89);
...
#endif
{
    printf("NetX Test:   Forward TCP Processing Test5..............................N/A\n");
