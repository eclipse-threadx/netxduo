...
#else
void    netx_tcp_socket_available_bytes_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   TCP Socket available bytes Test...........................");
...
ULONG           bytes_available;
    ...
    /* Get the socket bytes available.  */
    status =  nx_tcp_socket_bytes_available(&server_socket, &bytes_available);
    if (status || (bytes_available != 28 * 2))
        error_counter++;   
...
#endif
{
    ...
    printf("NetX Test:   TCP Socket available bytes Test...........................N/A\n"); 
