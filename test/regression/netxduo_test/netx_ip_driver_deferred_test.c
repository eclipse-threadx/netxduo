/* This NetX test concentrates on NX_IP_DRIVER_DEFERRED_EVENT for NX_LINK_PACKET_SEND command.  */
...
static NX_IP_DRIVER            driver_request;
...
#else
void    netx_ip_driver_deferred_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   IP Driver Deferred Test...................................");
...
static void    test_driver(struct NX_IP_DRIVER_STRUCT *driver_req)
{
    if (driver_req -> nx_ip_driver_command == NX_LINK_PACKET_SEND)
    {
        ...
        memcpy(&driver_request, driver_req, sizeof(driver_request));

        /* Call deferred processing. */
        _nx_ip_driver_deferred_processing(driver_req -> nx_ip_driver_ptr);
    }
    else if (driver_req -> nx_ip_driver_command == NX_LINK_DEFERRED_PROCESSING)
    {

        /* Test if this pointer is initialized. */
        *(driver_req -> nx_ip_driver_return_ptr) = 1;

        /* Pass the unfinished driver request to the real driver. */
        _nx_ram_network_driver_256(&driver_request);
    }
    else
    {

        /* Pass the driver request to the real driver directly. */
...
#endif
{
    ...
    printf("NetX Test:   IP Driver Deferred Test...................................N/A\n"); 
