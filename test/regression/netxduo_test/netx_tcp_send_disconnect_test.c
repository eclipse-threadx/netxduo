...
#else
void    netx_tcp_send_disconnect_test_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET   *my_packet;
    ...
    printf("NetX Test:   TCP Send Disconnect Test..................................");
    ...
    /* Send the packet out!  */
    /* Since packet is larger than peer's window size and peer doesn't receive any data, the send will fail. */
...
ULONG           actual_status;
    ...
    /* Sleep one second and let client thread send the packet first. */
    tx_thread_sleep(NX_IP_PERIODIC_RATE);

    /* Disconnect the client socket while it is transmitting.  */
...
#endif
{
    ...
    printf("NetX Test:   TCP Send Disconnect Test..................................N/A\n"); 
