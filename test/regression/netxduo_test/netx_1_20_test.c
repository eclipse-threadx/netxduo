/* 1.20 TCP MUST move on to CLOSED state after receiving an ACK of the sent FIN in LAST_ACK state.  */

/* Procedure
1. Establish a connection by the "three-way handshake" procedure.
2. Client sends a FIN packet and becomes LAST_ACK state.
3. Check the packet is FIN one.
4. Server receives the FIN packet and replies an ACK packet.
5. Check the state of client is LAST_ACK.
6. Check the packet is an ACK one.
7. Client receives the ACK packet.
8. Check the state of client is CLOSED.  */
...
static void    my_tcp_packet_receive_1_20(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_1_20_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_20_application_define(void *first_unused_memory)
#endif
{
    CHAR       *pointer;
    UINT       status;
...
static void    ntest_0_entry(ULONG thread_input)
{
    ...
    printf("NetX Test:   TCP Spec 1.20 Test........................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_20;
    ...
    /* To test if client_socket is on the CLOSED state.  */
    ...
    if((error_counter) || (ack_counter!=1))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
static void    ntest_1_entry(ULONG thread_input)
{
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_20_2;
...
void           my_tcp_packet_receive_1_20(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
    NX_TCP_HEADER               *tcp_header_ptr;

    /* Check whether the state of server is LAST_ACK.  */
    ...
    /* Let client receives the packet.  */
    _nx_tcp_packet_receive(ip_ptr, packet_ptr);

}

void           my_tcp_packet_receive_1_20_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
    NX_TCP_HEADER               *tcp_header_ptr;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 1.20 Test........................................N/A\n"); 
