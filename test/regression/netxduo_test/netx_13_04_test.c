/* 13.04 TCP SHOULD be capable of queuing out-of-order segments.  */

/* Procedure
   1. Client connects to server.
   2. Client sends a packet that is out of order.
   3. Client sends a packet that is in order.
   5. Server receives packets successfully.  */
...
#else
void           netx_13_04_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG        bytes_copied;
    ...
    if((data_packet_counter != 2) || (rcv_length != 40) || (memcmp(rcv_buffer, (void*)data_13_04, rcv_length)))
        error_counter++;
...
UINT        old_threshold;
    ...
    printf("NetX Test:   TCP Spec 13.04 Test.......................................");
    ...
    status = nx_packet_data_append(my_packet, &data_13_04[20], 20, &pool_0, NX_IP_PERIODIC_RATE);
    ...
    status = nx_packet_data_append(my_packet, data_13_04, 20, &pool_0, NX_IP_PERIODIC_RATE);
...
UINT       j,k=0;
    ...
    {
        flag=rand()%2; 
        if(flag) data_13_04[k++]='A'+rand()%26;
        else data_13_04[k++]='a'+rand()%26;
    }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 13.04 Test.......................................N/A\n"); 
