/* 15.26 TCP SHOULD use RTO = 3 sec initially.  */

/* Procedure
   1. Client sends SYN packet to server.
   2. When the packet passed to driver, check RTO of client.  */

/* Warning: TCP SHOULD use RTO = 1 sec initially.  */
...
#else
void           netx_15_26_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    /* Capture the packet send to server.  */
    advanced_packet_process_callback = my_packet_process_15_26;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 15.26 Test.......................................");
...
ULONG            three_second;
    ...
    {
        three_second = NX_IP_PERIODIC_RATE;
        three_second += (NX_IP_PERIODIC_RATE << 1);
        
        /* Check if RTO = 3 sec.  */
        if(client_socket.nx_tcp_socket_timeout != three_second)
            need_warning = NX_TRUE;
    }
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 15.26 Test.......................................N/A\n"); 
