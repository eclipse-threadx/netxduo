/* Test processing of NS with invalid ICMPv6 payload length. */
 ...
 * ICMPv6 type: 135.
 * ICMPv6 code: 0.
 * The length of ICMPv6 payload is 8. */
static char ns_pkt[62] = {
...
0x22, 0xff, 0xfe, 0x33, 0x44, 0x56, 0x87, 0x00, /* "..3DV.. */
0x14, 0x20, 0x00, 0x00, 0x00, 0x00              /* c..... */
};
...
NX_PACKET              *packet_ptr;
    ...
    printf("NetX Test:   ICMPv6 Invalid Length Test 2.............................."); 
    ...
    memcpy(packet_ptr -> nx_packet_prepend_ptr, &ns_pkt[14], sizeof(ns_pkt) - 14);
    packet_ptr -> nx_packet_length = sizeof(ns_pkt) - 14;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   ICMPv6 Invalid Length Test 2..............................N/A\n"); 
