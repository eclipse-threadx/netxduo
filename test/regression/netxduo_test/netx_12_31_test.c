/* 12.31 TCP MUST be prepared to handle an illegal option length for MSS, in a SYN,ACK segment; a suggested procedure is to reset the connection.  */
...
static void    my_tcp_packet_receive_12_31(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_12_31_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_12_31_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 12.31 Test.......................................");        

    /* Create a socket.  */
    status = nx_tcp_socket_create(&ip_0, &client_socket, "Client Socket", 
                                  NX_IP_NORMAL, NX_FRAGMENT_OKAY, NX_IP_TIME_TO_LIVE, 310,
                                  NX_NULL, NX_NULL);            
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_31;

    /*To handle the syn,ack packet.*/
    advanced_packet_process_callback = my_packet_process_12_31;
    ...
    if ((error_counter != 0) || (syn_ack_counter != 1) || (rst_counter != 1))
    {          
        printf("ERROR!\n");
...
ULONG      actual_status;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_31_2;
...
#error "NetX Product undefined."
    ...
    {   
        ...
        /*Modify the MSS length to 0*/
        *option_word_1 = *option_word_1 & 0xFF00FFFF;
        NX_CHANGE_ULONG_ENDIAN(*option_word_1);
...
#elif defined(__PRODUCT_NETX__)
        dest_ip = server_socket.nx_tcp_socket_connect_ip;
...
NX_TCP_HEADER   *header_ptr;
    ...
    /*If connection havn't been reset, give back, restore the TCP receive function.*/
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 12.31 Test.......................................N/A\n"); 
