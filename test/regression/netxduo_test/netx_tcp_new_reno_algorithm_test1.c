...
3. Drop the first and second segments in the driver.
...
6. Server send ACK with acknowledgment number as the second number of first segment.
7. Client fast retransmits the second segment.
8. Server receives the segment and check the segments data.
9. Disconnect.
10. Print the result.
*/
...
#else
void           netx_tcp_new_reno_algorithm_test1_application_define(void *first_unused_memory)
#endif
{
...
NX_PACKET      *my_packet[5];
    ...
    printf("NetX Test:   TCP New Reno Algorithm Test1..............................");
    ...
    if (client_socket.nx_tcp_socket_tx_sequence_recover != client_tx_sequnce - 1 + 100)
    { 
        error_counter ++;
    }
...
static void    thread_1_entry(ULONG thread_input)
{
    ...
    if ((error_counter) || (packet_counter != 7) || (ack_counter < 5))
    {
        printf("ERROR!\n");
        test_control_return(1);
    }
...
NX_TCP_HEADER        *tcp_header_ptr;
    ...
    if(packet_ptr -> nx_packet_length == 60)
    {
        ...
        if ((packet_counter == 1) || (packet_counter == 2))
        {    
        ...
        else if (packet_counter == 5)
        {
            ...
            /* Should be 5th segment.  */
            if (tcp_header_ptr -> nx_tcp_sequence_number != client_tx_sequnce + 80)
            {
                error_counter ++;
            }
        }
...
NX_TCP_HEADER        *tcp_header_ptr;
    ...
    if(tcp_header_ptr -> nx_tcp_header_word_3 & NX_TCP_ACK_BIT)
    {
        ...
        /* This should be normal ACK for 1th segment in fast recovery.  */
        else if (ack_counter == 4)
        {
        ...
        /* This should be normal ACK for 2th segment in fast recovery.  */
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP New Reno Algorithm Test1..............................N/A\n"); 
