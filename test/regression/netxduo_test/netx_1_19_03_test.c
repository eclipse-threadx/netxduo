...
/* 1.19.03:TCP MUST send a FIN on a CLOSE call in CLOSE_WAIT state.  */

/*  Procedure
    1.Client socket connects to server socket.
    2.Server socket disconnects to client socket.
    3.Check the state of client socket is CLOSE_WAIT.
    4.Client sends a FIN packet in order to call CLOSE command.
...
static void    my_tcp_packet_receive_1_19_03(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_19_03_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT       status;
    ...
    printf("NetX Test:   TCP Spec 1.19.03 Test.....................................");
    ...
    /* Check the state of client is CLOSE_WAIT.  */
    if(client_socket.nx_tcp_socket_state != NX_TCP_CLOSE_WAIT)
        error_counter++;

    /* Disconnect the client socket to send a CLOSE call.  */
    if(flag_1_19_03 == 0)
        flag_1_19_03 = 1;
...
ULONG      actual_status;
    ...
    /* Point to my function  */
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_19_03;
...
NX_TCP_HEADER   *tcp_header_ptr;
    if(flag_1_19_03 == 1)
    {
        ...
        /* Check whether it is a FIN packet.  */
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 1.19.03 Test.....................................N/A\n"); 
