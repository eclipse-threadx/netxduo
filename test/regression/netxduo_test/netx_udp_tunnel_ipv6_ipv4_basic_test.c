...
#else
void    netx_udp_tunnel_ipv6_ipv4_basic_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        free_port;
    ...
    printf("NetX Test:   TUNNEL UDP IPV6_4 Basic Processing Test.......");
...
ULONG           recv_length = 0;
    ...
    address_selector_1.nx_selector_src_tunnel_address.nxd_ip_address.v4 = 0x02020304;
    address_selector_1.nx_selector_dst_tunnel_address.nxd_ip_version = NX_IP_VERSION_V4;
    address_selector_1.nx_selector_dst_tunnel_address.nxd_ip_address.v4 = 0x02020305;

    /* Set up TUNNEL */
    status = nx_tunnel_create(&ip_1, &tunnel_1,NX_IP_VERSION_V4,address_selector_1);
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("NetX Test:   TUNNEL UDP IPV6_4 Basic Processing Test...................N/A\n");
