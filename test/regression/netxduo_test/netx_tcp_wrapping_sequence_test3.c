 ...
 *      0x0000000F ~ 0x0000001E, length is 16. 
 * The seconds packet is dropped.
 * Server will ACK 0x0000000F. 
 * 
...
#else
void    netx_tcp_wrapping_sequence_test3_application_define(void *first_unused_memory)
#endif
{
...
UINT        i;
    ...
    printf("NetX Test:   TCP Wrapping Sequence Test 3..............................");
    ...
    client_socket.nx_tcp_socket_tx_sequence =        0xFFFFFFFF;
    server_socket.nx_tcp_socket_rx_sequence =        0xFFFFFFFF;
    server_socket.nx_tcp_socket_rx_sequence_acked =  0xFFFFFFFF;
...
#endif
{
    ...
    printf("NetX Test:   TCP Wrapping Sequence Test 3..............................N/A\n"); 
