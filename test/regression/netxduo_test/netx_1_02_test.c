/* 1.02 TCP MUST move on to ESTABLISHED state after receiving ACK in SYN-RCVD state.  */
...
/* Procedure
   ...
   6. Let server deal with the ACK packet and checks the state of server is ESTABLISHED.  */
...
static void    my_tcp_packet_receive_1_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
    ...
    status = nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", 128, pointer, 8192);
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 1.02 Test........................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_02;
    ...
    /* Check whether received an ACK packet. */
    if(ack_counter != 1)
        error_counter++;

    /* Check the state of server is ESTABLISHED.  */
...
void           my_tcp_packet_receive_1_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr)
{
NX_TCP_HEADER               *tcp_header_ptr;

    /* Check whether the state of server is SYN_RCVD.  */
    if (server_socket.nx_tcp_socket_state == NX_TCP_SYN_RECEIVED)
    {
        tcp_header_ptr = (NX_TCP_HEADER *)packet_ptr -> nx_packet_prepend_ptr;
        NX_CHANGE_ULONG_ENDIAN(tcp_header_ptr -> nx_tcp_header_word_3);

        /* Check the packet is a ACK one.  */
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.02 Test........................................N/A\n"); 
