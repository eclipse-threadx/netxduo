...
#else
void    netx_tcp_dropped_packet_test2_application_define(void *first_unused_memory)
#endif
{
...
UINT        i;
    ...
    printf("NetX Test:   TCP Dropped Packet Test 2.................................");
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        if ((i == 0) || (i == 2))
        {
            ...
            /* Set driver filter to drop the first and third packets. */
...
#endif
{
    ...
    printf("NetX Test:   TCP Dropped Packet Test 2.................................N/A\n"); 
