/* 12.04 TCP MUST be prepared to handle an illegal option length for MSS, in a SYN segment; a suggested procedure is to reset the connection.  */

/*  Procedure
1.Intercept the SYN packet
...
static void    my_tcp_packet_receive_12_04(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_12_04_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_12_04_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 12.04 Test.......................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_04;
...
UINT       status;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_12_04_2;

    /*To handle the syn packet.*/
    advanced_packet_process_callback = my_packet_process_12_04;
    ...
    if ((error_counter != 0) && (syn_counter != 1) && (rst_counter != 1))
    {       
        printf("ERROR!\n");
        test_control_return(1);   
    }
...
NX_TCP_HEADER   *header_ptr;
    ...
    /*Check whether the connection is reset.*/
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 12.04 Test.......................................N/A\n"); 
