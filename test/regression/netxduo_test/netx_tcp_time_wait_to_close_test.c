/* This NetX test concentrates on TCP state change from TIME-WAIT to CLOSE.  */
...
#else
void    netx_tcp_time_wait_to_close_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        status;
    ...
    printf("NetX Test:   TCP TIME-WAIT to CLOSE Test...............................");
    ...
    /* Wait for 2MSL. */
    tx_thread_sleep(_nx_tcp_2MSL_timer_rate + NX_IP_PERIODIC_RATE);
...
#endif
{
    ...
    printf("NetX Test:   TCP TIME-WAIT to CLOSE Test...............................N/A\n");
