...
#else
void    netx_ip_link_local_address_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    status;
    ...
    status = nx_ip_create(&ip_0, "NetX IP Instance 0", IP_ADDRESS(169, 254, 3, 4), 0xFFFF0000UL, &pool_0, _nx_ram_network_driver_256,
                    pointer, 2048, 1);
    pointer =  pointer + 2048;
...
ULONG   server_addr;
    ...
    printf("NetX Test:   IP Link-Local Address Test................................");
    ...
    server_addr = IP_ADDRESS(1, 2, 3, 5);
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        /* Connect to server. */
        status = nx_tcp_client_socket_connect(&client_socket, server_addr, 12, 5 * NX_IP_PERIODIC_RATE);
        ...
        /* Modify the IP address to routable. */
        nx_ip_address_set(&ip_0, IP_ADDRESS(1, 2, 3, 4), 0xFFFFFF00);
        server_addr = IP_ADDRESS(169, 254, 3, 5);
    }
...
UINT    i;
    ...
    for (i = 0; i < 2; i++) 
    {
        ...
        /* Modify the IP address to link-local. */
        nx_ip_address_set(&ip_1, IP_ADDRESS(169, 254, 3, 5), 0xFFFF0000);
    }
}
#else
#ifdef CTEST
...
#endif
{
    ...
    printf("NetX Test:   IP Link-Local Address Test................................N/A\n");
