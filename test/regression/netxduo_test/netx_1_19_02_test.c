/* 1.19.02:TCP MUST send a FIN on a CLOSE call in SYN-RCVD state.   */

/*  Procedure
    1.Client sends a SYN packet and becomes SYN_SENT state.
    2.Server receives the SYN packet and becomes SYN_RECEIVED state.
    3.Server calls the CLOSE command.
    4.Server socket sends a FIN packet on a CLOSE call.
...
static void    my_tcp_packet_receive_1_19_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_19_02_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 1.19.02 Test.....................................");
    ...
    /* Let driver drop the SYN+ACK packet. */
    advanced_packet_process_callback = my_packet_process_1_19_02;
    ...
    /* Check the state of server socket is SYN_RECEIVED.  */
    ...
    if(flag_1_19_02 == 0)
        flag_1_19_02 = 1;
    status = nx_tcp_socket_disconnect(&server_socket,50);
...
UINT       status;
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_19_02;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 1.19.02 Test.....................................N/A\n"); 
