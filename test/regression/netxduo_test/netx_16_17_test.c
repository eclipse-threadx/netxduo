/* 16.17 A TCP MAY keep its offered receive window closed indefinitely.  */

/* Procedure
   1. Client connect to Server.
   2. Client send a packet to Server,the size of packet is same as Server's receive window size.
   3. Check the Server's receive window size.  */
...
#else
void           netx_16_17_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
ULONG      actual_status;
    ...
    printf("NetX Test:   TCP Spec 16.17 Test.......................................");
    ...
    if(server_socket.nx_tcp_socket_rx_window_current != 0)
        error_counter++;
...
#endif
{
    ...
    /* Print out test information banner.  */
    printf("NetX Test:   TCP Spec 16.17 Test.......................................N/A\n"); 
