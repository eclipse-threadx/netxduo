...
#else
void    netx_ip_fragmentation_wrong_protocol_field_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        packet_length;
    ...
    printf("NetX Test:   IP Fragmentation Wrong Protocol Field Test................");
...
#endif
{
    ...
    printf("NetX Test:   IP Fragmentation Wrong Protocol Field Test................N/A\n");
