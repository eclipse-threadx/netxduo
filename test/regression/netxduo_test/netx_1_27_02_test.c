/* 1.27.02 TCP must ignore a data segment in CLOSE_WAIT state.  */

/* Procedure
1. Establish a connection by the "three-way handshake" procedure.
2. Let the server socket disconnect to client socket.
3. Set the server socket to ESTABLISHED state.
4. Let the server socket send out a data segment.
5. Check if the client socket is in CLOSE_WAIT state.
6. Let the client socket receive the data segment.
7. Check the status.  */
...
static void    my_tcp_packet_receive_1_27_02(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_1_27_02_application_define(void *first_unused_memory)
#endif
{
CHAR    *pointer;
UINT    status;
...
NX_PACKET   *packet_ptr;
    ...
    printf("NetX Test:   TCP Spec 1.27.02 Test.....................................");
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_1_27_02;
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 1.27.02 Test.....................................N/A\n");
