...
static void    my_tcp_packet_receive_3_17(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
static void    my_tcp_packet_receive_3_17_2(NX_IP *ip_ptr, NX_PACKET *packet_ptr);
...
#else
void           netx_3_17_application_define(void *first_unused_memory)
#endif
{
CHAR       *pointer;
UINT       status;
...
UINT                        status;
    ...
    advanced_packet_process_callback = my_packet_process_3_17;
    ...
    ip_0.nx_ip_tcp_packet_receive = my_tcp_packet_receive_3_17;
...
NX_PACKET                   *my_packet;
    ...
    printf("NetX Test:   TCP Spec 3.17 Test........................................");
    ...
    ip_1.nx_ip_tcp_packet_receive = my_tcp_packet_receive_3_17_2;
...
ULONG           source_ip, dest_ip;
    ...
    else if((packet_ptr -> nx_packet_length == 50) && (!memcmp(packet_ptr -> nx_packet_prepend_ptr + 40, MSG, 10)))
    {
...
NX_TCP_HEADER               *tcp_header_ptr;
    ...
    if((packet_ptr -> nx_packet_length == 30) && (!memcmp(packet_ptr -> nx_packet_prepend_ptr + 20, MSG, 10)))
    {
        ...
        if(tcp_header_ptr ->nx_tcp_acknowledgment_number != client_socket.nx_tcp_socket_tx_sequence)
            data_packet_counter++;
...
#endif
{
    ...
    printf("NetX Test:   TCP Spec 3.17 Test........................................N/A\n");
