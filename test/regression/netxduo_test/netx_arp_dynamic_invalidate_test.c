/* This NetX test concentrates on the ARP dynamic entry invalidate operation.  */
...
#else
void    netx_arp_dynamic_invalidate_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG       invalid_messages;
    ...
    printf("NetX Test:   ARP Dynamic Invalidate Processing Test....................");
    ...
    /* Setup multiple dynamic ARP entries.  */
    status =   nx_arp_dynamic_entry_set(&ip_0, IP_ADDRESS(1, 2, 3, 5), 0x0011, 0x22334457);
    status +=  nx_arp_dynamic_entry_set(&ip_0, IP_ADDRESS(1, 2, 3, 6), 0x0011, 0x22334458);
    status +=  nx_arp_dynamic_entry_set(&ip_0, IP_ADDRESS(1, 2, 3, 7), 0x0011, 0x22334459);
    status +=  nx_arp_dynamic_entry_set(&ip_0, IP_ADDRESS(1, 2, 3, 39), 0x0011, 0x2233445a);
    status +=  nx_arp_dynamic_entry_set(&ip_0, IP_ADDRESS(1, 2, 3, 37), 0x0011, 0x2233445b);
    status +=  nx_arp_dynamic_entry_set(&ip_0, IP_ADDRESS(1, 2, 3, 69), 0x0011, 0x2233445c);
    ...
    /* Invalidate all ARP dynamic entries.  */
...
#endif
{
    ...
    printf("NetX Test:   ARP Dynamic Invalidate Processing Test....................N/A\n"); 
