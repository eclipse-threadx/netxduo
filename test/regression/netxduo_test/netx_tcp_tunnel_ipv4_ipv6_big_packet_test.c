...
#else
void    netx_tcp_tunnel_ipv4_ipv6_big_packet_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    status; 
    ...
    status =  nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", 1660, pointer, 10248);
...
CHAR        *msg = MSG;
    ...
    printf("NetX Test:   TUNNEL TCP IPV4_6 Big Packet Test.............");
    ...
    memcpy(my_packet -> nx_packet_prepend_ptr, &msg[0], 1460);

    /* Adjust the write pointer.  */
    my_packet -> nx_packet_length =  1460;
    my_packet -> nx_packet_append_ptr =  my_packet -> nx_packet_prepend_ptr + 1460;
...
#endif
{
    ...
    /* Print out some test information banners.  */
    printf("NetX Test:   TUNNEL TCP IPV4_6 Big Packet Test.........................N/A\n");
