...
#else
void    netx_tcp_zero_window_probe_test_2_application_define(void *first_unused_memory)
#endif
{
...
UINT        i;
    ...
    printf("NetX Test:   TCP Zero Window Probe Test 2..............................");
...
static UINT    client_driver_packet_process(NX_IP *ip_ptr, NX_PACKET *packet_ptr, UINT *operation_ptr, UINT *delay_ptr)
{
    ...
    else if (packet_counter == 2)
    {
            ...
            (*(packet_ptr -> nx_packet_append_ptr - 1) == send_buff[WINDOW_SIZE]))
        {
            ...
            server_socket.nx_tcp_socket_rx_window_current++;
        }
    }
...
#endif
{
    ...
    printf("NetX Test:   TCP Zero Window Probe Test 2..............................N/A\n");
