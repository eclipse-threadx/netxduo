...
set(SUPPORTED_TEST_SUBNET_SIZES 4 8 16 32 64 128 256)
list(FIND SUPPORTED_TEST_SUBNET_SIZES ${TEST_SUBNET_SIZE}
     TEST_SUBNET_SIZE_INDEX)
if(TEST_SUBNET_SIZE_INDEX EQUAL -1)
  message(FATAL_ERROR "TEST_SUBNET_SIZE must be a power of two from 4 through 256")
endif()
math(EXPR TEST_PREFIX_LENGTH "30 - ${TEST_SUBNET_SIZE_INDEX}")
