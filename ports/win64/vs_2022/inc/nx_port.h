...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This file contains data type definitions that make the NetX Duo     */
/*    real-time TCP/IP stack function identically on a Windows 64-bit     */
/*    host simulation using Visual Studio 2022.  This port is intended    */
/*    solely for running the regression test suite and is not suitable    */
/*    for production use.                                                 */
/*                                                                        */
/**************************************************************************/
...
/* Default to little endian, since x86-64 is little endian.  */
...
#define __SWAP32__(val) ((((val) & 0xFF000000U) >> 24) | (((val) & 0x00FF0000U) >> 8) \
                       | (((val) & 0x0000FF00U) << 8) | (((val) & 0x000000FFU) << 24))

#define __SWAP16__(val) (USHORT)((((val) & 0xFF00U) >> 8) | (((val) & 0x00FFU) << 8))
...
/* Define the version ID of NetX Duo.  This may be utilized by the application.  */

#ifdef NX_SYSTEM_INIT
CHAR                            _nx_version_id[] =
                                    "(c) 2024 Microsoft Corp. (c) 2026 Eclipse ThreadX contributors.  *  NetX Duo Win64/VS2022 Version 6.5.2.202603 *";
#else
